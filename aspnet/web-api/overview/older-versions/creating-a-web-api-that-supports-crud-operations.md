...
如果解决方案资源管理器尚未出现，请单击“视图”菜单，并选择“解决方案资源管理器”。 在解决方案资源管理器中，右键单击 "**模型**" 文件夹。 从上下文菜单中，选择 "**添加**"，然后选择 "**类**"。 将类命名为 &quot;产品&quot;。
...
**添加控制器**向导将在 "控制器" 文件夹中创建一个名为 "ProductsController.cs" 的文件。 如果此文件尚未打开，请双击文件将其打开。 添加以下 **using** 语句：
