...
title: ASP.NET Web API 概述和入门视频 |Microsoft Docs
author: rick-anderson
description: 这是一系列视频，可帮助你开始使用 ASP.NET Web API。
ms.author: riande
ms.date: 02/16/2012
...
ms.locfileid: "78484238"
---
# <a name="aspnet-web-api-overview-and-getting-started-videos"></a>ASP.NET Web API 概述和入门视频

> 这是一系列视频，可帮助你开始使用 ASP.NET Web API。
