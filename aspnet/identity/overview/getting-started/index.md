...
- [ASP.NET Identity 建议的资源](aspnet-identity-recommended-resources.md)
...
- [ASP.NET Identity：通过 EntityFramework MySQL 提供程序使用 MySQL 存储 (C#)](aspnet-identity-using-mysql-storage-with-an-entityframework-mysql-provider.md)
