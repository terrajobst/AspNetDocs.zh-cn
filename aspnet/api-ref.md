---
uid: api-ref
title: ASP.NET API 参考 |Microsoft Docs
author: rick-anderson
description: ASP.NET 的 API 参考文档。
...
* [ASP.NET API 参考](/dotnet/api/?view=netframework-4.7&term=system.web)

* [ASP.NET MVC API 参考](https://msdn.microsoft.com/library/mt134468)
