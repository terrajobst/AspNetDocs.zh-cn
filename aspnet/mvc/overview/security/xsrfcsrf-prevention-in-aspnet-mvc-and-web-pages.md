...
ANTI-XSRF 例程当前执行不抵御[点击劫持](https://www.owasp.org/index.php/Clickjacking)。 想要自行防范点击劫持的应用程序可以轻松完成此操作发送 X 帧选项：每个响应 SAMEORIGIN 标头。 所有最新的浏览器都支持此标头。 有关详细信息，请参阅[IE 博客](https://blogs.msdn.com/b/ieinternals/archive/2010/03/30/combating-clickjacking-with-x-frame-options.aspx)，则[SDL 博客](https://blogs.msdn.com/b/sdl/archive/2009/02/05/clickjacking-defense-in-ie8.aspx)，并[OWASP](https://www.owasp.org/index.php/Clickjacking)。 ASP.NET Web 堆栈运行时可能会在一些将来的版本使 MVC 和网页的 ANTI-XSRF 帮助程序自动设置此标头，以便应用程序遭受此种攻击会自动受到保护。
