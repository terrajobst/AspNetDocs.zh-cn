...
title: 入门与 ASP.NET MVC 3 （C#） |Microsoft Docs
author: rick-anderson
description: 使用 Microsoft Visual Web Developer 2010 Express （使用C#Microsoft Visual Web Developer Express）生成 ASP.NET MVC Web 应用程序的基础知识。
ms.author: riande
ms.date: 04/12/2012
...
ms.locfileid: "78434732"
---
# <a name="getting-started-with-aspnet-mvc-3-c"></a>ASP.NET MVC 3 入门 (C#)

> 使用 Microsoft Visual Web Developer 2010 Express （使用C#Microsoft Visual Web Developer Express）生成 ASP.NET MVC Web 应用程序的基础知识。
