...
<span data-ttu-id="5c7fa-130">必须具有要完成本实验的以下项：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-130">You must have the following items to complete this lab:</span></span>
...
3. <span data-ttu-id="5c7fa-187">在添加视图对话框中，验证是否视图名称是**索引**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-187">In the Add View dialog, verify that the View Name is **Index**.</span></span> <span data-ttu-id="5c7fa-188">选择**创建强类型化视图**选项，然后选择**唱片集 (MvcMusicStore.Models)** 从**模型类**下拉列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-188">Select the **Create a strongly-typed view** option, and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="5c7fa-189">选择**列表**从**基架模板**下拉列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-189">Select **List** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="5c7fa-190">将保留**视图引擎**到**Razor**和其他字段具有其默认值，然后单击**添加**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-190">Leave the **View engine** to **Razor** and the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="5c7fa-191">![添加索引视图](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "添加索引视图")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-191">![Adding an index view](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "Adding an index view")</span></span>
...
<span data-ttu-id="5c7fa-204">在此任务中，将测试**StoreManager** **索引**视图模板显示根据前面的步骤的设计的唱片集的列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-204">In this task, you will test that the **StoreManager** **Index** View template displays a list of albums according to the design of the previous steps.</span></span>
...
2. <span data-ttu-id="5c7fa-275">在添加视图对话框中，验证是否视图名称是**编辑**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-275">In the Add View dialog, verify that the View Name is **Edit**.</span></span> <span data-ttu-id="5c7fa-276">检查**创建强类型化视图**复选框，然后选择**唱片集 (MvcMusicStore.Models)** 从**查看数据类**下拉列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-276">Check the **Create a strongly-typed view** checkbox and select **Album (MvcMusicStore.Models)** from the **View data class** drop-down.</span></span> <span data-ttu-id="5c7fa-277">选择**编辑**从**基架模板**下拉列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-277">Select **Edit** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="5c7fa-278">其他字段保留为其默认值，然后单击**添加**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-278">Leave the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="5c7fa-279">![添加编辑视图](aspnet-mvc-4-helpers-forms-and-validation/_static/image7.png "添加 Edit 视图")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-279">![Adding an Edit view](aspnet-mvc-4-helpers-forms-and-validation/_static/image7.png "Adding an Edit view")</span></span>
...
2. <span data-ttu-id="5c7fa-320">在主页页面中启动项目。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-320">The project starts in the Home page.</span></span> <span data-ttu-id="5c7fa-321">将 URL 更改为 **/StoreManager/Edit/1**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-321">Change the URL to **/StoreManager/Edit/1**.</span></span> <span data-ttu-id="5c7fa-322">将唱片集标题改为**负载**，然后单击**保存**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-322">Change the Album title to **Load** and click on **Save**.</span></span> <span data-ttu-id="5c7fa-323">验证在列表中的唱片集实际更改唱片集的标题。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-323">Verify that album's title actually changed in the list of albums.</span></span>
    ...
    <span data-ttu-id="5c7fa-324">![正在更新相册](aspnet-mvc-4-helpers-forms-and-validation/_static/image10.png "更新唱片集")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-324">![Updating an album](aspnet-mvc-4-helpers-forms-and-validation/_static/image10.png "Updating an album")</span></span>
...
2. <span data-ttu-id="5c7fa-350">在添加视图对话框中，验证是否视图名称是**创建**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-350">In the Add View dialog, verify that the View Name is **Create**.</span></span> <span data-ttu-id="5c7fa-351">选择**创建强类型化视图**选项，然后选择**唱片集 (MvcMusicStore.Models)** 从**模型类**下拉列表和**创建**从**基架模板**下拉列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-351">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down and **Create** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="5c7fa-352">其他字段保留为其默认值，然后单击**添加**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-352">Leave the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="5c7fa-354">*添加 Create 视图*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-354">*Adding the Create View*</span></span>
...
2. <span data-ttu-id="5c7fa-370">替换**HTTP POST 创建**以下操作方法代码：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-370">Replace **HTTP-POST Create** action method code with the following:</span></span>
    ...
    <span data-ttu-id="5c7fa-371">(代码段- *ASP.NET MVC 4 帮助程序和窗体和验证-Ex4 StoreManagerController HTTP-POST 创建操作*)</span><span class="sxs-lookup"><span data-stu-id="5c7fa-371">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex4 StoreManagerController HTTP- POST Create action*)</span></span>
...
3. <span data-ttu-id="5c7fa-403">删除控制器操作正是与上一存储详细信息控制器操作相同： 它会查询**唱片集**对象从数据库中使用**id**提供 URL，并返回适当**视图**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-403">The Delete controller action is exactly the same as the previous Store Details controller action: it queries the **album** object from the database using the **id** provided in the URL and returns the appropriate **View**.</span></span> <span data-ttu-id="5c7fa-404">若要执行此操作，将为 HTTP GET**删除**以下操作方法代码：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-404">To do this, replace the HTTP-GET **Delete** action method code with the following:</span></span>
    ...
    <span data-ttu-id="5c7fa-405">(代码段- *ASP.NET MVC 4 帮助程序和窗体和验证-Ex5 处理删除 HTTP GET Delete 操作*)</span><span class="sxs-lookup"><span data-stu-id="5c7fa-405">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-GET Delete action*)</span></span>
...
5. <span data-ttu-id="5c7fa-408">在添加视图对话框中，验证是否视图名称是**删除**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="5c7fa-409">选择**创建强类型化视图**选项，然后选择**唱片集 (MvcMusicStore.Models)** 从**模型类**下拉列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="5c7fa-410">选择**删除**从**基架模板**下拉列表。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="5c7fa-411">其他字段保留为其默认值，然后单击**添加**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="5c7fa-412">![添加 Delete 视图](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "添加 Delete 视图")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="5c7fa-413">*添加 Delete 视图*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="5c7fa-414">删除模板显示模型中的所有字段。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="5c7fa-415">将显示仅唱片集的标题。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-415">You will show only the album's title.</span></span> <span data-ttu-id="5c7fa-416">若要执行此操作，请将视图的内容替换为以下代码：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="5c7fa-417">任务 2-运行应用程序</span><span class="sxs-lookup"><span data-stu-id="5c7fa-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="5c7fa-418">在此任务中，将测试**StoreManager** **删除**视图页显示确认删除窗体。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="5c7fa-419">按**F5**运行该应用程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="5c7fa-420">在主页页面中启动项目。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-420">The project starts in the Home page.</span></span> <span data-ttu-id="5c7fa-421">将 URL 更改为 **/StoreManager**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="5c7fa-422">选择要删除通过单击一个相册**删除**并验证是否已上载新视图。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="5c7fa-423">![删除 Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "删除 Album")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="5c7fa-424">*删除 Album*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="5c7fa-425">任务 3-实现 HTTP POST Delete 操作方法</span><span class="sxs-lookup"><span data-stu-id="5c7fa-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="5c7fa-426">在此任务中，您将实现将在用户单击时调用的 Delete 操作方法的 HTTP POST 版本**删除**按钮。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="5c7fa-427">该方法应在删除数据库中的唱片集。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="5c7fa-428">关闭浏览器，如果需要以返回到 Visual Studio 窗口。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="5c7fa-429">打开**StoreManagerController**类。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="5c7fa-430">若要执行此操作，请展开**控制器**文件夹，然后双击**StoreManagerController.cs**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="5c7fa-431">替换**HTTP POST Delete**以下操作方法代码：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="5c7fa-432">(代码段- *ASP.NET MVC 4 帮助程序和窗体和验证-Ex5 处理删除 HTTP POST Delete 操作*)</span><span class="sxs-lookup"><span data-stu-id="5c7fa-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="5c7fa-433">任务 4-运行应用程序</span><span class="sxs-lookup"><span data-stu-id="5c7fa-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="5c7fa-434">在此任务中，将测试**StoreManager 删除**视图页可让您删除唱片集，然后重定向到 StoreManager 索引视图。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="5c7fa-435">按**F5**运行该应用程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="5c7fa-436">在主页页面中启动项目。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-436">The project starts in the Home page.</span></span> <span data-ttu-id="5c7fa-437">将 URL 更改为 **/StoreManager**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="5c7fa-438">选择要删除通过单击一个相册**删除。**</span><span class="sxs-lookup"><span data-stu-id="5c7fa-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="5c7fa-439">通过单击确认删除**删除**按钮：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="5c7fa-440">![删除 Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "删除 Album")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="5c7fa-441">*删除 Album*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="5c7fa-442">验证是否删除唱片集，因为它不会出现在**索引**页。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="5c7fa-443">练习 6:添加验证</span><span class="sxs-lookup"><span data-stu-id="5c7fa-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="5c7fa-444">目前，您所具有的创建和编辑窗体不执行任何类型的验证。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="5c7fa-445">如果用户离开价格字段中的所需的字段留空或键入字母，会向您的第一个错误将从数据库中。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="5c7fa-446">通过将数据批注添加到 model 类，可以向应用程序添加验证。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="5c7fa-447">描述所需的规则应用于您的模型属性，可以利用数据批注和 ASP.NET MVC 将负责强制执行和向用户显示相应的消息。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="5c7fa-448">任务 1-添加数据批注</span><span class="sxs-lookup"><span data-stu-id="5c7fa-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="5c7fa-449">在此任务中，您将添加到将使创建和编辑页面的唱片集模型的数据注释显示验证消息在适当的时候。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="5c7fa-450">对于简单的模型类，添加数据批注只需添加处理**使用**语句**System.ComponentModel.DataAnnotation**，然后将放到 **[必需]** 上相应的属性的属性。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="5c7fa-451">下面的示例将使**名称**属性在视图中的必填字段。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="5c7fa-452">这是稍微复杂一些类似于此应用程序的情况下在其中生成实体数据模型。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="5c7fa-453">如果你的数据批注直接添加到模型类，它们将被覆盖如果从数据库对模型进行更新。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="5c7fa-454">相反，您可使用元数据部分类将是为了容纳批注并与模型相关联的类使用 **[MetadataType]** 属性。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="5c7fa-455">打开**开始**解决方案位于**源/Ex6-AddingValidation/开始/** 文件夹。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="5c7fa-456">否则，可能会继续使用 **最终** 解决方案通过完成上一练习中获取。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="5c7fa-457">如果您打开提供**开始**需要下载某些缺少的 NuGet 包的解决方案，然后再继续。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="5c7fa-458">若要执行此操作，请单击**项目**菜单，然后选择**管理 NuGet 包**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="5c7fa-459">在中**管理 NuGet 包**对话框中，单击**还原**若要下载缺少的包。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="5c7fa-460">最后，通过单击生成解决方案**构建** | **生成解决方案**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="5c7fa-461">使用 NuGet 的优点之一是，您不必提供在项目中的所有库项目大小减少。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="5c7fa-462">使用 NuGet 增强工具，请通过在 Packages.config 文件中，指定包版本可以下载第一次运行该项目的所有所需的库。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="5c7fa-463">这就是原因需要将从本实验中打开现有解决方案后运行这些步骤。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="5c7fa-464">打开**Album.cs**从**模型**文件夹。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="5c7fa-465">替换**Album.cs**内容与突出显示的代码，以便它看起来如下所示：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="5c7fa-466">在行 **[DisplayFormat(ConvertEmptyStringToNull=false)]** 指示数据源中更新数据字段时，将不会从模型的空字符串转换为 null。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="5c7fa-467">实体框架将 null 值分配给该模型之前数据批注验证字段时，此设置会避免异常。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="5c7fa-468">(代码段- *ASP.NET MVC 4 帮助程序和窗体和验证-Ex6 唱片集的元数据部分类*)</span><span class="sxs-lookup"><span data-stu-id="5c7fa-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="5c7fa-469">这**唱片集**分部类具有**MetadataType**属性，用于指向**AlbumMetaData**数据批注的类。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="5c7fa-470">以下是一些用于批注的唱片集模型的数据批注属性：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="5c7fa-471">需要-指示该属性是必填的字段</span><span class="sxs-lookup"><span data-stu-id="5c7fa-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="5c7fa-472">DisplayName-定义要使用窗体字段并验证消息的文本</span><span class="sxs-lookup"><span data-stu-id="5c7fa-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="5c7fa-473">DisplayFormat-指定如何显示和格式化数据字段。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="5c7fa-474">StringLength-定义字符串字段的最大长度</span><span class="sxs-lookup"><span data-stu-id="5c7fa-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="5c7fa-475">范围-最大和最小值为数值字段</span><span class="sxs-lookup"><span data-stu-id="5c7fa-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="5c7fa-476">ScaffoldColumn-允许隐藏编辑器窗体中的字段</span><span class="sxs-lookup"><span data-stu-id="5c7fa-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="5c7fa-477">任务 2-运行应用程序</span><span class="sxs-lookup"><span data-stu-id="5c7fa-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="5c7fa-478">在本任务中，您将测试创建和编辑页面验证字段，使用上一个任务中选择的显示名称。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="5c7fa-479">按**F5**运行该应用程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="5c7fa-480">在主页页面中启动项目。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-480">The project starts in the Home page.</span></span> <span data-ttu-id="5c7fa-481">将 URL 更改为**StoreManager/创建**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="5c7fa-482">验证是否显示名称匹配的分部类中的 (如**唱片集画面 URL**而不是**AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="5c7fa-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="5c7fa-483">单击**创建**，而不填充窗体。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="5c7fa-484">验证获取相应的验证消息。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="5c7fa-485">![验证创建页中的字段](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "验证创建页中的字段")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="5c7fa-486">*在创建页中的已验证的字段*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="5c7fa-487">你可以验证相同出现**编辑**页。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="5c7fa-488">将 URL 更改为 **/StoreManager/Edit/1**并验证是否显示名称与在分部类中的匹配 (如**唱片集画面 URL**而不是**AlbumArtUrl**)。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="5c7fa-489">空**标题**并**价格**字段，然后单击**保存**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="5c7fa-490">验证获取相应的验证消息。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-490">Verify that you get the corresponding validation messages.</span></span>

    ![在编辑页中的已验证的字段](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="5c7fa-492">*在编辑页中的已验证的字段*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="5c7fa-493">练习 7:在客户端使用非介入式 jQuery</span><span class="sxs-lookup"><span data-stu-id="5c7fa-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="5c7fa-494">在此练习中，您将学习如何启用客户端的 MVC 4 非介入式 jQuery 验证。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="5c7fa-495">非介入式 jQuery 使用数据 ajax 前缀 JavaScript 来调用操作方法在服务器而不是干扰的方式发出的内联客户端脚本。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>

<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="5c7fa-496">任务 1-运行之前启用非介入式 jQuery 在应用程序</span><span class="sxs-lookup"><span data-stu-id="5c7fa-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="5c7fa-497">在本任务中，将运行之前要比较这两种验证模型包括 jQuery 在应用程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="5c7fa-498">打开**开始**解决方案位于**源/Ex7-UnobtrusivejQueryValidation/开始/** 文件夹。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="5c7fa-499">否则，可能会继续使用 **最终** 解决方案通过完成上一练习中获取。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="5c7fa-500">如果您打开提供**开始**需要下载某些缺少的 NuGet 包的解决方案，然后再继续。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="5c7fa-501">若要执行此操作，请单击**项目**菜单，然后选择**管理 NuGet 包**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="5c7fa-502">在中**管理 NuGet 包**对话框中，单击**还原**若要下载缺少的包。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="5c7fa-503">最后，通过单击生成解决方案**构建** | **生成解决方案**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="5c7fa-504">使用 NuGet 的优点之一是，您不必提供在项目中的所有库项目大小减少。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="5c7fa-505">使用 NuGet 增强工具，请通过在 Packages.config 文件中，指定包版本可以下载第一次运行该项目的所有所需的库。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="5c7fa-506">这就是原因需要将从本实验中打开现有解决方案后运行这些步骤。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="5c7fa-507">按 **F5** 运行该应用程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="5c7fa-508">在主页页面中启动项目。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-508">The project starts in the Home page.</span></span> <span data-ttu-id="5c7fa-509">浏览 **/StoreManager/创建**然后单击**创建**而不填充该窗体以验证你收到验证消息：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="5c7fa-510">![客户端验证已禁用](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "禁用客户端验证")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="5c7fa-511">*禁用客户端验证*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="5c7fa-512">在浏览器中打开的 HTML 源代码：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="5c7fa-513">任务 2-启用非介入式客户端验证</span><span class="sxs-lookup"><span data-stu-id="5c7fa-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="5c7fa-514">在本任务中，将启用 jQuery**非介入式客户端验证**从**Web.config**文件，它是默认情况下所有新的 ASP.NET MVC 4 项目中设置为 false。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="5c7fa-515">此外，您将添加所需的脚本引用，以使 jQuery 非介入式客户端验证工作。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="5c7fa-516">打开**Web.Config**文件在项目根目录位置，并确保选中**ClientValidationEnabled**并**UnobtrusiveJavaScriptEnabled**密钥值设置为 **，则返回 true**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="5c7fa-517">此外可以通过在 Global.asax.cs 以获得相同的结果的代码来启用客户端验证：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="5c7fa-518">**HtmlHelper.ClientValidationEnabled = true;**</span><span class="sxs-lookup"><span data-stu-id="5c7fa-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="5c7fa-519">此外，可以将 ClientValidationEnabled 属性分配到任何控制器具有自定义行为。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="5c7fa-520">打开**Create.cshtml**处**Views\StoreManager**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="5c7fa-521">以下脚本文件，请确保**jquery.validate**并**jquery.validate.unobtrusive**，通过视图中引用&quot; **~/bundles/jqueryval**&quot;捆绑包。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view through the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="5c7fa-522">所有这些 jQuery 库包含在新的 MVC 4 项目。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="5c7fa-523">您可以找到更多库中的 **/脚本**您项目的文件夹。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="5c7fa-524">为了使此验证库的工作原理，您需要添加对 jQuery 框架库的引用。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="5c7fa-525">由于已在添加此引用 **\_Layout.cshtml**文件，您不需要在此特定视图中添加它。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="5c7fa-526">任务 3-运行应用程序使用非介入式 jQuery 验证</span><span class="sxs-lookup"><span data-stu-id="5c7fa-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="5c7fa-527">在此任务中，将测试**StoreManager**创建视图模板执行用户创建新的唱片集时使用 jQuery 库的客户端验证。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="5c7fa-528">按 **F5** 运行该应用程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="5c7fa-529">在主页页面中启动项目。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-529">The project starts in the Home page.</span></span> <span data-ttu-id="5c7fa-530">浏览 **/StoreManager/创建**然后单击**创建**而不填充该窗体以验证你收到验证消息：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="5c7fa-531">![使用 jQuery 启用客户端验证](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "使用 jQuery 启用客户端验证")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="5c7fa-532">*使用 jQuery 启用客户端验证*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="5c7fa-533">在浏览器中，打开创建视图的源代码:</span><span class="sxs-lookup"><span data-stu-id="5c7fa-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="5c7fa-534">对于每个客户端验证规则，非介入式 jQuery 将添加一个特性，其数据-val-*rulename*=&quot;*消息*&quot;。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="5c7fa-535">下面是一系列标记该 Unobtrusive jQuery 插入 html 输入字段来执行客户端验证：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="5c7fa-536">数据值</span><span class="sxs-lookup"><span data-stu-id="5c7fa-536">Data-val</span></span>
   > - <span data-ttu-id="5c7fa-537">数据 val 编号</span><span class="sxs-lookup"><span data-stu-id="5c7fa-537">Data-val-number</span></span>
   > - <span data-ttu-id="5c7fa-538">数据值范围</span><span class="sxs-lookup"><span data-stu-id="5c7fa-538">Data-val-range</span></span>
   > - <span data-ttu-id="5c7fa-539">数据值的范围最小/最大数据值范围</span><span class="sxs-lookup"><span data-stu-id="5c7fa-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="5c7fa-540">-Val 的所需的数据</span><span class="sxs-lookup"><span data-stu-id="5c7fa-540">Data-val-required</span></span>
   > - <span data-ttu-id="5c7fa-541">数据值长度</span><span class="sxs-lookup"><span data-stu-id="5c7fa-541">Data-val-length</span></span>
   > - <span data-ttu-id="5c7fa-542">数据值的长度最大/最小数据 val 长度</span><span class="sxs-lookup"><span data-stu-id="5c7fa-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="5c7fa-543">所有数据值将都填入模型**数据批注**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="5c7fa-544">然后，可以在客户端运行在服务器端工作的所有逻辑。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="5c7fa-545">例如，价格属性具有以下数据注释在模型中：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="5c7fa-546">在使用非介入式 jQuery 后, 生成的代码是：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="5c7fa-547">总结</span><span class="sxs-lookup"><span data-stu-id="5c7fa-547">Summary</span></span>

<span data-ttu-id="5c7fa-548">通过完成本动手实验介绍了如何使用户能够更改与使用以下数据库中存储的数据：</span><span class="sxs-lookup"><span data-stu-id="5c7fa-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="5c7fa-549">控制器的操作，例如索引、 创建、 编辑、 删除</span><span class="sxs-lookup"><span data-stu-id="5c7fa-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="5c7fa-550">ASP.NET MVC 基架功能用于 HTML 表中显示属性</span><span class="sxs-lookup"><span data-stu-id="5c7fa-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="5c7fa-551">自定义 HTML 帮助程序来提高用户体验</span><span class="sxs-lookup"><span data-stu-id="5c7fa-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="5c7fa-552">对 HTTP GET 或 HTTP POST 调用做出响应的操作方法</span><span class="sxs-lookup"><span data-stu-id="5c7fa-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="5c7fa-553">有关类似视图模板，如创建和编辑共享的编辑器模板</span><span class="sxs-lookup"><span data-stu-id="5c7fa-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="5c7fa-554">窗体元素，如下拉列表</span><span class="sxs-lookup"><span data-stu-id="5c7fa-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="5c7fa-555">数据注释进行模型验证</span><span class="sxs-lookup"><span data-stu-id="5c7fa-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="5c7fa-556">使用 jQuery 非介入式库的客户端验证</span><span class="sxs-lookup"><span data-stu-id="5c7fa-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="5c7fa-557">附录 a:安装 Visual Studio Express 2012 for Web</span><span class="sxs-lookup"><span data-stu-id="5c7fa-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="5c7fa-558">你可以安装**Microsoft Visual Studio Express 2012 for Web**或另一个&quot;Express&quot;使用版本 **[Microsoft Web 平台安装程序](https://www.microsoft.com/web/downloads/platform.aspx)** .</span><span class="sxs-lookup"><span data-stu-id="5c7fa-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="5c7fa-559">以下说明将指导您完成安装所需的步骤*Visual studio Express 2012 for Web*使用*Microsoft Web 平台安装程序*。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="5c7fa-560">转到[ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169)。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="5c7fa-561">或者，如果你已安装 Web 平台安装程序，则可以打开它，并搜索产品&quot; <em>Visual Studio Express 2012 for Web 与 Windows Azure SDK</em>&quot;。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="5c7fa-562">单击**立即安装**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-562">Click on **Install Now**.</span></span> <span data-ttu-id="5c7fa-563">如果还没有**Web 平台安装程序**将重定向以下载并安装。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="5c7fa-564">一次**Web 平台安装程序**处于打开状态，单击**安装**以启动安装程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="5c7fa-565">![安装 Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "安装 Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="5c7fa-566">*安装 Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="5c7fa-567">阅读所有产品的许可证和条款，然后单击**我接受**以继续。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![接受许可条款](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="5c7fa-569">*接受许可条款*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="5c7fa-570">等待，直到下载和安装过程完成。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-570">Wait until the downloading and installation process completes.</span></span>

    ![安装进度](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="5c7fa-572">*安装进度*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-572">*Installation progress*</span></span>
6. <span data-ttu-id="5c7fa-573">安装完成后，单击**完成**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-573">When the installation completes, click **Finish**.</span></span>

    ![安装已完成](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="5c7fa-575">*安装已完成*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-575">*Installation completed*</span></span>
7. <span data-ttu-id="5c7fa-576">单击**退出**以关闭 Web 平台安装程序。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="5c7fa-577">若要打开 Visual Studio Express for Web，请转到**启动**屏幕上即可开始编写&quot; **VS Express**&quot;，然后单击**VS Express for Web**磁贴。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web 磁贴](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="5c7fa-579">*VS Express for Web 磁贴*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="5c7fa-580">附录 b:使用代码片段</span><span class="sxs-lookup"><span data-stu-id="5c7fa-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="5c7fa-581">使用代码段，可以轻松获得相关所需的所有代码。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="5c7fa-582">实验室文档将告诉您完全何时可以使用它们，如下图中所示。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="5c7fa-583">![使用 Visual Studio 代码段代码插入到你的项目](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "使用 Visual Studio 代码段代码插入到你的项目")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="5c7fa-584">*使用 Visual Studio 代码段代码插入到你的项目*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="5c7fa-585">***若要添加代码段使用键盘 (仅限 C#)***</span><span class="sxs-lookup"><span data-stu-id="5c7fa-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="5c7fa-586">将光标置于要插入的代码。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="5c7fa-587">开始键入代码片段名称 （不带空格或连字符）。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="5c7fa-588">观看作为 IntelliSense 显示匹配的代码段的名称。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="5c7fa-589">选择正确的代码段 （或继续键入直到整个代码段的名称处于选定状态）。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="5c7fa-590">按 Tab 键两次，以在光标位置插入代码段。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="5c7fa-591">![开始键入代码段名称](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "开始键入代码段名称")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="5c7fa-592">*开始键入代码段名称*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="5c7fa-593">![按 tab 键以选择突出显示代码段](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "按选项卡以选择突出显示代码段")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="5c7fa-594">*按 tab 键以选择突出显示代码段*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="5c7fa-595">![再次按 Tab 和代码段将 expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "再次按 Tab 和代码段将扩展")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="5c7fa-596">*再次按 Tab 和代码段将扩展*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="5c7fa-597">***若要添加代码段使用鼠标 （C#、 Visual Basic 和 XML）*** 1。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="5c7fa-598">右键单击你想要插入的代码片段。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="5c7fa-599">选择**插入代码段**跟**我的代码片段**。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="5c7fa-600">通过单击选择列表中中的相关代码片段。</span><span class="sxs-lookup"><span data-stu-id="5c7fa-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="5c7fa-601">![右键单击你想要插入代码段和选择插入代码段](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "右键单击你想要插入代码段和选择插入代码段")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="5c7fa-602">*右键单击你想要插入代码段和选择插入代码段*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="5c7fa-603">![通过单击选择列表中中的相关代码片段](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "通过单击选择列表中中的相关代码片段")</span><span class="sxs-lookup"><span data-stu-id="5c7fa-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="5c7fa-604">*通过单击选择列表中中的相关代码片段*</span><span class="sxs-lookup"><span data-stu-id="5c7fa-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
