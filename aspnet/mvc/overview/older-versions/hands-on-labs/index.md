...
- [ASP.NET MVC 4 Entity Framework 基架和迁移](aspnet-mvc-4-entity-framework-scaffolding-and-migrations.md)
- [ASP.NET MVC 4 依赖项注入](aspnet-mvc-4-dependency-injection.md)
- [ASP.NET MVC 4 帮助程序、窗体和验证](aspnet-mvc-4-helpers-forms-and-validation.md)
