...
- [ASP.NET MVC 4 入门](getting-started-with-aspnet-mvc4/index.md)
    ...
    - [ASP.NET MVC 4 简介](getting-started-with-aspnet-mvc4/intro-to-aspnet-mvc-4.md)
    - [添加控制器](getting-started-with-aspnet-mvc4/adding-a-controller.md)
    - [添加视图](getting-started-with-aspnet-mvc4/adding-a-view.md)
    - [添加模型](getting-started-with-aspnet-mvc4/adding-a-model.md)
    - [从控制器访问模型的数据](getting-started-with-aspnet-mvc4/accessing-your-models-data-from-a-controller.md)
    - [检查 Edit 方法和编辑视图](getting-started-with-aspnet-mvc4/examining-the-edit-methods-and-edit-view.md)
    - [向电影模型和表添加新字段](getting-started-with-aspnet-mvc4/adding-a-new-field-to-the-movie-model-and-table.md)
    - [向模型添加验证](getting-started-with-aspnet-mvc4/adding-validation-to-the-model.md)
    - [检查 Details 和 Delete 方法](getting-started-with-aspnet-mvc4/examining-the-details-and-delete-methods.md)
- [通过 MVC 4 开始使用 EF 5](getting-started-with-ef-5-using-mvc-4/index.md)

    - [创建 Entity Framework 数据模型](getting-started-with-ef-5-using-mvc-4/creating-an-entity-framework-data-model-for-an-asp-net-mvc-application.md)
    - [实现基本的 CRUD 功能](getting-started-with-ef-5-using-mvc-4/implementing-basic-crud-functionality-with-the-entity-framework-in-asp-net-mvc-application.md)
    - [排序、筛选和分页](getting-started-with-ef-5-using-mvc-4/sorting-filtering-and-paging-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [创建更复杂的数据模型](getting-started-with-ef-5-using-mvc-4/creating-a-more-complex-data-model-for-an-asp-net-mvc-application.md)
    - [读取相关数据](getting-started-with-ef-5-using-mvc-4/reading-related-data-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [更新相关数据](getting-started-with-ef-5-using-mvc-4/updating-related-data-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [处理并发](getting-started-with-ef-5-using-mvc-4/handling-concurrency-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [实现继承](getting-started-with-ef-5-using-mvc-4/implementing-inheritance-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [实现存储库和工作单元模式](getting-started-with-ef-5-using-mvc-4/implementing-the-repository-and-unit-of-work-patterns-in-an-asp-net-mvc-application.md)
    - [高级 Entity Framework 方案](getting-started-with-ef-5-using-mvc-4/advanced-entity-framework-scenarios-for-an-mvc-web-application.md)
    - [生成章节下载](getting-started-with-ef-5-using-mvc-4/building-the-ef5-mvc4-chapter-downloads.md)
- [MVC 4 动手实验](hands-on-labs/index.md)

    - [ASP.NET MVC 4 的新增功能](hands-on-labs/whats-new-in-aspnet-mvc-4.md)
    - [ASP.NET MVC 4 基础知识](hands-on-labs/aspnet-mvc-4-fundamentals.md)
    - [ASP.NET MVC 4 模型和数据访问](hands-on-labs/aspnet-mvc-4-models-and-data-access.md)
    - [ASP.NET MVC 4 自定义操作筛选器](hands-on-labs/aspnet-mvc-4-custom-action-filters.md)
    - [ASP.NET MVC 4 Entity Framework 基架和迁移](hands-on-labs/aspnet-mvc-4-entity-framework-scaffolding-and-migrations.md)
    - [ASP.NET MVC 4 依赖项注入](hands-on-labs/aspnet-mvc-4-dependency-injection.md)
    - [ASP.NET MVC 4 帮助程序、窗体和验证](hands-on-labs/aspnet-mvc-4-helpers-forms-and-validation.md)
- [ASP.NET MVC 4 移动功能](aspnet-mvc-4-mobile-features.md)
- [通过 MVC 4 使用 OAuth 提供程序](using-oauth-providers-with-mvc.md)
- [ASP.NET MVC 3 入门](getting-started-with-aspnet-mvc3/index.md)

    - [ASP.NET MVC 3 入门 (C#)](getting-started-with-aspnet-mvc3/cs/index.md)

        - [ASP.NET MVC 3 简介 (C#)](getting-started-with-aspnet-mvc3/cs/intro-to-aspnet-mvc-3.md)
        - [添加控制器 (C#)](getting-started-with-aspnet-mvc3/cs/adding-a-controller.md)
        - [添加视图 (C#)](getting-started-with-aspnet-mvc3/cs/adding-a-view.md)
        - [添加模型 (C#)](getting-started-with-aspnet-mvc3/cs/adding-a-model.md)
        - [从控制器访问模型的数据 (C#)](getting-started-with-aspnet-mvc3/cs/accessing-your-models-data-from-a-controller.md)
    ...
    - [ASP.NET MVC 3 入门 (VB.NET)](getting-started-with-aspnet-mvc3/vb/index.md)
        ...
        - [添加控制器 (VB)](getting-started-with-aspnet-mvc3/vb/adding-a-controller.md)
        - [添加视图 (VB)](getting-started-with-aspnet-mvc3/vb/adding-a-view.md)
