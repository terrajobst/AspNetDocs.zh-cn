...
[![仅更新联系人](iteration-7-add-ajax-functionality-cs/_static/image1.jpg)](iteration-7-add-ajax-functionality-cs/_static/image1.png)

**图 01**：仅更新联系人（[单击查看完全大小的图像](iteration-7-add-ajax-functionality-cs/_static/image2.png)）
...
**列表 Controllers\ContactController.cs （Index 方法）**
...
[!["删除确认" 页面](iteration-7-add-ajax-functionality-cs/_static/image2.jpg)](iteration-7-add-ajax-functionality-cs/_static/image3.png)

**图 02**： "删除确认" 页面（[单击以查看完全大小的图像](iteration-7-add-ajax-functionality-cs/_static/image4.png)）
