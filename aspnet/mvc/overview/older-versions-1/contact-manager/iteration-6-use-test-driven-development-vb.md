...
我们还没有真正实现任何与我们实际 EntityContactManagerRepository 类中的联系人组处理相关的方法。 目前，EntityContactManagerRepository 类 IContactManagerRepository 界面中列出的联系人组方法的每个具有存根 （stub） 方法。 例如，ListGroups() 方法当前如下所示：
