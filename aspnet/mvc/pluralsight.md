...
- [简介和先决条件](https://pluralsight.com/training/Player?author=scott-allen&name=aspdotnet-mvc5-fundamentals-m1-introduction&mode=live&clip=0&course=aspdotnet-mvc5-fundamentals)
...
- [标识和安全](https://pluralsight.com/training/Player?author=scott-allen&name=aspdotnet-mvc5-fundamentals-m3-identity&mode=live&clip=0&course=aspdotnet-mvc5-fundamentals)
...
> K.Scott Allen Pluralsight 的记录此 MVC 5 课程提供快速掌握最新版本的 ASP.NET MVC 上的绝佳方法。 Scott 的演示文稿样式是可以轻松地遵循和从技术上讲极具吸引力，课程格式、 视频播放器和整体节奏是真的很棒。 加上-它是免费的因此没有理由不以立即了解 MVC 5 ！
>
> &mdash;Scott Guthrie 执行副总裁、 Microsoft Cloud and Enterprise 组中 Microsoft

![pluralsight logo playbutton](pluralsight/_static/image1.png)

取消锁定其访问 3,000 + 开发人员，IT，和创造性随时随地可以观看的课程。

* [ASP.NET MVC 5 基础](https://www.pluralsight.com/courses/aspdotnet-mvc5-fundamentals)
* [Pluralsight 定价和计划](https://www.pluralsight.com/pricing)
