...
---
# <a name="mvc-music-store-part-3-views-and-viewmodels"></a>MVC Music 商店第 3 部分：视图和 ViewModel

通过[Jon Galloway](https://github.com/jongalloway)

Jon 将继续介绍了视图、 Viewmodel 和母版页 MVC Music 商店教程。

[&#9654;观看视频 （13 分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/mvc-music-store-part-3-views-and-viewmodels)

> [!div class="step-by-step"]
> [上一个](mvc-music-store-part-2-controllers.md)
