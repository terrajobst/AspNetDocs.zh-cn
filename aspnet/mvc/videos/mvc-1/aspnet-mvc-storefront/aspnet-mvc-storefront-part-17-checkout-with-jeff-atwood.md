...
---
<a name="aspnet-mvc-storefront-part-17-checkout-with-jeff-atwood"></a>ASP.NET MVC 店面第 17 部分：与 Jeff Atwood 结算
====================
通过[Rob conery 专攻](https://github.com/robconery)

在本集中我签出过程准备并与自己，Jeff Atwood 先生 CodingHorror 交流。 我们谈一谈各种各样的因素，但主要讨论 Open ID、 CardSpace 和 Jeff 希望如何查看在理想情况下工作的签出过程。 我然后引导你完成设置 CardSpace 在本地计算机上。
