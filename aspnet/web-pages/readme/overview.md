...
## <a name="changes-and-issues"></a><span data-ttu-id="ca37d-130">更改和问题</span><span class="sxs-lookup"><span data-stu-id="ca37d-130">Changes and Issues</span></span>
...
> <span data-ttu-id="ca37d-145">**解决方法**</span><span class="sxs-lookup"><span data-stu-id="ca37d-145">**Workaround**</span></span>  
...
> <span data-ttu-id="ca37d-158">卸载 SQL Server Compact 使用命令行选项不适用于此版本。</span><span class="sxs-lookup"><span data-stu-id="ca37d-158">Uninstallation of SQL Server Compact using command-line options does not work in this release.</span></span>
> 
...
> 2. <span data-ttu-id="ca37d-211">删除*packages.config*在网站的根目录中的文件。</span><span class="sxs-lookup"><span data-stu-id="ca37d-211">Delete the *packages.config* file in the root of the website.</span></span>
...
>      <span data-ttu-id="ca37d-249">**to** *\Bin*</span><span class="sxs-lookup"><span data-stu-id="ca37d-249">**to** *\Bin*</span></span>
...
> <span data-ttu-id="ca37d-273">**解决方法**</span><span class="sxs-lookup"><span data-stu-id="ca37d-273">**Workaround**</span></span>  
> 
...
> <span data-ttu-id="ca37d-290">WebMatrix 1.0 是无法执行某些任务需要提升，例如，在以下情况下安装其他组件：</span><span class="sxs-lookup"><span data-stu-id="ca37d-290">WebMatrix 1.0 is unable to perform certain tasks that require elevation, such as installing additional components in the following situations:</span></span>
> 
...
[<span data-ttu-id="ca37d-337">https://go.microsoft.com/fwlink/?LinkID=207675&amp;clcid=0x409</span><span class="sxs-lookup"><span data-stu-id="ca37d-337">https://go.microsoft.com/fwlink/?LinkID=207675&amp;clcid=0x409</span></span>](https://go.microsoft.com/fwlink/?LinkID=207675&amp;clcid=0x409)
...
> <span data-ttu-id="ca37d-348">WebMatrix 不完全支持为 SQL Server Compact 的支持的二进制文件部署到正在运行.NET Framework 版本 3.5 使用中等信任配置的服务器。</span><span class="sxs-lookup"><span data-stu-id="ca37d-348">WebMatrix does not fully support deploying supporting binaries for SQL Server Compact to a server that is running .NET Framework version 3.5 with a medium trust configuration.</span></span>
> 
...
> <span data-ttu-id="ca37d-360">发布的 Moodle 应用程序后，应用程序不会无法正常工作。</span><span class="sxs-lookup"><span data-stu-id="ca37d-360">After you publish a Moodle application, the application does not work correctly.</span></span>
> 
...
#### <a name="issue-some-links-in-atomsite-are-broken-after-you-download-a-published-site"></a><span data-ttu-id="ca37d-402">问题：下载已发布的站点之后，AtomSite 中的某些链接已断开</span><span class="sxs-lookup"><span data-stu-id="ca37d-402">Issue: Some links in AtomSite are broken after you download a published site</span></span>
...
#### <a name="issue-download-published-site-fails-for-applications-that-have-browser-based-setup"></a><span data-ttu-id="ca37d-413">问题："下载已发布的站点"失败的应用程序的基于浏览器的设置</span><span class="sxs-lookup"><span data-stu-id="ca37d-413">Issue: "Download published site" fails for applications that have browser-based setup</span></span>

> <span data-ttu-id="ca37d-414">某些应用程序 (例如，订购 Kentico CMS) 要求你在浏览器中启动它们才能执行安装后设置，如创建数据库。</span><span class="sxs-lookup"><span data-stu-id="ca37d-414">Some applications (for example, Kentico CMS) require you to launch them in the browser in order to perform post-installation setup such as creating a database.</span></span> <span data-ttu-id="ca37d-415">如果发布这样的应用程序，而无需完成基于浏览器的设置，请尝试从远程服务器下载同一站点将失败。</span><span class="sxs-lookup"><span data-stu-id="ca37d-415">If you publish an application like this without completing the browser-based setup, attempting to download the same site from a remote server will fail.</span></span>
> 
> <span data-ttu-id="ca37d-416">**解决方法**</span><span class="sxs-lookup"><span data-stu-id="ca37d-416">**Workaround**</span></span>  
> <span data-ttu-id="ca37d-417">将站点发布之前完成基于浏览器的设置。</span><span class="sxs-lookup"><span data-stu-id="ca37d-417">Finish browser-based setup before publishing the site.</span></span>


#### <a name="issue-download-published-site-fails-with-a-database-error-for-dotnetnuke-and-kooboo-cms"></a><span data-ttu-id="ca37d-418">问题："下载已发布的站点"失败，出现数据库错误 DotNetNuke 和 Kooboo CMS</span><span class="sxs-lookup"><span data-stu-id="ca37d-418">Issue: "Download published site" fails with a database error for DotNetNuke and Kooboo CMS</span></span>

> <span data-ttu-id="ca37d-419">如果你尝试从服务器下载应用程序和数据库连接字符串中具有管理员凭据**发布设置**对话框中，可能会看到发布日志中的以下错误：</span><span class="sxs-lookup"><span data-stu-id="ca37d-419">If you try to download an application from a server and you have administrator credentials in the database connection string in the **Publish Settings** dialog, you might see the following error in the publish log:</span></span>
> 
> [!code-console[Main](overview/samples/sample9.cmd)]
> 
> <span data-ttu-id="ca37d-420">**解决方法**</span><span class="sxs-lookup"><span data-stu-id="ca37d-420">**Workaround**</span></span>  
> <span data-ttu-id="ca37d-421">如果可行，重新发布该网站 （或将其发布） 的数据库使用非管理员凭据。</span><span class="sxs-lookup"><span data-stu-id="ca37d-421">If practical, republish the site (or have it published) using non-administrator credentials for the database.</span></span>


<a id="More_Info"></a>

## <a name="for-more-information"></a><span data-ttu-id="ca37d-422">更多信息</span><span class="sxs-lookup"><span data-stu-id="ca37d-422">For More Information</span></span>

<span data-ttu-id="ca37d-423">有关 WebMatrix 1.0 的详细信息，请参阅以下网站：</span><span class="sxs-lookup"><span data-stu-id="ca37d-423">For more information about WebMatrix 1.0, see the following websites:</span></span>

- [<span data-ttu-id="ca37d-424">IIS.net</span><span class="sxs-lookup"><span data-stu-id="ca37d-424">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="ca37d-425">ASP.NET 2.0</span><span class="sxs-lookup"><span data-stu-id="ca37d-425">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="ca37d-426">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="ca37d-426">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

<span data-ttu-id="ca37d-427">© 2011 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="ca37d-427">© 2011 Microsoft Corporation.</span></span> <span data-ttu-id="ca37d-428">保留所有权利。</span><span class="sxs-lookup"><span data-stu-id="ca37d-428">All Rights Reserved.</span></span> <span data-ttu-id="ca37d-429">[使用条款](https://msdn.microsoft.cos/cc300389.aspx)。</span><span class="sxs-lookup"><span data-stu-id="ca37d-429">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
