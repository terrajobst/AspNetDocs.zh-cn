...
---
# <a name="displaying-data-in-a-chart-part-1"></a>在图表中显示数据（第 1 部分）

作者： [Joe Stagner](https://github.com/JoeStagner)

视频 accompaniment 在图表中显示数据教程（第1部分）

[&#9654;观看视频（12分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/displaying-data-in-a-chart-(part-1))
