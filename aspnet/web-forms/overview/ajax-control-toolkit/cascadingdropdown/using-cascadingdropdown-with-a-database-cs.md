...
[![T他的第一个列表是自动填充](using-cascadingdropdown-with-a-database-cs/_static/image2.png)](using-cascadingdropdown-with-a-database-cs/_static/image1.png)

自动填充第一个列表 ([单击此项可查看原尺寸图像](using-cascadingdropdown-with-a-database-cs/_static/image3.png))


[![T根据第一个列表中选择填充他第二个列表](using-cascadingdropdown-with-a-database-cs/_static/image5.png)](using-cascadingdropdown-with-a-database-cs/_static/image4.png)
