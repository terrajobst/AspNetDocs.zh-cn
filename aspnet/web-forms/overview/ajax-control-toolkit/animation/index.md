...
- [选取列表中的一个动画 (C#)](picking-one-animation-out-of-a-list-cs.md)
...
- [对 UpdatePanel 控件执行动画处理 (C#)](animating-an-updatepanel-control-cs.md)
...
- [选取列表中的一个动画 (VB)](picking-one-animation-out-of-a-list-vb.md)
