...
---
# <a name="how-do-i-use-the-html-editor-control-vb"></a>如何实现使用 HTML 编辑器控件吗？ (VB)
...
**图 01**： HTML 编辑器（[单击以查看完全大小的图像](how-do-i-use-the-html-editor-control-vb/_static/image2.png)）
...
**图 02**：设计、HTML 和预览按钮（[单击以查看完全大小的图像](how-do-i-use-the-html-editor-control-vb/_static/image4.png)）
...
**图 03**： HTML 编辑器控件（[单击以查看完全大小的图像](how-do-i-use-the-html-editor-control-vb/_static/image6.png)）
...
[![使用 HTML 编辑器提交窗体](how-do-i-use-the-html-editor-control-vb/_static/image4.jpg)](how-do-i-use-the-html-editor-control-vb/_static/image7.png)

**图 04**：使用 HTML 编辑器提交窗体（[单击以查看完全大小的图像](how-do-i-use-the-html-editor-control-vb/_static/image8.png)）
...
**图 05**：自定义的 HTML 编辑器（[单击以查看完全大小的图像](how-do-i-use-the-html-editor-control-vb/_static/image10.png)）
...
> [上一页](how-do-i-use-the-html-editor-control-cs.md)
