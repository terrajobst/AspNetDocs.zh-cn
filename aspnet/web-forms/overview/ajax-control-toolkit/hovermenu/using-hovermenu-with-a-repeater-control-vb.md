...
[下载代码](https://download.microsoft.com/download/b/0/6/b06fe835-5b8f-4c00-aef8-062c19d75b95/HoverMenu1.vb.zip)或[下载 PDF](https://download.microsoft.com/download/b/6/a/b6ae89ee-df69-4c87-9bfb-ad1eb2b23373/hovermenu1VB.pdf)
...
[![在 repeater 中的每一项旁边显示悬停菜单](using-hovermenu-with-a-repeater-control-vb/_static/image2.png)](using-hovermenu-with-a-repeater-control-vb/_static/image1.png)

悬停菜单显示在 repeater 中每个项的旁边（[单击以查看完全大小的图像](using-hovermenu-with-a-repeater-control-vb/_static/image3.png)）

> [!div class="step-by-step"]
> [上一页](using-hovermenu-with-a-repeater-control-cs.md)
