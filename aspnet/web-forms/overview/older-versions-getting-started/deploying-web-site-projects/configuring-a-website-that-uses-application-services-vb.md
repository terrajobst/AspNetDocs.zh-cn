...
有关 ASP.NET 的 URL 授权功能以及如何使用它为用户和角色的授权规则明确说明的详细信息请阅读[*基于用户的授权*](../../older-versions-security/membership/user-based-authorization-vb.md)和[*基于角色的授权*](../../older-versions-security/roles/role-based-authorization-vb.md)教程从我[*网站安全教程*](../../older-versions-security/introduction/security-basics-and-asp-net-support-cs.md)。
...
- [*SQL Server 中创建成员身份架构*](../../older-versions-security/membership/creating-the-membership-schema-in-sql-server-vb.md)
