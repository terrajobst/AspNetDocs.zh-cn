...
[![T他通讯簿评审 Web 应用程序的数据库是包含的四个表](deploying-a-database-vb/_static/image2.jpg)](deploying-a-database-vb/_static/image1.jpg) 
...
[![T他技术流派页](deploying-a-database-vb/_static/image5.jpg)](deploying-a-database-vb/_static/image4.jpg) 

**图 2**:技术流派页 ([单击此项可查看原尺寸图像](deploying-a-database-vb/_static/image6.jpg))


[![T在 24 小时内的教授自己 ASP.NET 3.5 查看他](deploying-a-database-vb/_static/image8.jpg)](deploying-a-database-vb/_static/image7.jpg) 
...
[![Locate 数据库资源管理器或服务器资源管理器中的数据库](deploying-a-database-vb/_static/image11.jpg)](deploying-a-database-vb/_static/image10.jpg) 
...
[![T他数据库发布向导的初始屏幕](deploying-a-database-vb/_static/image14.jpg)](deploying-a-database-vb/_static/image13.jpg) 
...
[![T他数据库发布向导的初始屏幕](deploying-a-database-vb/_static/image17.jpg)](deploying-a-database-vb/_static/image16.jpg) 
...
[![Script 数据库添加到一个文件或将其发布到你的 Web 宿主提供程序直接](deploying-a-database-vb/_static/image20.jpg)](deploying-a-database-vb/_static/image19.jpg) 
...
[![S指定发布选项](deploying-a-database-vb/_static/image23.jpg)](deploying-a-database-vb/_static/image22.jpg) 
...
[![C为你的 Web 主机提供商 s 数据库服务器 onnect](deploying-a-database-vb/_static/image26.jpg)](deploying-a-database-vb/_static/image25.jpg) 
...
[![C为你的 Web 主机提供商 s 数据库服务器 onnect](deploying-a-database-vb/_static/image29.jpg)](deploying-a-database-vb/_static/image28.jpg) 
...
[![T他对象具有重复生产数据库上数据库](deploying-a-database-vb/_static/image32.jpg)](deploying-a-database-vb/_static/image31.jpg) 

**图 11**:数据库对象已复制了生产数据库上 ([单击此项可查看原尺寸图像](deploying-a-database-vb/_static/image33.jpg))


[![T他生产数据库上开发数据库包含相同的数据](deploying-a-database-vb/_static/image35.jpg)](deploying-a-database-vb/_static/image34.jpg) 
