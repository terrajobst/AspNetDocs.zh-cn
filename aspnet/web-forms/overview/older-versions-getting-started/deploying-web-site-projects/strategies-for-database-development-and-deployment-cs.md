...
[![SQL 比较列出了开发和生产数据库之间的差异](strategies-for-database-development-and-deployment-cs/_static/image5.jpg)](strategies-for-database-development-and-deployment-cs/_static/image4.jpg)

**图 2**:SQL 比较列出了开发之间的差异和生产数据库 ([单击此项可查看原尺寸图像](strategies-for-database-development-and-deployment-cs/_static/image6.jpg))
