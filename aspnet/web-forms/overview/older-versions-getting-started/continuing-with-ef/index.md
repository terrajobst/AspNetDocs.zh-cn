...
title: ASP.NET 4-继续实体框架4和 Web 窗体 |Microsoft Docs
author: rick-anderson
description: 如何使用 ObjectDataSource 控件生成 Contoso U 应用程序作为 n 层应用程序以及如何处理并发和最大化性能。
ms.author: riande
ms.date: 10/05/2011
