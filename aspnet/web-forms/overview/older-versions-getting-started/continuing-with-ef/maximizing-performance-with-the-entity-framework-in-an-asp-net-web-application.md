...
- [使用实体框架和对象数据源：自定义分页](http://geekswithblogs.net/Frez/articles/using-the-entity-framework-and-the-objectdatasource-custom-paging.aspx)。 在这些教程中创建的 ContosoUniversity 应用程序说明如何实现分页中的为基础的博客文章*Departments.aspx*页。
