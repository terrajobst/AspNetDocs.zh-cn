...
title: 在 SQL Server 中创建成员身份架构 |Microsoft Docs
...
**图 1**：将名为 `SecurityTutorials.mdf` 数据库的新 SQL 数据库添加到 `App_Data` 文件夹（[单击查看完全大小的映像](creating-the-membership-schema-in-sql-server-vb/_static/image3.png)）
...
**图 2**： `SecurityTutorials` 数据库当前为空（[单击以查看完全大小的图像](creating-the-membership-schema-in-sql-server-vb/_static/image6.png)）
...
**图 3**：连接到 SQL Server 2005 Express Edition 实例（[单击以查看完全大小的图像](creating-the-membership-schema-in-sql-server-vb/_static/image9.png)）
...
**图 4**：附加 `SecurityTutorials.mdf` 数据库（[单击以查看完全大小的图像](creating-the-membership-schema-in-sql-server-vb/_static/image12.png)）

[![SecurityTutorials 数据库出现在 "数据库" 文件夹中](creating-the-membership-schema-in-sql-server-vb/_static/image14.png)](creating-the-membership-schema-in-sql-server-vb/_static/image13.png)

**图 5**： `SecurityTutorials.mdf` 数据库显示在 "数据库" 文件夹中（[单击以查看完全大小的图像](creating-the-membership-schema-in-sql-server-vb/_static/image15.png)）
...
**图 6**：将数据库重命名为 `SecurityTutorialsDatabase`（[单击查看完全大小的映像](creating-the-membership-schema-in-sql-server-vb/_static/image18.png)）
...
[![使用 ASP.NET SQL Server 安装向导添加成员身份架构](creating-the-membership-schema-in-sql-server-vb/_static/image20.png)](creating-the-membership-schema-in-sql-server-vb/_static/image19.png)

**图 7**：使用 ASP.NET SQL Server 安装向导来添加成员身份架构（[单击以查看完全大小的映像](creating-the-membership-schema-in-sql-server-vb/_static/image21.png)）
...
[![选择为应用程序服务选项配置 SQL Server](creating-the-membership-schema-in-sql-server-vb/_static/image23.png)](creating-the-membership-schema-in-sql-server-vb/_static/image22.png)

**图 8**：选择 "为应用程序服务配置 SQL Server" 选项（[单击以查看完全大小的映像](creating-the-membership-schema-in-sql-server-vb/_static/image24.png)）
...
**图 9**：输入数据库信息（[单击以查看完全大小的映像](creating-the-membership-schema-in-sql-server-vb/_static/image27.png)）
...
[已在数据库中添加了 ![多个表、视图和存储过程](creating-the-membership-schema-in-sql-server-vb/_static/image29.png)](creating-the-membership-schema-in-sql-server-vb/_static/image28.png)

**图 10**：已将各种表、视图和存储过程添加到数据库中（[单击以查看完全大小的图像](creating-the-membership-schema-in-sql-server-vb/_static/image30.png)）
...
[![用户帐户可以跨多个应用程序进行分区](creating-the-membership-schema-in-sql-server-vb/_static/image32.png)](creating-the-membership-schema-in-sql-server-vb/_static/image31.png)

**图 11**：可以跨多个应用程序对用户帐户进行分区（[单击查看完全大小的映像](creating-the-membership-schema-in-sql-server-vb/_static/image33.png)）
...
> [!NOTE]
> `SqlMembershipProvider` 所使用的特定加密或哈希算法由 `<machineKey>` 元素中的设置确定。 我们在<a id="Tutorial3"> </a> [*Forms 身份验证配置和高级主题*](../introduction/forms-authentication-configuration-and-advanced-topics-vb.md)教程的步骤3中讨论了此配置元素。
