...
**图 2**:添加名为的新文件夹`CL`和一个名为类 `ProductsCL.cs`
...
[![T他 ProductsCL 类包括在业务对象下拉列表](caching-data-in-the-architecture-cs/_static/image5.png)](caching-data-in-the-architecture-cs/_static/image4.png)

**图 4**:`ProductsCL`类包含在业务对象下拉列表 ([单击以查看实际尺寸的图像](caching-data-in-the-architecture-cs/_static/image6.png))
...
[![T他在下拉列表中列出了 ProductsCL 类的方法](caching-data-in-the-architecture-cs/_static/image8.png)](caching-data-in-the-architecture-cs/_static/image7.png)
