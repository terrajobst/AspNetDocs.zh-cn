...
[![E支票中 GridView 行是可编辑](batch-updating-cs/_static/image1.gif)](batch-updating-cs/_static/image1.png)

**图 1**:在 GridView 中的每一行都是可编辑 ([单击此项可查看原尺寸图像](batch-updating-cs/_static/image2.png))
...
[![C配置对象数据源以使用 ProductsBLL 类](batch-updating-cs/_static/image2.gif)](batch-updating-cs/_static/image3.png)

**图 2**:配置为使用 ObjectDataSource`ProductsBLL`类 ([单击以查看实际尺寸的图像](batch-updating-cs/_static/image4.png))


[![Retrieve 使用 GetProducts 方法的产品数据](batch-updating-cs/_static/image3.gif)](batch-updating-cs/_static/image5.png)
...
[![Set 更新、 插入和删除选项卡添加到 （无） 中的下拉列表](batch-updating-cs/_static/image4.gif)](batch-updating-cs/_static/image7.png)

**图 4**:设置下拉列表列出了在更新、 插入和删除选项卡中为 （无） ([单击此项可查看原尺寸图像](batch-updating-cs/_static/image8.png))
...
[![T他 ProductName TemplateField 现在包含一个文本框和一个 RequiredFieldValidator](batch-updating-cs/_static/image6.gif)](batch-updating-cs/_static/image9.png)
...
[![Add CompareValidator，确保价格输入为非负货币值](batch-updating-cs/_static/image7.gif)](batch-updating-cs/_static/image11.png)

**图 7**:添加 CompareValidator，确保价格输入是一个非负货币值 ([单击此项可查看原尺寸图像](batch-updating-cs/_static/image12.png))
...
[![C配置对象数据源以使用 CategoriesBLL 类](batch-updating-cs/_static/image8.gif)](batch-updating-cs/_static/image13.png)

**图 8**:配置为使用 ObjectDataSource`CategoriesBLL`类 ([单击以查看实际尺寸的图像](batch-updating-cs/_static/image14.png))


[![Retrieve 使用 GetCategories 方法类别数据](batch-updating-cs/_static/image9.gif)](batch-updating-cs/_static/image15.png)
...
[![Set 更新和删除选项卡添加到 （无） 中的下拉列表](batch-updating-cs/_static/image10.gif)](batch-updating-cs/_static/image17.png)

**图 10**:设置下拉列表列出了更新和删除选项卡中为 （无） ([单击此项可查看原尺寸图像](batch-updating-cs/_static/image18.png))
...
[![Bind 到 CategoriesDataSource DropDownList](batch-updating-cs/_static/image11.gif)](batch-updating-cs/_static/image19.png)
...
[![E支票 GridView 行是可编辑](batch-updating-cs/_static/image13.gif)](batch-updating-cs/_static/image21.png)

**图 13**:每个 GridView 行是可编辑 ([单击此项可查看原尺寸图像](batch-updating-cs/_static/image22.png))
...
[![T他页现在包含两个更新的产品按钮](batch-updating-cs/_static/image16.gif)](batch-updating-cs/_static/image23.png)

**图 16**:页现在包含两个更新的产品按钮 ([单击此项可查看原尺寸图像](batch-updating-cs/_static/image24.png))
