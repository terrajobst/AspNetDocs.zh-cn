...
为了提供此行为，我们需要使用通过调用页面方法发出相应的输出基于在生成其内容为 TemplateField`BrochurePath`值。 我们先探讨了此格式设置方法返回[GridView 控件中使用 Templatefield](../custom-formatting/using-templatefields-in-the-gridview-control-cs.md)教程。
