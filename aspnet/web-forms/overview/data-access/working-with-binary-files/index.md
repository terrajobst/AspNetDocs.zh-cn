...
- [添加新纪录时增加文件上载选项 (C#)](including-a-file-upload-option-when-adding-a-new-record-cs.md)
- [上载和删除现有的二进制数据 (C#)](updating-and-deleting-existing-binary-data-cs.md)
- [上载文件 (VB)](uploading-files-vb.md)
- [显示数据 Web 控件中的二进制数据 (VB)](displaying-binary-data-in-the-data-web-controls-vb.md)
- [添加新纪录时增加文件上载选项 (VB)](including-a-file-upload-option-when-adding-a-new-record-vb.md)
- [上载和删除现有的二进制数据 (VB)](updating-and-deleting-existing-binary-data-vb.md)
