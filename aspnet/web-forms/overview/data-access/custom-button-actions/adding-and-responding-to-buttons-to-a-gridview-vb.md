...
[![B其他 FormView 和 GridView 包含按钮，执行自定义操作](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image2.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image1.png)

**图 1**:FormView 和 GridView 包含按钮，执行自定义操作 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image3.png))
...
[![Add SectionLevelTutorialListing.ascx 用户控件到 Default.aspx](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image6.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image5.png)
...
[![C创建新对象数据源名为 SuppliersDataSource](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image10.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image9.png)
...
[![C配置数据源以使用 SuppliersBLL 类的 GetSuppliers() 方法](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image13.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image12.png)
...
[![T他 FormView 列出 CompanyName 和当前所选供应商的电话号码字段](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image16.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image15.png)

**图 7**:FormView 列出`CompanyName`并`Phone`字段从当前所选供应商 ([单击以查看实际尺寸的图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image17.png))
...
[![C创建新对象数据源名为 SuppliersProductsDataSource](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image19.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image18.png)
...
配置此 ObjectDataSource 使用 ProductsBLL 类的`GetProductsBySupplierID(supplierID)`方法 （请参阅图 9）。 尽管此 GridView 将允许针对产品的价格调整，它不会使用内置编辑或删除从 GridView 的功能。 因此，我们可以设置为 （无） 下拉列表的 ObjectDataSource s 更新、 插入和删除选项卡。


[![C配置数据源以使用 ProductsBLL 类的 GetProductsBySupplierID(supplierID) 方法](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image22.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image21.png)
...
[![I供应商 Id 参数应来自供应商 FormView 控件指示](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image25.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image24.png)
...
[![T他在 GridView 中显示的产品的所选供应商 s](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image28.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image27.png)

**图 11**:GridView 中显示所选供应商的产品 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image29.png))
...
[![C创建 DAL 的方法使用临时 SQL 语句](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image31.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image30.png)

**图 12**:创建 DAL 的方法使用一个临时 SQL 语句 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image32.png))
...
[![C选择更新查询类型](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image34.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image33.png)

**图 13**:选择更新查询类型 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image35.png))
...
[![N\ 新 DAL 方法 DiscontinueAllProductsForSupplier 名称](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image37.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image36.png)
...
[![Add 的停止所有产品按钮 Web 控件与 s 的 FormView ItemTemplate](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image40.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image39.png)
...
**图 16**:Cooperativa de Quesos Las Cabras 提供两个活动产品 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image44.png))
...
[![A单击停止所有产品按钮，页符供应商的产品的相应地更新](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image46.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image45.png)

**图 17**:单击停止所有的产品按钮后，供应商的产品更新相应地受到了 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image47.png))
...
[![T他 GridView 包括价格 + 10%和价格-10%按钮](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image51.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image50.png)

**图 20**:GridView 包括价格 + 10%和价格-10%按钮 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image52.png))


[![T他价格的第一个和第三个产品已更新通过价格 + 10%和价格-10%按钮](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image54.png)](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image53.png)

**图 21**:第一个和第三个产品已更新通过价格 + 10 的价格 %和价格-10%按钮 ([单击此项可查看原尺寸图像](adding-and-responding-to-buttons-to-a-gridview-vb/_static/image55.png))
...
> [上一个](adding-and-responding-to-buttons-to-a-gridview-cs.md)
