...
- <span data-ttu-id="c5e96-127">使用强类型化数据绑定表达式</span><span class="sxs-lookup"><span data-stu-id="c5e96-127">Use strongly-typed data-binding expressions</span></span>
...
<span data-ttu-id="c5e96-143">本动手实验包括以下练习：</span><span class="sxs-lookup"><span data-stu-id="c5e96-143">This hands-on lab includes the following exercises:</span></span>
...
6. <span data-ttu-id="c5e96-222">按**F5**可开始调试网站并转到产品页。</span><span class="sxs-lookup"><span data-stu-id="c5e96-222">Press **F5** to start debugging the site and go to the Products page.</span></span> <span data-ttu-id="c5e96-223">你应看到 GridView 中填充了 GetCategories 方法返回的类别。</span><span class="sxs-lookup"><span data-stu-id="c5e96-223">You should see that the GridView is populated with the categories returned by the GetCategories method.</span></span>
    ...
    <span data-ttu-id="c5e96-225">*填充 GridView 使用模型绑定*</span><span class="sxs-lookup"><span data-stu-id="c5e96-225">*Populating a GridView using model binding*</span></span>
...
<span data-ttu-id="c5e96-288">在上一任务中，选择数据的主要使用模型绑定，在此任务中，您将学习如何在更新操作中使用模型绑定。</span><span class="sxs-lookup"><span data-stu-id="c5e96-288">In the previous task, you have used model binding mainly for selecting data, in this task you will learn how to use model binding in update operations.</span></span>
...
4. <span data-ttu-id="c5e96-402">运行网站并转到产品页。</span><span class="sxs-lookup"><span data-stu-id="c5e96-402">Run the site and go to the Products page.</span></span> <span data-ttu-id="c5e96-403">尝试更新使用的重复的值的类别的名称。</span><span class="sxs-lookup"><span data-stu-id="c5e96-403">Try to update the name of a category using an duplicated value.</span></span>

    <span data-ttu-id="c5e96-404">请注意，处理异常和错误消息显示在**ValidationSummary**控件。</span><span class="sxs-lookup"><span data-stu-id="c5e96-404">Notice that the exception was handled and the error message appears in the **ValidationSummary** control.</span></span>

    <span data-ttu-id="c5e96-405">![复制类别错误](whats-new-in-web-forms-in-aspnet-45/_static/image17.png "重复类别错误")</span><span class="sxs-lookup"><span data-stu-id="c5e96-405">![Duplicated category error](whats-new-in-web-forms-in-aspnet-45/_static/image17.png "Duplicated category error")</span></span>

    <span data-ttu-id="c5e96-406">*重复的类别错误*</span><span class="sxs-lookup"><span data-stu-id="c5e96-406">*Duplicated category error*</span></span>

<a id="Task_4_-_Request_Validation_in_ASPNET_Web_Forms_45"></a>
#### <a name="task-4---request-validation-in-aspnet-web-forms-45"></a><span data-ttu-id="c5e96-407">任务 4-请求 ASP.NET Web 窗体 4.5 中的验证</span><span class="sxs-lookup"><span data-stu-id="c5e96-407">Task 4 - Request Validation in ASP.NET Web Forms 4.5</span></span>

<span data-ttu-id="c5e96-408">在 ASP.NET 请求验证功能提供了一定的默认保护免受跨站点脚本 (XSS) 攻击。</span><span class="sxs-lookup"><span data-stu-id="c5e96-408">The request validation feature in ASP.NET provides a certain level of default protection against cross-site scripting (XSS) attacks.</span></span> <span data-ttu-id="c5e96-409">在以前版本的 ASP.NET，请求验证默认情况下已启用，仅可以禁用整个页面。</span><span class="sxs-lookup"><span data-stu-id="c5e96-409">In previous versions of ASP.NET, request validation was enabled by default and could only be disabled for an entire page.</span></span> <span data-ttu-id="c5e96-410">使用 ASP.NET Web 窗体的新版本现在可以禁用单个控件请求验证、 执行延迟请求验证或访问未经过验证的请求数据 （请小心，如果这样做 ！）。</span><span class="sxs-lookup"><span data-stu-id="c5e96-410">With the new version of ASP.NET Web Forms you can now disable the request validation for a single control, perform lazy request validation or access un-validated request data (be careful if you do so!).</span></span>

1. <span data-ttu-id="c5e96-411">按**Ctrl + F5**启动网站，而不进行调试，转到产品页。</span><span class="sxs-lookup"><span data-stu-id="c5e96-411">Press **Ctrl+F5** to start the site without debugging and go to the Products page.</span></span> <span data-ttu-id="c5e96-412">选择一个类别，然后单击**编辑**上的任何产品的链接。</span><span class="sxs-lookup"><span data-stu-id="c5e96-412">Select a category and then click the **Edit** link on any of the products.</span></span>
2. <span data-ttu-id="c5e96-413">键入包含具有潜在危险的内容，例如包括 HTML 标记的说明。</span><span class="sxs-lookup"><span data-stu-id="c5e96-413">Type a description containing potentially dangerous content, for instance including HTML tags.</span></span> <span data-ttu-id="c5e96-414">注意由于请求验证引发的异常。</span><span class="sxs-lookup"><span data-stu-id="c5e96-414">Take notice of the exception thrown due to the request validation.</span></span>

    <span data-ttu-id="c5e96-415">![编辑与具有潜在危险的内容的产品](whats-new-in-web-forms-in-aspnet-45/_static/image18.png "编辑产品具有潜在危险的内容")</span><span class="sxs-lookup"><span data-stu-id="c5e96-415">![Editing a product with potentially dangerous content](whats-new-in-web-forms-in-aspnet-45/_static/image18.png "Editing a product with potentially dangerous content")</span></span>

    <span data-ttu-id="c5e96-416">*编辑产品具有潜在危险的内容*</span><span class="sxs-lookup"><span data-stu-id="c5e96-416">*Editing a product with potentially dangerous content*</span></span>

    <span data-ttu-id="c5e96-417">![因请求验证而引发的异常](whats-new-in-web-forms-in-aspnet-45/_static/image19.png "因请求验证而引发的异常")</span><span class="sxs-lookup"><span data-stu-id="c5e96-417">![Exception thrown due to request validation](whats-new-in-web-forms-in-aspnet-45/_static/image19.png "Exception thrown due to request validation")</span></span>

    <span data-ttu-id="c5e96-418">*因请求验证而引发的异常*</span><span class="sxs-lookup"><span data-stu-id="c5e96-418">*Exception thrown due to request validation*</span></span>
3. <span data-ttu-id="c5e96-419">关闭页，并在 Visual Studio 中，按**SHIFT + F5**以停止调试。</span><span class="sxs-lookup"><span data-stu-id="c5e96-419">Close the page and, in Visual Studio, press **SHIFT+F5** to stop debugging.</span></span>
4. <span data-ttu-id="c5e96-420">打开**ProductDetails.aspx**页上，找到**说明**文本框中。</span><span class="sxs-lookup"><span data-stu-id="c5e96-420">Open the **ProductDetails.aspx** page and locate the **Description** TextBox.</span></span>
5. <span data-ttu-id="c5e96-421">添加新**ValidateRequestMode**属性设置为文本框中并将其值设置为**禁用**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-421">Add the new **ValidateRequestMode** property to the TextBox and set its value to **Disabled**.</span></span>

    <span data-ttu-id="c5e96-422">新**ValidateRequestMode**特性，您可以禁用每个控件上精细地请求验证。</span><span class="sxs-lookup"><span data-stu-id="c5e96-422">The new **ValidateRequestMode** attribute allows you to disable the request validation granularly on each control.</span></span> <span data-ttu-id="c5e96-423">当你想要使用的输入的可能接收 HTML 代码，但想要保留的页的其余部分使用的验证时，这很有用。</span><span class="sxs-lookup"><span data-stu-id="c5e96-423">This is useful when you want to use an input that may receive HTML code, but want to keep the validation working for the rest of the page.</span></span>

    [!code-aspx[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample29.aspx)]
6. <span data-ttu-id="c5e96-424">按**F5**运行 web 应用程序。</span><span class="sxs-lookup"><span data-stu-id="c5e96-424">Press **F5** to run the web application.</span></span> <span data-ttu-id="c5e96-425">再次打开编辑产品页，并完成包括 HTML 标记的产品说明。</span><span class="sxs-lookup"><span data-stu-id="c5e96-425">Open the edit product page again and complete a product description including HTML tags.</span></span> <span data-ttu-id="c5e96-426">请注意，可以现在将 HTML 内容添加到说明。</span><span class="sxs-lookup"><span data-stu-id="c5e96-426">Notice that you can now add HTML content to the description.</span></span>

    <span data-ttu-id="c5e96-427">![请求验证的产品说明禁用](whats-new-in-web-forms-in-aspnet-45/_static/image20.png "请求验证已禁用的产品说明")</span><span class="sxs-lookup"><span data-stu-id="c5e96-427">![Request validation disabled for the product description](whats-new-in-web-forms-in-aspnet-45/_static/image20.png "Request validation disabled for the product description")</span></span>

    <span data-ttu-id="c5e96-428">*请求验证已禁用的产品说明*</span><span class="sxs-lookup"><span data-stu-id="c5e96-428">*Request validation disabled for the product description*</span></span>

    > [!NOTE]
    > <span data-ttu-id="c5e96-429">应在生产应用程序中，清理输入的用户名，以确保输入唯一安全的 HTML 标记的 HTML 代码 (例如，有没有&lt;脚本&gt;标记)。</span><span class="sxs-lookup"><span data-stu-id="c5e96-429">In a production application, you should sanitize the HTML code entered by the user to make sure only safe HTML tags are entered (for example, there are no &lt;script&gt; tags).</span></span> <span data-ttu-id="c5e96-430">若要执行此操作，可以使用[Microsoft Web Protection Library](https://www.nuget.org/packages/AntiXSS)。</span><span class="sxs-lookup"><span data-stu-id="c5e96-430">To do this, you can use [Microsoft Web Protection Library](https://www.nuget.org/packages/AntiXSS).</span></span>
7. <span data-ttu-id="c5e96-431">再次编辑该产品。</span><span class="sxs-lookup"><span data-stu-id="c5e96-431">Edit the product again.</span></span> <span data-ttu-id="c5e96-432">在名称字段中键入 HTML 代码，然后单击**保存**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-432">Type HTML code in the Name field and click **Save**.</span></span> <span data-ttu-id="c5e96-433">请注意，说明字段中仅禁用请求验证并重新字段的其余部分仍验证针对具有潜在危险的内容。</span><span class="sxs-lookup"><span data-stu-id="c5e96-433">Notice that Request Validation is only disabled for the Description field and the rest of the fields re still validated against the potentially dangerous content.</span></span>

    <span data-ttu-id="c5e96-434">![请求验证其余字段中启用](whats-new-in-web-forms-in-aspnet-45/_static/image21.png "请求验证其余字段中启用")</span><span class="sxs-lookup"><span data-stu-id="c5e96-434">![Request validation enabled in the rest of the fields](whats-new-in-web-forms-in-aspnet-45/_static/image21.png "Request validation enabled in the rest of the fields")</span></span>

    <span data-ttu-id="c5e96-435">*在其余字段中启用请求验证*</span><span class="sxs-lookup"><span data-stu-id="c5e96-435">*Request validation enabled in the rest of the fields*</span></span>

    <span data-ttu-id="c5e96-436">ASP.NET Web 窗体 4.5 包括新的请求验证模式下惰式执行请求验证。</span><span class="sxs-lookup"><span data-stu-id="c5e96-436">ASP.NET Web Forms 4.5 includes a new request validation mode to perform request validation lazily.</span></span> <span data-ttu-id="c5e96-437">请求验证模式设置为**4.5**，如果一段代码访问*Request.Form [&quot;密钥&quot;]*，ASP.NET 4.5 请求验证将仅触发器请求验证该窗体集合中的特定元素。</span><span class="sxs-lookup"><span data-stu-id="c5e96-437">With the request validation mode set to **4.5**, if a piece of code accesses *Request.Form[&quot;key&quot;]*, ASP.NET 4.5's request validation will only trigger request validation for that specific element in the form collection.</span></span>

    <span data-ttu-id="c5e96-438">此外，ASP.NET 4.5 现在包括核心编码例程从 Microsoft ANTI-XSS 库版本 4.0。</span><span class="sxs-lookup"><span data-stu-id="c5e96-438">Additionally, ASP.NET 4.5 now includes core encoding routines from the Microsoft Anti-XSS Library v4.0.</span></span> <span data-ttu-id="c5e96-439">防 XSS 编码例程所实现的新*AntiXssEncoder*类型位于新**System.Web.Security.AntiXss**命名空间。</span><span class="sxs-lookup"><span data-stu-id="c5e96-439">The Anti-XSS encoding routines are implemented by the new *AntiXssEncoder* type found in the new **System.Web.Security.AntiXss** namespace.</span></span> <span data-ttu-id="c5e96-440">与**encoderType**配置为使用的参数*AntiXssEncoder*，自动编码在 ASP.NET 中使用新的编码例程，所有输出。</span><span class="sxs-lookup"><span data-stu-id="c5e96-440">With the **encoderType** parameter configured to use *AntiXssEncoder*, all output encoding within ASP.NET automatically uses the new encoding routines.</span></span>
8. <span data-ttu-id="c5e96-441">ASP.NET 4.5 请求验证还支持对请求数据未经过验证的访问。</span><span class="sxs-lookup"><span data-stu-id="c5e96-441">ASP.NET 4.5 request validation also supports un-validated access to request data.</span></span> <span data-ttu-id="c5e96-442">ASP.NET 4.5 中添加到新集合属性**HttpRequest**对象调用**Unvalidated**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-442">ASP.NET 4.5 adds a new collection property to the **HttpRequest** object called **Unvalidated**.</span></span> <span data-ttu-id="c5e96-443">导航到**HttpRequest.Unvalidated**有权访问的所有请求数据，包括窗体、 Querystring、 Cookie、 Url 和等等的公共部分。</span><span class="sxs-lookup"><span data-stu-id="c5e96-443">When you navigate into **HttpRequest.Unvalidated** you have access to all of the common pieces of request data, including Forms, QueryStrings, Cookies, URLs, and so on.</span></span>

    <span data-ttu-id="c5e96-444">![Request.Unvalidated 对象](whats-new-in-web-forms-in-aspnet-45/_static/image22.png "Request.Unvalidated 对象")</span><span class="sxs-lookup"><span data-stu-id="c5e96-444">![Request.Unvalidated object](whats-new-in-web-forms-in-aspnet-45/_static/image22.png "Request.Unvalidated object")</span></span>

    <span data-ttu-id="c5e96-445">*Request.Unvalidated 对象*</span><span class="sxs-lookup"><span data-stu-id="c5e96-445">*Request.Unvalidated object*</span></span>

    > [!NOTE]
    > <span data-ttu-id="c5e96-446">**请谨慎使用 HttpRequest.Unvalidated 属性 ！**</span><span class="sxs-lookup"><span data-stu-id="c5e96-446">**Please use the HttpRequest.Unvalidated property with caution!**</span></span> <span data-ttu-id="c5e96-447">请确保仔细对原始请求数据，以确保危险文本未往返和呈现回毫无戒心的客户执行自定义验证 ！</span><span class="sxs-lookup"><span data-stu-id="c5e96-447">Make sure you carefully perform custom validation on the raw request data to ensure that dangerous text is not round-tripped and rendered back to unsuspecting customers!</span></span>

<a id="Exercise3"></a>

<a id="Exercise_3_Asynchronous_Page_Processing_in_ASPNET_Web_Forms"></a>
### <a name="exercise-3-asynchronous-page-processing-in-aspnet-web-forms"></a><span data-ttu-id="c5e96-448">练习 3:异步页处理在 ASP.NET Web 窗体</span><span class="sxs-lookup"><span data-stu-id="c5e96-448">Exercise 3: Asynchronous Page Processing in ASP.NET Web Forms</span></span>

<span data-ttu-id="c5e96-449">在此练习中，将向你介绍新的异步页处理 ASP.NET Web 窗体中的功能。</span><span class="sxs-lookup"><span data-stu-id="c5e96-449">In this exercise, you will be introduced to the new asynchronous page processing features in ASP.NET Web Forms.</span></span>

<a id="Task_1_-_Updating_the_Product_Details_Page_to_Upload_and_Show_Images"></a>
#### <a name="task-1---updating-the-product-details-page-to-upload-and-show-images"></a><span data-ttu-id="c5e96-450">任务 1-更新产品详细信息页面上传并显示图像</span><span class="sxs-lookup"><span data-stu-id="c5e96-450">Task 1 - Updating the Product Details Page to Upload and Show Images</span></span>

<span data-ttu-id="c5e96-451">在本任务中，你将更新产品详细信息页，以允许用户指定产品的图像 URL 并将其显示在只读视图。</span><span class="sxs-lookup"><span data-stu-id="c5e96-451">In this task, you will update the product details page to allow the user to specify an image URL for the product and display it in the read-only view.</span></span> <span data-ttu-id="c5e96-452">通过以同步方式下载，将创建指定的图像的本地副本。</span><span class="sxs-lookup"><span data-stu-id="c5e96-452">You will create a local copy of the specified image by downloading it synchronously.</span></span> <span data-ttu-id="c5e96-453">在下一任务中，你将更新此实现，使其以异步方式工作。</span><span class="sxs-lookup"><span data-stu-id="c5e96-453">In the next task, you will update this implementation to make it work asynchronously.</span></span>

1. <span data-ttu-id="c5e96-454">打开**Visual Studio 2012**并加载**开始**解决方案位于**Source\Ex3 Async\Begin**从本实验的文件夹。</span><span class="sxs-lookup"><span data-stu-id="c5e96-454">Open **Visual Studio 2012** and load the **Begin** solution located in **Source\Ex3-Async\Begin** from this lab's folder.</span></span> <span data-ttu-id="c5e96-455">或者，您可以从上一练习在现有解决方案上继续工作。</span><span class="sxs-lookup"><span data-stu-id="c5e96-455">Alternatively, you can continue working on your existing solution from the previous exercises.</span></span>

   1. <span data-ttu-id="c5e96-456">如果您打开提供**开始**需要下载某些缺少的 NuGet 包的解决方案，然后再继续。</span><span class="sxs-lookup"><span data-stu-id="c5e96-456">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="c5e96-457">为此，请在解决方案资源管理器中，单击**WebFormsLab**项目，然后选择**管理 NuGet 包**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-457">To do this, in the Solution Explorer, click the **WebFormsLab** project and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="c5e96-458">在中**管理 NuGet 包**对话框中，单击**还原**若要下载缺少的包。</span><span class="sxs-lookup"><span data-stu-id="c5e96-458">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="c5e96-459">最后，通过单击生成解决方案**构建** | **生成解决方案**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-459">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="c5e96-460">使用 NuGet 的优点之一是，您不必提供在项目中的所有库项目大小减少。</span><span class="sxs-lookup"><span data-stu-id="c5e96-460">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="c5e96-461">使用 NuGet 增强工具，请通过在 Packages.config 文件中，指定包版本可以下载第一次运行该项目的所有所需的库。</span><span class="sxs-lookup"><span data-stu-id="c5e96-461">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="c5e96-462">这就是原因需要将从本实验中打开现有解决方案后运行这些步骤。</span><span class="sxs-lookup"><span data-stu-id="c5e96-462">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="c5e96-463">打开**ProductDetails.aspx**页上源，以显示产品图像的 FormView 的 ItemTemplate 中添加一个字段。</span><span class="sxs-lookup"><span data-stu-id="c5e96-463">Open the **ProductDetails.aspx** page source and add a field in the FormView's ItemTemplate to show the product image.</span></span>

    [!code-aspx[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample30.aspx)]
3. <span data-ttu-id="c5e96-464">添加字段以在 FormView 的 EditTemplate 中指定图像 URL。</span><span class="sxs-lookup"><span data-stu-id="c5e96-464">Add a field to specify the image URL in the FormView's EditTemplate.</span></span>

    [!code-aspx[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample31.aspx)]
4. <span data-ttu-id="c5e96-465">打开**ProductDetails.aspx.cs**代码隐藏文件，并添加以下命名空间指令。</span><span class="sxs-lookup"><span data-stu-id="c5e96-465">Open the **ProductDetails.aspx.cs** code-behind file and add the following namespace directives.</span></span>

    <span data-ttu-id="c5e96-466">(代码段- *Web 窗体实验室-Ex03-命名空间*)</span><span class="sxs-lookup"><span data-stu-id="c5e96-466">(Code Snippet - *Web Forms Lab - Ex03 - Namespaces*)</span></span>

    [!code-csharp[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample32.cs)]
5. <span data-ttu-id="c5e96-467">创建**UpdateProductImage**方法将远程图像存储在本地**映像**文件夹，然后更新 product 实体与新的图像位置值。</span><span class="sxs-lookup"><span data-stu-id="c5e96-467">Create an **UpdateProductImage** method to store remote images in the local **Images** folder and update the product entity with the new image location value.</span></span>

    <span data-ttu-id="c5e96-468">(代码段- *Web 窗体实验室-Ex03-UpdateProductImage*)</span><span class="sxs-lookup"><span data-stu-id="c5e96-468">(Code Snippet - *Web Forms Lab - Ex03 - UpdateProductImage*)</span></span>

    [!code-csharp[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample33.cs)]
6. <span data-ttu-id="c5e96-469">更新**UpdateProduct**方法来调用**UpdateProductImage**方法。</span><span class="sxs-lookup"><span data-stu-id="c5e96-469">Update the **UpdateProduct** method to call the **UpdateProductImage** method.</span></span>

    <span data-ttu-id="c5e96-470">(代码段- *Web 窗体实验室-Ex03-UpdateProductImage 调用*)</span><span class="sxs-lookup"><span data-stu-id="c5e96-470">(Code Snippet - *Web Forms Lab - Ex03 - UpdateProductImage Call*)</span></span>

    [!code-csharp[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample34.cs)]
7. <span data-ttu-id="c5e96-471">运行应用程序并尝试上传的映像的产品。</span><span class="sxs-lookup"><span data-stu-id="c5e96-471">Run the application and try to upload an image for a product.</span></span> <span data-ttu-id="c5e96-472">例如，可以使用 Office 剪贴画中的以下映像 URL: [[http://officeimg.vo.msecnd.net/images/MB900437099.jpg](http://officeimg.vo.msecnd.net/images/MB900437099.jpg)](http://officeimg.vo.msecnd.net/images/MB900437099.jpg)</span><span class="sxs-lookup"><span data-stu-id="c5e96-472">For example, you can use the following image URL from Office Clip Arts: [[http://officeimg.vo.msecnd.net/images/MB900437099.jpg](http://officeimg.vo.msecnd.net/images/MB900437099.jpg)](http://officeimg.vo.msecnd.net/images/MB900437099.jpg)</span></span>

    <span data-ttu-id="c5e96-473">![设置产品的映像](whats-new-in-web-forms-in-aspnet-45/_static/image23.png "设置产品的图像")</span><span class="sxs-lookup"><span data-stu-id="c5e96-473">![Setting an image for a product](whats-new-in-web-forms-in-aspnet-45/_static/image23.png "Setting an image for a product")</span></span>

    <span data-ttu-id="c5e96-474">*设置产品的图像*</span><span class="sxs-lookup"><span data-stu-id="c5e96-474">*Setting an image for a product*</span></span>

<a id="Task_2_-_Adding_Asynchronous_Processing_to_the_Product_Details_Page"></a>
#### <a name="task-2---adding-asynchronous-processing-to-the-product-details-page"></a><span data-ttu-id="c5e96-475">任务 2-添加异步处理到产品详细信息页</span><span class="sxs-lookup"><span data-stu-id="c5e96-475">Task 2 - Adding Asynchronous Processing to the Product Details Page</span></span>

<span data-ttu-id="c5e96-476">在本任务中，你将更新产品详细信息页，使其以异步方式工作。</span><span class="sxs-lookup"><span data-stu-id="c5e96-476">In this task, you will update the product details page to make it work asynchronously.</span></span> <span data-ttu-id="c5e96-477">将使用 ASP.NET 4.5 异步页处理，从而提高长时间运行任务-映像下载过程的性能。</span><span class="sxs-lookup"><span data-stu-id="c5e96-477">You will enhance a long running task - the image download process - by using ASP.NET 4.5 asynchronous page processing.</span></span>

<span data-ttu-id="c5e96-478">Web 应用程序中的异步方法可用于优化 ASP.NET 线程池的使用的方式。</span><span class="sxs-lookup"><span data-stu-id="c5e96-478">Asynchronous methods in web applications can be used to optimize the way ASP.NET thread pools are used.</span></span> <span data-ttu-id="c5e96-479">在 ASP.NET 中存在是有限的数量的不顾及在线程池中的线程请求，因此时所有线程都处于忙碌状态，, ASP.NET 开始拒绝新请求、 发送应用程序错误消息并将你的站点不可用。</span><span class="sxs-lookup"><span data-stu-id="c5e96-479">In ASP.NET there are a limited number of threads in the thread pool for attending requests, thus, when all the threads are busy, ASP.NET starts to reject new requests, sends application error messages and makes your site unavailable.</span></span>

<span data-ttu-id="c5e96-480">在网站上耗时的操作都非常适合进行异步编程，因为它们所分配的线程占用很长时间。</span><span class="sxs-lookup"><span data-stu-id="c5e96-480">Time-consuming operations on your web site are great candidates for asynchronous programming because they occupy the assigned thread for a long time.</span></span> <span data-ttu-id="c5e96-481">这包括长时间运行的请求，具有大量不同的元素的页和页需要脱机操作中，将此类查询的数据库或访问外部 web 服务器。</span><span class="sxs-lookup"><span data-stu-id="c5e96-481">This includes long running requests, pages with lots of different elements and pages that require offline operations, such querying a database or accessing an external web server.</span></span> <span data-ttu-id="c5e96-482">优点是处理页面时，这些操作使用异步方法，如果线程被释放并返回到线程池，用于处理新的页面请求。</span><span class="sxs-lookup"><span data-stu-id="c5e96-482">The advantage is that if you use asynchronous methods for these operations, while the page is processing, the thread is freed and returned to the thread pool and can be used to attend to a new page request.</span></span> <span data-ttu-id="c5e96-483">这意味着，页面才会开始在线程池从一个线程中处理和异步处理完成后，可能会完成在一个不同的处理。</span><span class="sxs-lookup"><span data-stu-id="c5e96-483">This means, the page will start processing in one thread from the thread pool and might complete processing in a different one, after the async processing completes.</span></span>

1. <span data-ttu-id="c5e96-484">打开**ProductDetails.aspx**页。</span><span class="sxs-lookup"><span data-stu-id="c5e96-484">Open the **ProductDetails.aspx** page.</span></span> <span data-ttu-id="c5e96-485">添加**异步**属性中**页面**元素并将其设置为**true**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-485">Add the **Async** attribute in the **Page** element and set it to **true**.</span></span> <span data-ttu-id="c5e96-486">此属性告知 ASP.NET 实现 IHttpAsyncHandler 接口。</span><span class="sxs-lookup"><span data-stu-id="c5e96-486">This attribute tells ASP.NET to implement the IHttpAsyncHandler interface.</span></span>

    [!code-aspx[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample35.aspx)]
2. <span data-ttu-id="c5e96-487">要显示的线程正在运行页的详细信息的页的底部添加一个标签。</span><span class="sxs-lookup"><span data-stu-id="c5e96-487">Add a Label at the bottom of the page to show the details of the threads running the page.</span></span>

    [!code-aspx[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample36.aspx)]
3. <span data-ttu-id="c5e96-488">打开**ProductDetails.aspx.cs**并添加以下命名空间指令。</span><span class="sxs-lookup"><span data-stu-id="c5e96-488">Open up **ProductDetails.aspx.cs** and add the following namespace directives.</span></span>

    <span data-ttu-id="c5e96-489">(代码段- *Web 窗体实验室-Ex03-命名空间 2*)</span><span class="sxs-lookup"><span data-stu-id="c5e96-489">(Code Snippet - *Web Forms Lab - Ex03 - Namespaces 2*)</span></span>

    [!code-csharp[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample37.cs)]
4. <span data-ttu-id="c5e96-490">修改**UpdateProductImage**方法以下载具有一个异步任务的图像。</span><span class="sxs-lookup"><span data-stu-id="c5e96-490">Modify the **UpdateProductImage** method to download the image with an asynchronous task.</span></span> <span data-ttu-id="c5e96-491">将替换**WebClient** **DownloadFile**方法替换**DownloadFileTaskAsync**方法，包括**await**关键字。</span><span class="sxs-lookup"><span data-stu-id="c5e96-491">You will replace the **WebClient** **DownloadFile** method with the **DownloadFileTaskAsync** method and include the **await** keyword.</span></span>

    <span data-ttu-id="c5e96-492">(代码段- *Web 窗体实验室-Ex03-UpdateProductImage 异步*)</span><span class="sxs-lookup"><span data-stu-id="c5e96-492">(Code Snippet - *Web Forms Lab - Ex03 - UpdateProductImage Async*)</span></span>

    [!code-csharp[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample38.cs)]

    <span data-ttu-id="c5e96-493">RegisterAsyncTask 注册新的页面异步任务要执行的另一个线程。</span><span class="sxs-lookup"><span data-stu-id="c5e96-493">The RegisterAsyncTask registers a new page asynchronous task to be executed in a different thread.</span></span> <span data-ttu-id="c5e96-494">它将接收要执行的任务 (t) 的 lambda 表达式。</span><span class="sxs-lookup"><span data-stu-id="c5e96-494">It receives a lambda expression with the Task (t) to be executed.</span></span> <span data-ttu-id="c5e96-495">**Await**中的关键字**DownloadFileTaskAsync**方法将转换后，将异步调用的回调方法的剩余部分**DownloadFileTaskAsync**方法完成。</span><span class="sxs-lookup"><span data-stu-id="c5e96-495">The **await** keyword in the **DownloadFileTaskAsync** method converts the remainder of the method into a callback that is invoked asynchronously after the **DownloadFileTaskAsync** method has completed.</span></span> <span data-ttu-id="c5e96-496">ASP.NET 将恢复自动维护所有原始 HTTP 请求值的方法的执行。</span><span class="sxs-lookup"><span data-stu-id="c5e96-496">ASP.NET will resume the execution of the method by automatically maintaining all the HTTP request original values.</span></span> <span data-ttu-id="c5e96-497">在.NET 4.5 中的新异步编程模型，可编写异步代码，看上去非常类似于同步代码，并让编译器处理回调函数或延续代码的复杂性。</span><span class="sxs-lookup"><span data-stu-id="c5e96-497">The new asynchronous programming model in .NET 4.5 enables you to write asynchronous code that looks very much like synchronous code, and let the compiler handle the complications of callback functions or continuation code.</span></span>
    > [!NOTE]
    > <span data-ttu-id="c5e96-498">RegisterAsyncTask 和 PageAsyncTask 自.NET 2.0 以来已可用。</span><span class="sxs-lookup"><span data-stu-id="c5e96-498">RegisterAsyncTask and PageAsyncTask were already available since .NET 2.0.</span></span> <span data-ttu-id="c5e96-499">Await 关键字新从.NET 4.5 的异步编程模型，可与.NET WebClient 对象的新 TaskAsync 方法一起使用。</span><span class="sxs-lookup"><span data-stu-id="c5e96-499">The await keyword is new from the .NET 4.5 asynchronous programming model and can be used together with the new TaskAsync methods from the .NET WebClient object.</span></span>
5. <span data-ttu-id="c5e96-500">添加代码以显示的线程的代码在其启动和完成执行。</span><span class="sxs-lookup"><span data-stu-id="c5e96-500">Add code to display the threads on which the code started and finished executing.</span></span> <span data-ttu-id="c5e96-501">若要执行此操作，更新**UpdateProductImage**用下面的代码的方法。</span><span class="sxs-lookup"><span data-stu-id="c5e96-501">To do this, update the **UpdateProductImage** method with the following code.</span></span>

    <span data-ttu-id="c5e96-502">(代码段- *Web 窗体实验室-Ex03-显示线程*)</span><span class="sxs-lookup"><span data-stu-id="c5e96-502">(Code Snippet - *Web Forms Lab - Ex03 - Show threads*)</span></span>

    [!code-csharp[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample39.cs)]
6. <span data-ttu-id="c5e96-503">打开网站的**Web.config**文件。</span><span class="sxs-lookup"><span data-stu-id="c5e96-503">Open the web site's **Web.config** file.</span></span> <span data-ttu-id="c5e96-504">添加以下 appSetting 变量。</span><span class="sxs-lookup"><span data-stu-id="c5e96-504">Add the following appSetting variable.</span></span>

    [!code-xml[Main](whats-new-in-web-forms-in-aspnet-45/samples/sample40.xml)]
7. <span data-ttu-id="c5e96-505">按**F5**运行应用程序并将该产品的图像上传。</span><span class="sxs-lookup"><span data-stu-id="c5e96-505">Press **F5** to run the application and upload an image for the product.</span></span> <span data-ttu-id="c5e96-506">请注意，启动和完成的代码可能不同的线程 ID。</span><span class="sxs-lookup"><span data-stu-id="c5e96-506">Notice the threads ID where the code started and finished may be different.</span></span> <span data-ttu-id="c5e96-507">这是因为从 ASP.NET 线程池的单独线程上运行的异步任务。</span><span class="sxs-lookup"><span data-stu-id="c5e96-507">This is because asynchronous tasks run on a separate thread from ASP.NET thread pool.</span></span> <span data-ttu-id="c5e96-508">完成任务后，ASP.NET 将任务放回队列中，并将分配任何可用的线程。</span><span class="sxs-lookup"><span data-stu-id="c5e96-508">When the task completes, ASP.NET puts the task back in the queue and assigns any of the available threads.</span></span>

    <span data-ttu-id="c5e96-509">![以异步方式下载图像](whats-new-in-web-forms-in-aspnet-45/_static/image24.png "异步下载图像")</span><span class="sxs-lookup"><span data-stu-id="c5e96-509">![Downloading an image asynchronously](whats-new-in-web-forms-in-aspnet-45/_static/image24.png "Downloading an image asynchronously")</span></span>

    <span data-ttu-id="c5e96-510">*以异步方式下载图像*</span><span class="sxs-lookup"><span data-stu-id="c5e96-510">*Downloading an image asynchronously*</span></span>

> [!NOTE]
> <span data-ttu-id="c5e96-511">此外，可以部署此应用程序对 Azure 以下[附录 b:ASP.NET MVC 4 应用程序使用 Web 部署发布](#AppendixB)。</span><span class="sxs-lookup"><span data-stu-id="c5e96-511">Additionally, you can deploy this application to Azure following [Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixB).</span></span>


* * *

<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="c5e96-512">总结</span><span class="sxs-lookup"><span data-stu-id="c5e96-512">Summary</span></span>

<span data-ttu-id="c5e96-513">在此动手实验中，已分析并演示以下概念：</span><span class="sxs-lookup"><span data-stu-id="c5e96-513">In this hands-on lab, the following concepts have been addressed and demonstrated:</span></span>

- <span data-ttu-id="c5e96-514">使用强类型化数据绑定表达式</span><span class="sxs-lookup"><span data-stu-id="c5e96-514">Use strongly-typed data-binding expressions</span></span>
- <span data-ttu-id="c5e96-515">在 Web 窗体中使用新的模型绑定功能</span><span class="sxs-lookup"><span data-stu-id="c5e96-515">Use new model binding features in Web Forms</span></span>
- <span data-ttu-id="c5e96-516">将值提供程序用于将页面数据映射到代码隐藏方法</span><span class="sxs-lookup"><span data-stu-id="c5e96-516">Use value providers for mapping page data to code-behind methods</span></span>
- <span data-ttu-id="c5e96-517">用户输入验证中使用数据注释</span><span class="sxs-lookup"><span data-stu-id="c5e96-517">Use Data Annotations for user input validation</span></span>
- <span data-ttu-id="c5e96-518">利用 Web 窗体中使用 jQuery 非介入式客户端验证</span><span class="sxs-lookup"><span data-stu-id="c5e96-518">Take advantage of unobtrusive client-side validation with jQuery in Web Forms</span></span>
- <span data-ttu-id="c5e96-519">实现粒度请求验证</span><span class="sxs-lookup"><span data-stu-id="c5e96-519">Implement granular request validation</span></span>
- <span data-ttu-id="c5e96-520">实现在 Web 窗体中处理的异步页面</span><span class="sxs-lookup"><span data-stu-id="c5e96-520">Implement asynchronous page processing in Web Forms</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="c5e96-521">附录 a:安装 Visual Studio Express 2012 for Web</span><span class="sxs-lookup"><span data-stu-id="c5e96-521">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="c5e96-522">你可以安装**Microsoft Visual Studio Express 2012 for Web**或另一个&quot;Express&quot;使用版本 **[Microsoft Web 平台安装程序](https://www.microsoft.com/web/downloads/platform.aspx)** .</span><span class="sxs-lookup"><span data-stu-id="c5e96-522">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="c5e96-523">以下说明将指导您完成安装所需的步骤*Visual studio Express 2012 for Web*使用*Microsoft Web 平台安装程序*。</span><span class="sxs-lookup"><span data-stu-id="c5e96-523">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="c5e96-524">转到[ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169)。</span><span class="sxs-lookup"><span data-stu-id="c5e96-524">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="c5e96-525">或者，如果你已安装 Web 平台安装程序，则可以打开它，并搜索产品&quot; <em>Visual Studio Express 2012 for Web 与 Azure SDK</em>&quot;。</span><span class="sxs-lookup"><span data-stu-id="c5e96-525">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="c5e96-526">单击**立即安装**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-526">Click on **Install Now**.</span></span> <span data-ttu-id="c5e96-527">如果还没有**Web 平台安装程序**将重定向以下载并安装。</span><span class="sxs-lookup"><span data-stu-id="c5e96-527">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="c5e96-528">一次**Web 平台安装程序**处于打开状态，单击**安装**以启动安装程序。</span><span class="sxs-lookup"><span data-stu-id="c5e96-528">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="c5e96-529">![安装 Visual Studio Express](whats-new-in-web-forms-in-aspnet-45/_static/image25.png "安装 Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="c5e96-529">![Install Visual Studio Express](whats-new-in-web-forms-in-aspnet-45/_static/image25.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="c5e96-530">*安装 Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="c5e96-530">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="c5e96-531">阅读所有产品的许可证和条款，然后单击**我接受**以继续。</span><span class="sxs-lookup"><span data-stu-id="c5e96-531">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![接受许可条款](whats-new-in-web-forms-in-aspnet-45/_static/image26.png)

    <span data-ttu-id="c5e96-533">*接受许可条款*</span><span class="sxs-lookup"><span data-stu-id="c5e96-533">*Accepting the license terms*</span></span>
5. <span data-ttu-id="c5e96-534">等待，直到下载和安装过程完成。</span><span class="sxs-lookup"><span data-stu-id="c5e96-534">Wait until the downloading and installation process completes.</span></span>

    ![安装进度](whats-new-in-web-forms-in-aspnet-45/_static/image27.png)

    <span data-ttu-id="c5e96-536">*安装进度*</span><span class="sxs-lookup"><span data-stu-id="c5e96-536">*Installation progress*</span></span>
6. <span data-ttu-id="c5e96-537">安装完成后，单击**完成**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-537">When the installation completes, click **Finish**.</span></span>

    ![安装已完成](whats-new-in-web-forms-in-aspnet-45/_static/image28.png)

    <span data-ttu-id="c5e96-539">*安装已完成*</span><span class="sxs-lookup"><span data-stu-id="c5e96-539">*Installation completed*</span></span>
7. <span data-ttu-id="c5e96-540">单击**退出**以关闭 Web 平台安装程序。</span><span class="sxs-lookup"><span data-stu-id="c5e96-540">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="c5e96-541">若要打开 Visual Studio Express for Web，请转到**启动**屏幕上即可开始编写&quot; **VS Express**&quot;，然后单击**VS Express for Web**磁贴。</span><span class="sxs-lookup"><span data-stu-id="c5e96-541">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web 磁贴](whats-new-in-web-forms-in-aspnet-45/_static/image29.png)

    <span data-ttu-id="c5e96-543">*VS Express for Web 磁贴*</span><span class="sxs-lookup"><span data-stu-id="c5e96-543">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
## <a name="appendix-b-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="c5e96-544">附录 b:ASP.NET MVC 4 应用程序使用 Web 部署发布</span><span class="sxs-lookup"><span data-stu-id="c5e96-544">Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="c5e96-545">本附录将演示如何从 Azure 门户创建新的网站和发布应用程序获取按照本实验中，利用 Azure 提供的 Web 部署发布功能。</span><span class="sxs-lookup"><span data-stu-id="c5e96-545">This appendix will show you how to create a new web site from the Azure Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Azure.</span></span>

<a id="ApxBTask1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-azure-portal"></a><span data-ttu-id="c5e96-546">任务 1-从 Azure 门户创建新的 Web 站点</span><span class="sxs-lookup"><span data-stu-id="c5e96-546">Task 1 - Creating a New Web Site from the Azure Portal</span></span>

1. <span data-ttu-id="c5e96-547">转到[Azure 管理门户](https://manage.windowsazure.com/)并使用与你的订阅关联的 Microsoft 凭据登录。</span><span class="sxs-lookup"><span data-stu-id="c5e96-547">Go to the [Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="c5e96-548">借助 Azure 可以免费托管 10 个 ASP.NET 网站，然后随着流量增长情况。</span><span class="sxs-lookup"><span data-stu-id="c5e96-548">With Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="c5e96-549">你可以注册[此处](https://aka.ms/aspnet-hol-azure)。</span><span class="sxs-lookup"><span data-stu-id="c5e96-549">You can sign up [here](https://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="c5e96-550">![登录到 Windows Azure 门户](whats-new-in-web-forms-in-aspnet-45/_static/image30.png "登录到 Windows Azure 门户")</span><span class="sxs-lookup"><span data-stu-id="c5e96-550">![Log on to Windows Azure portal](whats-new-in-web-forms-in-aspnet-45/_static/image30.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="c5e96-551">*登录到门户*</span><span class="sxs-lookup"><span data-stu-id="c5e96-551">*Log on to the Portal*</span></span>
2. <span data-ttu-id="c5e96-552">单击**新建**命令栏上。</span><span class="sxs-lookup"><span data-stu-id="c5e96-552">Click **New** on the command bar.</span></span>

    <span data-ttu-id="c5e96-553">![创建新的 Web 站点](whats-new-in-web-forms-in-aspnet-45/_static/image31.png "创建新的 Web 站点")</span><span class="sxs-lookup"><span data-stu-id="c5e96-553">![Creating a new Web Site](whats-new-in-web-forms-in-aspnet-45/_static/image31.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="c5e96-554">*创建新的 Web 站点*</span><span class="sxs-lookup"><span data-stu-id="c5e96-554">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="c5e96-555">单击**计算** | **网站**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-555">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="c5e96-556">然后选择**快速创建**选项。</span><span class="sxs-lookup"><span data-stu-id="c5e96-556">Then select **Quick Create** option.</span></span> <span data-ttu-id="c5e96-557">为新网站提供可用的 URL，然后单击**创建网站**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-557">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="c5e96-558">Azure 是可以控制和管理在云中运行的 web 应用程序的主机。</span><span class="sxs-lookup"><span data-stu-id="c5e96-558">Azure is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="c5e96-559">快速创建选项，可部署到 Azure 门户外部的已完成的 web 应用程序。</span><span class="sxs-lookup"><span data-stu-id="c5e96-559">The Quick Create option allows you to deploy a completed web application to the Azure from outside the portal.</span></span> <span data-ttu-id="c5e96-560">它不包括用于设置数据库的步骤。</span><span class="sxs-lookup"><span data-stu-id="c5e96-560">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="c5e96-561">![创建新的网站使用快速创建](whats-new-in-web-forms-in-aspnet-45/_static/image32.png "创建新的网站使用快速创建")</span><span class="sxs-lookup"><span data-stu-id="c5e96-561">![Creating a new Web Site using Quick Create](whats-new-in-web-forms-in-aspnet-45/_static/image32.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="c5e96-562">*创建新的网站使用快速创建*</span><span class="sxs-lookup"><span data-stu-id="c5e96-562">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="c5e96-563">等到新**网站**创建。</span><span class="sxs-lookup"><span data-stu-id="c5e96-563">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="c5e96-564">创建网站后，单击下面的链接**URL**列。</span><span class="sxs-lookup"><span data-stu-id="c5e96-564">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="c5e96-565">检查新的 Web 站点正常工作。</span><span class="sxs-lookup"><span data-stu-id="c5e96-565">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="c5e96-566">![浏览到新的 web 站点](whats-new-in-web-forms-in-aspnet-45/_static/image33.png "浏览到新的 web 站点")</span><span class="sxs-lookup"><span data-stu-id="c5e96-566">![Browsing to the new web site](whats-new-in-web-forms-in-aspnet-45/_static/image33.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="c5e96-567">*浏览到新的 web 站点*</span><span class="sxs-lookup"><span data-stu-id="c5e96-567">*Browsing to the new web site*</span></span>

    <span data-ttu-id="c5e96-568">![正在运行的网站](whats-new-in-web-forms-in-aspnet-45/_static/image34.png "正在运行的网站")</span><span class="sxs-lookup"><span data-stu-id="c5e96-568">![Web site running](whats-new-in-web-forms-in-aspnet-45/_static/image34.png "Web site running")</span></span>

    <span data-ttu-id="c5e96-569">*正在运行的网站*</span><span class="sxs-lookup"><span data-stu-id="c5e96-569">*Web site running*</span></span>
6. <span data-ttu-id="c5e96-570">返回到门户并单击下的 web 站点的名称**名称**列中显示的管理页。</span><span class="sxs-lookup"><span data-stu-id="c5e96-570">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="c5e96-571">![打开网站管理页](whats-new-in-web-forms-in-aspnet-45/_static/image35.png "打开网站管理页")</span><span class="sxs-lookup"><span data-stu-id="c5e96-571">![Opening the web site management pages](whats-new-in-web-forms-in-aspnet-45/_static/image35.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="c5e96-572">*打开网站管理页*</span><span class="sxs-lookup"><span data-stu-id="c5e96-572">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="c5e96-573">在中**仪表板**页面上，在**速览**部分中，单击**下载发布配置文件**链接。</span><span class="sxs-lookup"><span data-stu-id="c5e96-573">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="c5e96-574">*发布配置文件*包含所有发布到 Azure 的 web 应用程序为每个启用的发布方法所需的信息。</span><span class="sxs-lookup"><span data-stu-id="c5e96-574">The *publish profile* contains all of the information required to publish a web application to Azure for each enabled publication method.</span></span> <span data-ttu-id="c5e96-575">发布配置文件包含 Url、 用户凭据和连接到并对每个发布方法启用的终结点进行身份验证所需的数据库字符串。</span><span class="sxs-lookup"><span data-stu-id="c5e96-575">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="c5e96-576">**Microsoft WebMatrix 2**， **Microsoft Visual Studio Express for Web**并**Microsoft Visual Studio 2012**支持读取发布配置文件，以自动执行这些计划的配置web 应用程序发布到 Azure。</span><span class="sxs-lookup"><span data-stu-id="c5e96-576">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Azure.</span></span>

    <span data-ttu-id="c5e96-577">![正在下载网站发布配置文件](whats-new-in-web-forms-in-aspnet-45/_static/image36.png "下载网站发布配置文件")</span><span class="sxs-lookup"><span data-stu-id="c5e96-577">![Downloading the web site publish profile](whats-new-in-web-forms-in-aspnet-45/_static/image36.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="c5e96-578">*正在下载网站发布配置文件*</span><span class="sxs-lookup"><span data-stu-id="c5e96-578">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="c5e96-579">下载发布配置文件到已知位置。</span><span class="sxs-lookup"><span data-stu-id="c5e96-579">Download the publish profile file to a known location.</span></span> <span data-ttu-id="c5e96-580">进一步在此练习中将了解如何使用此文件发布到 Azure 的 web 应用程序从 Visual Studio。</span><span class="sxs-lookup"><span data-stu-id="c5e96-580">Further in this exercise you will see how to use this file to publish a web application to Azure from Visual Studio.</span></span>

    <span data-ttu-id="c5e96-581">![保存发布配置文件](whats-new-in-web-forms-in-aspnet-45/_static/image37.png "保存发布配置文件")</span><span class="sxs-lookup"><span data-stu-id="c5e96-581">![Saving the publish profile file](whats-new-in-web-forms-in-aspnet-45/_static/image37.png "Saving the publish profile")</span></span>

    <span data-ttu-id="c5e96-582">*保存发布配置文件*</span><span class="sxs-lookup"><span data-stu-id="c5e96-582">*Saving the publish profile file*</span></span>

<a id="ApxBTask2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="c5e96-583">任务 2-配置数据库服务器</span><span class="sxs-lookup"><span data-stu-id="c5e96-583">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="c5e96-584">如果你的应用程序将使用的 SQL Server 数据库将需要创建 SQL 数据库服务器。</span><span class="sxs-lookup"><span data-stu-id="c5e96-584">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="c5e96-585">如果你想要部署的简单应用程序不使用 SQL Server 可能会跳过此任务。</span><span class="sxs-lookup"><span data-stu-id="c5e96-585">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="c5e96-586">用于存储应用程序数据库，将需要 SQL 数据库服务器。</span><span class="sxs-lookup"><span data-stu-id="c5e96-586">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="c5e96-587">可以从在 Azure 管理门户在订阅中查看 SQL 数据库服务器**Sql 数据库** | **服务器** | **服务器的仪表板**.</span><span class="sxs-lookup"><span data-stu-id="c5e96-587">You can view the SQL Database servers from your subscription in the Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="c5e96-588">如果没有创建的服务器，则可以创建一个使用**添加**命令栏上的按钮。</span><span class="sxs-lookup"><span data-stu-id="c5e96-588">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="c5e96-589">请注意**服务器名称和 URL、 管理员登录名和密码**，因为你将在下一任务中使用它们。</span><span class="sxs-lookup"><span data-stu-id="c5e96-589">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="c5e96-590">不创建数据库，因为它将在后面的阶段中创建。</span><span class="sxs-lookup"><span data-stu-id="c5e96-590">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="c5e96-591">![SQL 数据库服务器仪表板](whats-new-in-web-forms-in-aspnet-45/_static/image38.png "SQL Database 服务器仪表板")</span><span class="sxs-lookup"><span data-stu-id="c5e96-591">![SQL Database Server Dashboard](whats-new-in-web-forms-in-aspnet-45/_static/image38.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="c5e96-592">*SQL 数据库服务器仪表板*</span><span class="sxs-lookup"><span data-stu-id="c5e96-592">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="c5e96-593">在下一个任务将测试从 Visual Studio 中，数据库连接，因此您需要在服务器的列表中包括你的本地 IP 地址**允许的 IP 地址**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-593">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="c5e96-594">若要执行此操作，请单击**配置**，选择中的 IP 地址**当前客户端 IP 地址**并将其粘贴在上**起始 IP 地址**和**结束 IP 地址**文本框中，然后单击![add-client-ip-address-ok-button](whats-new-in-web-forms-in-aspnet-45/_static/image39.png)按钮。</span><span class="sxs-lookup"><span data-stu-id="c5e96-594">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes and click the ![add-client-ip-address-ok-button](whats-new-in-web-forms-in-aspnet-45/_static/image39.png) button.</span></span>

    ![添加客户端 IP 地址](whats-new-in-web-forms-in-aspnet-45/_static/image40.png)

    <span data-ttu-id="c5e96-596">*添加客户端 IP 地址*</span><span class="sxs-lookup"><span data-stu-id="c5e96-596">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="c5e96-597">一次**客户端 IP 地址**添加到允许的 IP 地址列表中，单击**保存**以确认所做的更改。</span><span class="sxs-lookup"><span data-stu-id="c5e96-597">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![确认更改](whats-new-in-web-forms-in-aspnet-45/_static/image41.png)

    <span data-ttu-id="c5e96-599">*确认更改*</span><span class="sxs-lookup"><span data-stu-id="c5e96-599">*Confirm Changes*</span></span>

<a id="ApxBTask3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="c5e96-600">任务 3-ASP.NET MVC 4 应用程序使用 Web 部署发布</span><span class="sxs-lookup"><span data-stu-id="c5e96-600">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="c5e96-601">返回到 ASP.NET MVC 4 解决方案。</span><span class="sxs-lookup"><span data-stu-id="c5e96-601">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="c5e96-602">在中**解决方案资源管理器**，右键单击网站项目并选择**发布**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-602">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="c5e96-603">![发布应用程序](whats-new-in-web-forms-in-aspnet-45/_static/image42.png "发布应用程序")</span><span class="sxs-lookup"><span data-stu-id="c5e96-603">![Publishing the Application](whats-new-in-web-forms-in-aspnet-45/_static/image42.png "Publishing the Application")</span></span>

    <span data-ttu-id="c5e96-604">*发布此网站*</span><span class="sxs-lookup"><span data-stu-id="c5e96-604">*Publishing the web site*</span></span>
2. <span data-ttu-id="c5e96-605">导入发布配置文件保存在第一个任务。</span><span class="sxs-lookup"><span data-stu-id="c5e96-605">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="c5e96-606">![导入发布配置文件](whats-new-in-web-forms-in-aspnet-45/_static/image43.png "导入发布配置文件")</span><span class="sxs-lookup"><span data-stu-id="c5e96-606">![Importing the publish profile](whats-new-in-web-forms-in-aspnet-45/_static/image43.png "Importing the publish profile")</span></span>

    <span data-ttu-id="c5e96-607">*导入发布配置文件*</span><span class="sxs-lookup"><span data-stu-id="c5e96-607">*Importing publish profile*</span></span>
3. <span data-ttu-id="c5e96-608">单击**验证连接**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-608">Click **Validate Connection**.</span></span> <span data-ttu-id="c5e96-609">验证完成后单击**下一步**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-609">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="c5e96-610">请参阅验证连接按钮旁边会出现一个绿色复选标记后，验证已完成。</span><span class="sxs-lookup"><span data-stu-id="c5e96-610">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="c5e96-611">![验证连接](whats-new-in-web-forms-in-aspnet-45/_static/image44.png "验证连接")</span><span class="sxs-lookup"><span data-stu-id="c5e96-611">![Validating connection](whats-new-in-web-forms-in-aspnet-45/_static/image44.png "Validating connection")</span></span>

    <span data-ttu-id="c5e96-612">*验证连接*</span><span class="sxs-lookup"><span data-stu-id="c5e96-612">*Validating connection*</span></span>
4. <span data-ttu-id="c5e96-613">在中**设置**页面上，在**数据库**部分中，单击您的数据库连接的文本框旁边的按钮 (即**DefaultConnection**)。</span><span class="sxs-lookup"><span data-stu-id="c5e96-613">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="c5e96-614">![Web 部署配置](whats-new-in-web-forms-in-aspnet-45/_static/image45.png "Web 部署配置")</span><span class="sxs-lookup"><span data-stu-id="c5e96-614">![Web deploy configuration](whats-new-in-web-forms-in-aspnet-45/_static/image45.png "Web deploy configuration")</span></span>

    <span data-ttu-id="c5e96-615">*Web 部署配置*</span><span class="sxs-lookup"><span data-stu-id="c5e96-615">*Web deploy configuration*</span></span>
5. <span data-ttu-id="c5e96-616">配置数据库连接，如下所示：</span><span class="sxs-lookup"><span data-stu-id="c5e96-616">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="c5e96-617">在中**服务器名称**键入 SQL 数据库服务器 URL 使用*tcp:* 前缀。</span><span class="sxs-lookup"><span data-stu-id="c5e96-617">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="c5e96-618">在中**用户名**键入服务器管理员登录名。</span><span class="sxs-lookup"><span data-stu-id="c5e96-618">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="c5e96-619">在中**密码**键入服务器管理员登录密码。</span><span class="sxs-lookup"><span data-stu-id="c5e96-619">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="c5e96-620">键入新的数据库名称。</span><span class="sxs-lookup"><span data-stu-id="c5e96-620">Type a new database name.</span></span>

     <span data-ttu-id="c5e96-621">![配置目标连接字符串](whats-new-in-web-forms-in-aspnet-45/_static/image46.png "配置目标连接字符串")</span><span class="sxs-lookup"><span data-stu-id="c5e96-621">![Configuring destination connection string](whats-new-in-web-forms-in-aspnet-45/_static/image46.png "Configuring destination connection string")</span></span>

     <span data-ttu-id="c5e96-622">*配置目标连接字符串*</span><span class="sxs-lookup"><span data-stu-id="c5e96-622">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="c5e96-623">然后单击“确定” 。</span><span class="sxs-lookup"><span data-stu-id="c5e96-623">Then click **OK**.</span></span> <span data-ttu-id="c5e96-624">当系统提示你创建数据库时，单击**是**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-624">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="c5e96-625">![创建数据库](whats-new-in-web-forms-in-aspnet-45/_static/image47.png "创建数据库字符串")</span><span class="sxs-lookup"><span data-stu-id="c5e96-625">![Creating the database](whats-new-in-web-forms-in-aspnet-45/_static/image47.png "Creating the database string")</span></span>

    <span data-ttu-id="c5e96-626">*创建数据库*</span><span class="sxs-lookup"><span data-stu-id="c5e96-626">*Creating the database*</span></span>
7. <span data-ttu-id="c5e96-627">将用于连接到 Azure 中的 SQL 数据库的连接字符串是显示在默认连接文本框内。</span><span class="sxs-lookup"><span data-stu-id="c5e96-627">The connection string you will use to connect to SQL Database in Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="c5e96-628">然后，单击 **“下一步”**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-628">Then click **Next**.</span></span>

    <span data-ttu-id="c5e96-629">![连接字符串指向 SQL 数据库](whats-new-in-web-forms-in-aspnet-45/_static/image48.png "指向 SQL 数据库连接字符串")</span><span class="sxs-lookup"><span data-stu-id="c5e96-629">![Connection string pointing to SQL Database](whats-new-in-web-forms-in-aspnet-45/_static/image48.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="c5e96-630">*连接字符串指向 SQL 数据库*</span><span class="sxs-lookup"><span data-stu-id="c5e96-630">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="c5e96-631">在中**预览版**页上，单击**发布**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-631">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="c5e96-632">![Web 应用程序发布](whats-new-in-web-forms-in-aspnet-45/_static/image49.png "发布 web 应用程序")</span><span class="sxs-lookup"><span data-stu-id="c5e96-632">![Publishing the web application](whats-new-in-web-forms-in-aspnet-45/_static/image49.png "Publishing the web application")</span></span>

    <span data-ttu-id="c5e96-633">*Web 应用程序发布*</span><span class="sxs-lookup"><span data-stu-id="c5e96-633">*Publishing the web application*</span></span>
9. <span data-ttu-id="c5e96-634">在发布过程完成后，在默认浏览器将打开已发布的网站。</span><span class="sxs-lookup"><span data-stu-id="c5e96-634">Once the publishing process finishes, your default browser will open the published web site.</span></span>

<a id="AppendixC"></a>

<a id="Appendix_C_Using_Code_Snippets"></a>
## <a name="appendix-c-using-code-snippets"></a><span data-ttu-id="c5e96-635">附录 c:使用代码片段</span><span class="sxs-lookup"><span data-stu-id="c5e96-635">Appendix C: Using Code Snippets</span></span>

<span data-ttu-id="c5e96-636">使用代码段，可以轻松获得相关所需的所有代码。</span><span class="sxs-lookup"><span data-stu-id="c5e96-636">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="c5e96-637">实验室文档将告诉您完全何时可以使用它们，如下图中所示。</span><span class="sxs-lookup"><span data-stu-id="c5e96-637">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="c5e96-638">![使用 Visual Studio 代码段代码插入到你的项目](whats-new-in-web-forms-in-aspnet-45/_static/image50.png "使用 Visual Studio 代码段代码插入到你的项目")</span><span class="sxs-lookup"><span data-stu-id="c5e96-638">![Using Visual Studio code snippets to insert code into your project](whats-new-in-web-forms-in-aspnet-45/_static/image50.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="c5e96-639">*使用 Visual Studio 代码段代码插入到你的项目*</span><span class="sxs-lookup"><span data-stu-id="c5e96-639">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="c5e96-640">***若要添加代码段使用键盘 (仅限 C#)***</span><span class="sxs-lookup"><span data-stu-id="c5e96-640">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="c5e96-641">将光标置于要插入的代码。</span><span class="sxs-lookup"><span data-stu-id="c5e96-641">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="c5e96-642">开始键入代码片段名称 （不带空格或连字符）。</span><span class="sxs-lookup"><span data-stu-id="c5e96-642">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="c5e96-643">观看作为 IntelliSense 显示匹配的代码段的名称。</span><span class="sxs-lookup"><span data-stu-id="c5e96-643">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="c5e96-644">选择正确的代码段 （或继续键入直到整个代码段的名称处于选定状态）。</span><span class="sxs-lookup"><span data-stu-id="c5e96-644">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="c5e96-645">按 Tab 键两次，以在光标位置插入代码段。</span><span class="sxs-lookup"><span data-stu-id="c5e96-645">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="c5e96-646">![开始键入代码段名称](whats-new-in-web-forms-in-aspnet-45/_static/image51.png "开始键入代码段名称")</span><span class="sxs-lookup"><span data-stu-id="c5e96-646">![Start typing the snippet name](whats-new-in-web-forms-in-aspnet-45/_static/image51.png "Start typing the snippet name")</span></span>

<span data-ttu-id="c5e96-647">*开始键入代码段名称*</span><span class="sxs-lookup"><span data-stu-id="c5e96-647">*Start typing the snippet name*</span></span>

<span data-ttu-id="c5e96-648">![按 tab 键以选择突出显示代码段](whats-new-in-web-forms-in-aspnet-45/_static/image52.png "按选项卡以选择突出显示代码段")</span><span class="sxs-lookup"><span data-stu-id="c5e96-648">![Press Tab to select the highlighted snippet](whats-new-in-web-forms-in-aspnet-45/_static/image52.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="c5e96-649">*按 tab 键以选择突出显示代码段*</span><span class="sxs-lookup"><span data-stu-id="c5e96-649">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="c5e96-650">![再次按 Tab 和代码段将 expand](whats-new-in-web-forms-in-aspnet-45/_static/image53.png "再次按 Tab 和代码段将扩展")</span><span class="sxs-lookup"><span data-stu-id="c5e96-650">![Press Tab again and the snippet will expand](whats-new-in-web-forms-in-aspnet-45/_static/image53.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="c5e96-651">*再次按 Tab 和代码段将扩展*</span><span class="sxs-lookup"><span data-stu-id="c5e96-651">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="c5e96-652">***若要添加代码段使用鼠标 （C#、 Visual Basic 和 XML）*** 1。</span><span class="sxs-lookup"><span data-stu-id="c5e96-652">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="c5e96-653">右键单击你想要插入的代码片段。</span><span class="sxs-lookup"><span data-stu-id="c5e96-653">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="c5e96-654">选择**插入代码段**跟**我的代码片段**。</span><span class="sxs-lookup"><span data-stu-id="c5e96-654">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="c5e96-655">通过单击选择列表中中的相关代码片段。</span><span class="sxs-lookup"><span data-stu-id="c5e96-655">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="c5e96-656">![右键单击你想要插入代码段和选择插入代码段](whats-new-in-web-forms-in-aspnet-45/_static/image54.png "右键单击你想要插入代码段和选择插入代码段")</span><span class="sxs-lookup"><span data-stu-id="c5e96-656">![Right-click where you want to insert the code snippet and select Insert Snippet](whats-new-in-web-forms-in-aspnet-45/_static/image54.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="c5e96-657">*右键单击你想要插入代码段和选择插入代码段*</span><span class="sxs-lookup"><span data-stu-id="c5e96-657">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="c5e96-658">![通过单击选择列表中中的相关代码片段](whats-new-in-web-forms-in-aspnet-45/_static/image55.png "通过单击选择列表中中的相关代码片段")</span><span class="sxs-lookup"><span data-stu-id="c5e96-658">![Pick the relevant snippet from the list, by clicking on it](whats-new-in-web-forms-in-aspnet-45/_static/image55.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="c5e96-659">*通过单击选择列表中中的相关代码片段*</span><span class="sxs-lookup"><span data-stu-id="c5e96-659">*Pick the relevant snippet from the list, by clicking on it*</span></span>
