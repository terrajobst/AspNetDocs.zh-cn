...
<span data-ttu-id="a3bc2-143">在此任务中，您将发现的新功能的 CSS 编辑器中。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-143">In this task, you will discover the new features of the CSS Editor.</span></span> <span data-ttu-id="a3bc2-144">这一新编辑器将帮助你提高工作效率，通过利用新的智能缩进、 改进的代码注释和增强的 IntelliSense 列表。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-144">This new editor will help you increase your productivity by taking advantage of the new smart indentation, the improved code comments and the enhanced IntelliSense list.</span></span>
...
4. <span data-ttu-id="a3bc2-155">单击**折叠**(![折叠](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image6.png)) 和**展开**(![展开](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image7.png)) 按钮位于文本的左边距。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-155">Click the **Collapse** (![collapse](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image6.png) ) and **Expand** (![expand](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image7.png) ) buttons located on the left margin of the text.</span></span> <span data-ttu-id="a3bc2-156">请注意，您现在可以隐藏不使用具有更清晰的视图的样式。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-156">Notice that you can now hide the styles you don't use to have a cleaner view.</span></span>
    ...
    <span data-ttu-id="a3bc2-157">![折叠的 CSS 类](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image8.png "折叠 CSS 类")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-157">![Collapsing CSS classes](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image8.png "Collapsing CSS classes")</span></span>
...
7. <span data-ttu-id="a3bc2-169">内部 **.main div**类中，在末尾处找到光标**边框：0px;** 并按**Enter**以显示智能感知列表。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-169">Inside **.main div** class, locate the cursor at the end of **border: 0px;** and press **Enter** to display the IntelliSense list.</span></span> <span data-ttu-id="a3bc2-170">开始键入**顶部**并请注意，当您键入筛选列表的方式。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-170">Start typing **top** and notice how the list is filtered as you type.</span></span> <span data-ttu-id="a3bc2-171">列表中将显示包含的元素**顶部**在单词的任何部分 (在以前版本的 Visual Studio 中，对列表进行筛选的项的*开始*一词的)。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-171">The list will display the elements that contain **top** at any part of the word (In prior versions of Visual Studio, the list is filtered by the items that *begin* with the term).</span></span>
    ...
    *<span data-ttu-id="a3bc2-173">在 CSS 中的 IntelliSense 增强功能</span><span class="sxs-lookup"><span data-stu-id="a3bc2-173">IntelliSense enhancements in CSS</span></span>*
...
3. <span data-ttu-id="a3bc2-184">按**Expand** (![com](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image14.png) ) 颜色选取器，以显示的颜色渐变，然后拖动要选择不同的颜色的渐变光标上的按钮。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-184">Press the **Expand** (![com](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image14.png) ) button on the color picker to display the color gradient, and then drag the gradient cursor to select a different color.</span></span> <span data-ttu-id="a3bc2-185">之后，单击**取色器**按钮，然后从屏幕中选择任何颜色。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-185">After that, click the **Eyedropper** button and select any color from the screen.</span></span> <span data-ttu-id="a3bc2-186">请注意，将光标移动时，背景颜色值发生动态更改。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-186">Notice that background color value changes dynamically while you move the cursor.</span></span>
    ...
    *<span data-ttu-id="a3bc2-188">颜色选取器渐变</span><span class="sxs-lookup"><span data-stu-id="a3bc2-188">Color picker gradient</span></span>*
...
1. <span data-ttu-id="a3bc2-197">在中**Site.css**文件中，找到**标头**CSS 类定义 (.header) 并将以下光标 **/\*边框半径\*/** 占位符，用于添加新的代码段。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-197">In the **Site.css** file, locate the **header** CSS class definition (.header) and place the cursor below the **/\*border radius\*/** placeholder to add a new snippet.</span></span> <span data-ttu-id="a3bc2-198">按**Enter**若要显示的智能感知列表和类型**radius**来筛选列表。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-198">Press **Enter** to display the IntelliSense list and type **radius** to filter the list.</span></span> <span data-ttu-id="a3bc2-199">选择**边框半径**从列表中双击，使用选项，然后按**选项卡**键以插入代码段。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-199">Select the **border-radius** option from the list with a double click, and then press the **TAB** key to insert the snippet.</span></span> <span data-ttu-id="a3bc2-200">然后，键入 radius 大小像素为单位，然后按**Enter**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-200">Then, type a radius size in pixels and press **Enter**.</span></span> <span data-ttu-id="a3bc2-201">例如，键入**15px**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-201">For instance, type **15px**.</span></span>
    ...
    <span data-ttu-id="a3bc2-203">![使用边框半径代码段](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "使用边框半径代码段")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-203">![Using a border-radius snippet](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "Using a border-radius snippet")</span></span>
...
7. <span data-ttu-id="a3bc2-220">创建一个新类**div.images u l l i img:hover**如下**div.images u l l i i m g**类定义，并将光标置于括号 **。**</span><span class="sxs-lookup"><span data-stu-id="a3bc2-220">Create a new class **div.images ul li img:hover** below the **div.images ul li img** class definition and place the cursor inside the brackets **.**</span></span>
    ...
    <span data-ttu-id="a3bc2-221">CSS</span><span class="sxs-lookup"><span data-stu-id="a3bc2-221">CSS</span></span>
...
4. <span data-ttu-id="a3bc2-250">将目标架构更改为 HTML 4.01。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-250">Change the Target Schema to HTML 4.01.</span></span>
    ...
    *<span data-ttu-id="a3bc2-252">在 HTML 源编辑工具栏中更改文档类型</span><span class="sxs-lookup"><span data-stu-id="a3bc2-252">Changing Doctype in HTML Source Editing toolbar</span></span>*
...
1. <span data-ttu-id="a3bc2-267">上**Default.aspx**页上，添加**H3**具有标题 (例如，Visual Studio 2012 Rocks ！) 的元素。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-267">On the **Default.aspx** page, add an **H3** element with a title (for example, Visual Studio 2012 Rocks!).</span></span>
...
2. <span data-ttu-id="a3bc2-278">在中**Default.aspx**页上，找到下 Web11 Rocks 游标!!</span><span class="sxs-lookup"><span data-stu-id="a3bc2-278">In the **Default.aspx** page, locate the cursor under the Web11 Rocks!!</span></span> <span data-ttu-id="a3bc2-279">标头。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-279">Header.</span></span> <span data-ttu-id="a3bc2-280">类型**音频**按 TAB 键。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-280">Type **audio** and press the TAB key.</span></span>
    ...
    *<span data-ttu-id="a3bc2-284">插入 HTML5 代码段</span><span class="sxs-lookup"><span data-stu-id="a3bc2-284">Inserting HTML5 Code Snippets</span></span>*
...
5. <span data-ttu-id="a3bc2-291">现在，请尝试插入控件页的某些部分。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-291">Now, try to insert a control in some part of the page.</span></span> <span data-ttu-id="a3bc2-292">例如，尝试插入**GridView**控件，但无需键入**&lt;网格，** 开始键入 **&lt;GV**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-292">For example, try to insert a **GridView** control, but instead of typing **&lt;Gri,** start typing **&lt;GV**.</span></span> <span data-ttu-id="a3bc2-293">请注意，IntelliSense 列表显示了**asp: GridView**控件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-293">Notice that the IntelliSense list shows the **asp:GridView** control.</span></span>
    ...
    *<span data-ttu-id="a3bc2-299">插入与 IntelliSense 列表和部分匹配的 GridView</span><span class="sxs-lookup"><span data-stu-id="a3bc2-299">Inserting a GridView with IntelliSense lists and partial matching</span></span>*
...
<span data-ttu-id="a3bc2-329">在此任务中，将使用新提取到用户控件上下文操作从所选的代码生成新的用户控件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-329">In this task, you will use the new Extract to User Control contextual operation to generate a new user control from the selected code.</span></span>
...
<span data-ttu-id="a3bc2-346">Visual Studio 已续订，它有望使代码模式，可访问和组织使用的 JavaScript 编辑器。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-346">Visual Studio has renewed the JavaScript editor with the promise to make the code mode accessible and organized.</span></span> <span data-ttu-id="a3bc2-347">中已存在的许多 Visual Studio 功能C#或 VB 编辑器现在已实现 JavaScript 编辑器中：转到定义、 自动缩进、 文档和验证在编写时。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-347">Many Visual Studio features that already existed in C# or VB editors are now implemented in the JavaScript editor: Go To Definition, automatic indentation, documentation and validation when you are writing.</span></span> <span data-ttu-id="a3bc2-348">使用续订的智能感知列表就能够轻松获得相关 JavaScript 函数目录。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-348">With the renewed IntelliSense list you will have the JavaScript function catalog at your fingertips.</span></span>
...
4. <span data-ttu-id="a3bc2-390">在该文件的最后一行，编写任何字符串，如**&quot;测试&quot;** （包括引号以指示它是作为字符串）。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-390">In the last line of the file, write any string like **&quot;test&quot;** (include the quotation marks to indicate it is as string).</span></span> <span data-ttu-id="a3bc2-391">编写一段字符串可以显示 IntelliSense 列表中，并选择旁边**剪裁**选项。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-391">Write a period next to the string to display the IntelliSense list, and select the **trim** option.</span></span>
    ...
    <span data-ttu-id="a3bc2-392">在 ECMAScript5 标准中，字符串值和变量也有定义，如裁剪、 大写、 搜索和替换的字符串方法。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-392">In ECMAScript5 standard, string values and variables also have string methods defined, like trim, uppercase, search and replace.</span></span>
...
3. <span data-ttu-id="a3bc2-404">在中**测试**函数中，调用**multiply**接收两个参数的函数。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-404">In the **test** function, call the **multiply** function that receives two parameters.</span></span> <span data-ttu-id="a3bc2-405">请注意，在显示工具提示框**乘**函数文档。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-405">Notice the tooltip box is showing the **multiply** function documentation.</span></span>

    [!code-javascript[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample9.js)]

    <span data-ttu-id="a3bc2-406">![对于 JavaScript 函数的 XML 文档](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "对于 JavaScript 函数的 XML 文档")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-406">![XML documentation for JavaScript functions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "XML documentation for JavaScript functions")</span></span>

    *<span data-ttu-id="a3bc2-407">对于 JavaScript 函数的 XML 文档</span><span class="sxs-lookup"><span data-stu-id="a3bc2-407">XML documentation for JavaScript functions</span></span>*
4. <span data-ttu-id="a3bc2-408">完成的函数调用语句和类型*点*打开智能感知列表上返回的值。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-408">Complete the function call statement and type a *dot* to open the IntelliSense list on the returned value.</span></span> <span data-ttu-id="a3bc2-409">请注意，Visual Studio 检测**返回**在文档中，将该值视为一个数字值。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-409">Notice that Visual Studio is detecting the **return** value in the documentation, treating the value as a number.</span></span>

    <span data-ttu-id="a3bc2-410">![返回类型的 XML 文档](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "返回类型的 XML 文档")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-410">![XML documentation for return types](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "XML documentation for return types")</span></span>

    *<span data-ttu-id="a3bc2-411">返回类型的 XML 文档</span><span class="sxs-lookup"><span data-stu-id="a3bc2-411">XML documentation for return types</span></span>*
5. <span data-ttu-id="a3bc2-412">现在，插入添加函数的调用。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-412">Now, insert a call to add function.</span></span> <span data-ttu-id="a3bc2-413">请注意，JavaScript 编辑器现在支持的函数重载。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-413">Notice that the JavaScript editor now supports function overloads.</span></span> <span data-ttu-id="a3bc2-414">当您编写的函数名称时，你将能够选择任何可用的文档中指定的重载。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-414">When you write a function name, you will be able to select any of the available overloads specified in the documentation.</span></span>

    <span data-ttu-id="a3bc2-415">![重载的 XML 文档](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "重载的 XML 文档")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-415">![XML documentation for overloads](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "XML documentation for overloads")</span></span>

    *<span data-ttu-id="a3bc2-416">重载的 XML 文档</span><span class="sxs-lookup"><span data-stu-id="a3bc2-416">XML documentation for overloads</span></span>*
6. <span data-ttu-id="a3bc2-417">打开**GotoDefinition.js**文件，找到 **$().html()** 函数调用。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-417">Open **GotoDefinition.js** file and locate the **$().html()** function call.</span></span> <span data-ttu-id="a3bc2-418">上定位光标**html**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-418">Locate the cursor on **html**.</span></span>
7. <span data-ttu-id="a3bc2-419">按**F12**和导航到的定义。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-419">Press **F12** and navigate to the definition.</span></span> <span data-ttu-id="a3bc2-420">请注意，现在可以访问，并浏览您的 JavaScript 代码，而不使用**查找**工具。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-420">Notice you can now access and browse your JavaScript code without using the **Find** tool.</span></span>
8. <span data-ttu-id="a3bc2-421">在底部的代码文件的签名块之前的 jQuery 指令上找到光标。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-421">Locate the cursor on the jQuery instruction prior to the signature block at the bottom of the code file.</span></span> <span data-ttu-id="a3bc2-422">按**F12**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-422">Press **F12**.</span></span> <span data-ttu-id="a3bc2-423">您将导航到 jQuery 库文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-423">You will navigate to the jQuery library file.</span></span> <span data-ttu-id="a3bc2-424">请注意，还可以在使用 jQuery 文件之间导航**F12**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-424">Notice you can also navigate across the jQuery files using **F12**.</span></span>

    <span data-ttu-id="a3bc2-425">![导航到 jQuery 定义](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "导航到 jQuery 定义")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-425">![Navigating to jQuery definitions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "Navigating to jQuery definitions")</span></span>

    *<span data-ttu-id="a3bc2-426">导航到 jQuery 定义</span><span class="sxs-lookup"><span data-stu-id="a3bc2-426">Navigating to jQuery definitions</span></span>*

> [!NOTE]
> <span data-ttu-id="a3bc2-427">请确保 GotoDefinition.js 保存该文件之前具有没有语法错误。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-427">Make sure that GotoDefinition.js has no syntax errors before saving the file.</span></span>


<a id="Exercise4"></a>

<a id="Exercise_4_Bundling_and_Minification"></a>
### <a name="exercise-4-bundling-and-minification"></a><span data-ttu-id="a3bc2-428">练习 4:捆绑和缩小</span><span class="sxs-lookup"><span data-stu-id="a3bc2-428">Exercise 4: Bundling and Minification</span></span>

<span data-ttu-id="a3bc2-429">多少次你的网站是否包含多个 JavaScript 或 CSS 文件？</span><span class="sxs-lookup"><span data-stu-id="a3bc2-429">How many times do your websites include more than one JavaScript or CSS file?</span></span> <span data-ttu-id="a3bc2-430">这是非常常见的方案的捆绑和缩小可帮助以减小文件大小并使站点执行速度更快。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-430">This is a very common scenario where bundling and minification can help to reduce the file size and make the site perform faster.</span></span> <span data-ttu-id="a3bc2-431">ASP.NET 4.5 中的新绑定功能 JS 或 CSS 文件的一组包为单个元素，并通过缩小内容 （即删除不是必需的空白区域，删除注释，减少标识符） 来减小其大小。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-431">The new bundling feature in ASP.NET 4.5 packs a set of JS or CSS files into a single element, and reduces its size by minifying the content ( i.e. removing not required blank spaces, removing comments, reducing identifiers ).</span></span>

<span data-ttu-id="a3bc2-432">捆绑和缩小 ASP.NET 4.5 中的执行在运行时，以便过程可以识别用户代理 （例如 IE、 Mozilla 等） 并因此，通过面向用户浏览器 （例如，删除内容 Mozilla 特定改进压缩当请求来自 IE）。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-432">Bundling and minification in ASP.NET 4.5 is performed at runtime, so that the process can identify the user agent (for example IE, Mozilla, etc), and thus, improve the compression by targeting the user browser (for instance, removing stuff that is Mozilla specific when the request comes from IE).</span></span>

<span data-ttu-id="a3bc2-433">在此练习中，您将了解如何启用和 ASP.NET 4.5 中使用不同类型的绑定和缩减。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-433">In this exercise, you will learn how to enable and use the different types of bundling and minification in ASP.NET 4.5.</span></span>

<a id="Ex4Task1"></a>

<a id="Task_1_-_Installing_the_Bundling_and_Minification_Package_from_NuGet"></a>
#### <a name="task-1---installing-the-bundling-and-minification-package-from-nuget"></a><span data-ttu-id="a3bc2-434">任务 1-安装捆绑和缩小从 NuGet 包</span><span class="sxs-lookup"><span data-stu-id="a3bc2-434">Task 1 - Installing the Bundling and Minification Package from NuGet</span></span>

1. <span data-ttu-id="a3bc2-435">如果尚未打开，启动**Visual Studio** ，然后打开**WhatsNewASPNET.sln**解决方案位于**Source\WhatsNewASPNET**本实验的文件夹。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-435">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="a3bc2-436">打开 NuGet 包管理器控制台。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-436">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="a3bc2-437">若要执行此操作，使用菜单**视图** | **其他 Windows** | **程序包管理器控制台**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-437">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>

    <span data-ttu-id="a3bc2-438">![打开包管理器 file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "打开包管理器控制台")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-438">![Opening the package manager file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "Opening the package manager console")</span></span>

    *<span data-ttu-id="a3bc2-439">打开包管理器控制台</span><span class="sxs-lookup"><span data-stu-id="a3bc2-439">Opening the package manager console</span></span>*
3. <span data-ttu-id="a3bc2-440">在**程序包管理器控制台**类型**Install-package Microsoft.Web.Optimization**然后按**ENTER**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-440">In the **Package Manager Console,** type **Install-Package Microsoft.Web.Optimization** and press **ENTER**.</span></span>

<a id="Ex4Task2"></a>

<a id="Task_2_-_Default_Bundles"></a>
#### <a name="task-2---default-bundles"></a><span data-ttu-id="a3bc2-441">任务 2-默认捆绑包</span><span class="sxs-lookup"><span data-stu-id="a3bc2-441">Task 2 - Default Bundles</span></span>

<span data-ttu-id="a3bc2-442">使用绑定和缩减的最简单方法是启用的默认捆绑包。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-442">The simplest way to use bundling and minification is to enable the default bundles.</span></span> <span data-ttu-id="a3bc2-443">此方法使用约定来让你引用的文件夹中的 JS 和 CSS 文件的捆绑和缩小化版本。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-443">This method uses conventions to let you reference the bundled and minified version for the JS and CSS files in a folder.</span></span>

<span data-ttu-id="a3bc2-444">在本任务中，您将学习如何启用和引用捆绑和缩小 JS 和 CSS 文件和查看生成的输出。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-444">In this task, you will learn how to enable and reference the bundled and minified JS and CSS files and view the resulting output.</span></span>

1. <span data-ttu-id="a3bc2-445">如果尚未打开，启动**Visual Studio** ，然后打开**WhatsNewASPNET.sln**解决方案位于**Source\WhatsNewASPNET**本实验的文件夹。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-445">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="a3bc2-446">在中**解决方案资源管理器**，展开**样式**， **Scripts\custom**并**Scripts\bundle**文件夹。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-446">In the **Solution Explorer**, expand the **Styles**, **Scripts\custom** and **Scripts\bundle** folders.</span></span>

    <span data-ttu-id="a3bc2-447">请注意，该应用程序使用多个 CSS 和 JS 文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-447">Notice that the application is using more than one CSS and JS file.</span></span>

    <span data-ttu-id="a3bc2-448">![在应用程序中的多个样式表和 JavaScript 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "应用程序中的多个样式表和 JavaScript 文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-448">![Multiple Stylesheets and JavaScript files in the application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "Multiple Stylesheets and JavaScript files in the application")</span></span>

    *<span data-ttu-id="a3bc2-449">在应用程序中的多个样式表和 JavaScript 文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-449">Multiple Stylesheets and JavaScript files in the application</span></span>*
3. <span data-ttu-id="a3bc2-450">打开**Global.asax.cs**文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-450">Open the **Global.asax.cs** file.</span></span>

    <span data-ttu-id="a3bc2-451">请注意，新**Microsoft.Web.Optimization**命名空间已被注释掉文件开头。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-451">Notice that the new **Microsoft.Web.Optimization** namespace is commented out at the beginning of the file.</span></span> <span data-ttu-id="a3bc2-452">取消注释的 using 指令以包括捆绑和缩小功能。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-452">Uncomment the using directive to include the bundling and minification features.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample10.cs)]
4. <span data-ttu-id="a3bc2-453">找到**应用程序\_启动**方法。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-453">Locate the **Application\_Start** method.</span></span>

    <span data-ttu-id="a3bc2-454">在此方法中，取消注释 EnableDefaultBundles 调用，如下面的代码段中所示。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-454">In this method, uncomment the EnableDefaultBundles call as shown in the snippet below.</span></span> <span data-ttu-id="a3bc2-455">这使我们能够通过使用到该文件夹的路径中引用捆绑的集合文件夹中的 CSS 文件再加上&quot;CSS&quot;或&quot;JS&quot;后缀。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-455">This enables us to reference a bundled collection of CSS files in a folder by using the path to that folder, plus the &quot;CSS&quot; or the &quot;JS&quot; suffix.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample11.cs)]
5. <span data-ttu-id="a3bc2-456">打开**Optimization.aspx**文件，找到的内容控件**HeadContent**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-456">Open the **Optimization.aspx** file and locate the content control for **HeadContent**.</span></span>

    <span data-ttu-id="a3bc2-457">请注意，CSS 文件和 JS 文件具有单个引用的标记。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-457">Notice the CSS files and the JS files have a single referenced tag.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample12.aspx)]

    > [!NOTE]
    > <span data-ttu-id="a3bc2-458">此代码是出于演示目的。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-458">This code is for demo purposes.</span></span> <span data-ttu-id="a3bc2-459">理想情况下，将引用 Site.Master 文件中的捆绑包。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-459">Ideally, you will reference the bundles in the Site.Master file.</span></span> <span data-ttu-id="a3bc2-460">在此示例代码中，您将发现一些绑定的文件，也正在 Site.Master 文件中，通过引用进行此最后一个引用冗余。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-460">In this sample code, you will find that some of the bundled files are also being referenced by the Site.Master file, making this last reference redundant.</span></span>
6. <span data-ttu-id="a3bc2-461">请注意，使用链接中的绑定约定**href**属性从样式和 Scripts\custom 获取所有 CSS 或 JS 文件文件夹分别。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-461">Notice that the links are using the bundling conventions in the **href** attribute to get all the CSS or JS files from the Styles and Scripts\custom folder respectively.</span></span>

    <span data-ttu-id="a3bc2-462">可以使用路径**脚本/自定义/JS**捆绑和缩小内的所有 JS 文件如下所示**自定义脚本/** 文件夹。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-462">You can use the path **Scripts/custom/JS** as shown below to bundle and minify all the JS files inside a **Scripts/custom** folder.</span></span> <span data-ttu-id="a3bc2-463">这是默认捆绑包的默认行为。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-463">This is the default behavior with the default bundles.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample13.aspx)]
7. <span data-ttu-id="a3bc2-464">打开**Styles\Site.css**文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-464">Open the **Styles\Site.css** file.</span></span>

    <span data-ttu-id="a3bc2-465">请注意，原始的 CSS 文件包含缩进的代码、 空格和扩大文件的注释。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-465">Notice that the original CSS file contains indented code, blank spaces and comments that enlarge the file.</span></span> <span data-ttu-id="a3bc2-466">（还 JavaScript 文件包含空格和注释）。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-466">(Also the JavaScript file contains blank spaces and comments).</span></span>

    <span data-ttu-id="a3bc2-467">![脚本文件夹中的一个原始的 CSS 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "脚本文件夹中的一个原始的 CSS 文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-467">![One of the original CSS files in the Scripts folder](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "One of the original CSS files in the Scripts folder")</span></span>

    *<span data-ttu-id="a3bc2-468">在脚本文件夹中的原始 CSS 文件之一</span><span class="sxs-lookup"><span data-stu-id="a3bc2-468">One of the original CSS files in the Scripts folder</span></span>*
8. <span data-ttu-id="a3bc2-469">按**F5**运行该应用程序并导航到**优化**页。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-469">Press **F5** to run the application and navigate to the **Optimization** page.</span></span>
9. <span data-ttu-id="a3bc2-470">单击**CSS 捆绑包**链接以下载并打开文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-470">Click on the **CSS Bundle** link to download and open the file.</span></span>

    <span data-ttu-id="a3bc2-471">签出缩小捆绑文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-471">Check out the minified bundled file.</span></span> <span data-ttu-id="a3bc2-472">您会注意到，已删除所有空格、 注释和缩进字符，生成较小的文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-472">You will notice that all the blank spaces, comments and indentation characters have been removed, generating a smaller file.</span></span>

    <span data-ttu-id="a3bc2-473">![在绑定的 CSS 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "捆绑 CSS 文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-473">![Bundled CSS files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "Bundled CSS files")</span></span>

    *<span data-ttu-id="a3bc2-474">绑定的 CSS 文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-474">Bundled CSS files</span></span>*
10. <span data-ttu-id="a3bc2-475">现在，单击**JS 捆绑**链接以打开捆绑在一起的 JavaScript 文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-475">Now click the **JS Bundle** link to open the JavaScript bundled file.</span></span> <span data-ttu-id="a3bc2-476">你可以安全地忽略警告的资源管理器。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-476">You can safely disregard the explorer warning.</span></span> <span data-ttu-id="a3bc2-477">请注意下的 JavaScript 文件**自定义**文件夹也捆绑和缩小。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-477">Notice the JavaScript files under the **custom** folder are also bundled and minified.</span></span>

    <span data-ttu-id="a3bc2-478">![在绑定的 JavaScript 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "捆绑 JavaScript 文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-478">![Bundled JavaScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "Bundled JavaScript files")</span></span>

    *<span data-ttu-id="a3bc2-479">绑定的 JavaScript 文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-479">Bundled JavaScript files</span></span>*

    <span data-ttu-id="a3bc2-480">启用 CSS 或 JS 文件的压缩是复杂得多早期 ASP.NET 版本中。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-480">Enabling compression for CSS or JS files was much more complicated in previous ASP.NET version.</span></span> <span data-ttu-id="a3bc2-481">现在，如您所见，您只需添加中的一行*Global.asax*文件启用绑定，并从你的站点引用捆绑的文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-481">Now, as you have seen, you just need to add one line in the *Global.asax* file to enable bundling, and then reference the bundled files from your site.</span></span>

<a id="Ex4Task3"></a>

<a id="Task_3_-_Static_Bundles"></a>
#### <a name="task-3---static-bundles"></a><span data-ttu-id="a3bc2-482">任务 3-静态捆绑包</span><span class="sxs-lookup"><span data-stu-id="a3bc2-482">Task 3 - Static Bundles</span></span>

<span data-ttu-id="a3bc2-483">静态捆绑包方法，可自定义捆绑包、 引用和缩小方法用于将文件组。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-483">The static bundle approach allows you to customize the set of files to bundle, the reference and the minification method that will be used.</span></span>

<span data-ttu-id="a3bc2-484">在此任务中，您将配置一个静态的捆绑包来定义一组特定的捆绑和缩小的文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-484">In this task, you will configure a static bundle to define a specific set of files to bundle and minify.</span></span>

1. <span data-ttu-id="a3bc2-485">关闭浏览器。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-485">Close the browser.</span></span>
2. <span data-ttu-id="a3bc2-486">打开**Global.asax.cs**文件，找到**应用程序\_启动**方法。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-486">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
3. <span data-ttu-id="a3bc2-487">取消注释下面的代码中所示的静态绑定代码。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-487">Uncomment the static bundle code as shown in the code below.</span></span>

    <span data-ttu-id="a3bc2-488">要定义了将使用引用的静态捆绑&quot; **~/StaticBundle** &quot;虚拟路径和使用**JsMinify**与所有指定文件缩减为**AddFile**方法。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-488">You are defining a static bundle that will be referenced with the &quot;**~/StaticBundle**&quot; virtual path and use **JsMinify** for minification of all the specified files with the **AddFile** method.</span></span> <span data-ttu-id="a3bc2-489">最后，要添加到静态捆绑**BundleTable**和启用它。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-489">Finally, you are adding the static bundle to the **BundleTable** and enabling it.</span></span>

    <span data-ttu-id="a3bc2-490">请注意，文件不位于同一位置;这是通过默认绑定的另一个优点。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-490">Notice that the files are not located in the same place; this is another advantage over the default bundling.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample14.cs)]
4. <span data-ttu-id="a3bc2-491">打开**Optimization.aspx**文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-491">Open the **Optimization.aspx** file.</span></span>

    <span data-ttu-id="a3bc2-492">请注意，指向**静态 JS 捆绑**正在使用时在 Global.asax.cs 文件中配置静态捆绑包已声明的路径： **/StaticBundle**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-492">Notice that the link to **Static JS Bundle** is using the path you have declared when you configured the static bundle in the Global.asax.cs file: **/StaticBundle**.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample15.aspx)]
5. <span data-ttu-id="a3bc2-493">按**F5**若要运行该应用程序，然后导航到**优化**页。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-493">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
6. <span data-ttu-id="a3bc2-494">单击**静态 JS 捆绑**链接以打开该文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-494">Click on the **Static JS Bundle** link to open the file.</span></span>

    <span data-ttu-id="a3bc2-495">请注意，缩小捆绑 JavaScript 文件是在路径下的静态绑定文件中配置的所有 JavaScript 文件的输出&quot;/StaticBundle&quot;。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-495">Notice that the minified bundled JavaScript file is the output for all the JavaScript files configured in the static bundle file under the path &quot;/StaticBundle&quot;.</span></span>

    <span data-ttu-id="a3bc2-496">![静态 JavaScript 文件捆绑](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "静态 JavaScript 文件捆绑包")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-496">![Static JavaScript files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "Static JavaScript files bundle")</span></span>

    *<span data-ttu-id="a3bc2-497">静态 JavaScript 文件捆绑在一起</span><span class="sxs-lookup"><span data-stu-id="a3bc2-497">Static JavaScript files bundle</span></span>*
7. <span data-ttu-id="a3bc2-498">关闭浏览器并返回到 Visual Studio。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-498">Close the browser and return to Visual Studio.</span></span>

<a id="Ex4Task4"></a>

<a id="Task_4_-_Dynamic_Folder_Bundles"></a>
#### <a name="task-4---dynamic-folder-bundles"></a><span data-ttu-id="a3bc2-499">任务 4-动态文件夹捆绑包</span><span class="sxs-lookup"><span data-stu-id="a3bc2-499">Task 4 - Dynamic Folder Bundles</span></span>

<span data-ttu-id="a3bc2-500">在本任务中，您将学习如何配置动态文件夹捆绑包。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-500">In this task, you will learn how to configure dynamic folder bundles.</span></span> <span data-ttu-id="a3bc2-501">动态绑定的强大功能是可以包含静态 JavaScript，以及其他文件中将编译为 JavaScript 的语言，因此，需要进行一些处理绑定执行之前。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-501">The power of dynamic bundling is that you can include static JavaScript, as well as other files in languages that compiles into JavaScript, and thus, require some processing before the bundling is executed.</span></span>

<span data-ttu-id="a3bc2-502">在此示例中，您将学习如何使用**DynamicFolderBundle**类，以创建用于写入 CofeeScript 中的文件的动态捆绑包。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-502">In this example, you will learn how to use the **DynamicFolderBundle** class to create a dynamic bundle for files written in CofeeScript.</span></span> <span data-ttu-id="a3bc2-503">CofeeScript 是一种编程语言，将编译为 JavaScript，提供更简单的语法来编写 JavaScript 代码，从而加强 JavaScript 的简洁和可读性。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-503">CofeeScript is a programming language that compiles into JavaScript and provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability.</span></span>

1. <span data-ttu-id="a3bc2-504">打开**Global.asax.cs**文件，找到**应用程序\_启动**方法。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-504">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
2. <span data-ttu-id="a3bc2-505">取消注释以下代码中所示的动态绑定代码。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-505">Uncomment the dynamic bundle code as shown in the code below.</span></span>

    <span data-ttu-id="a3bc2-506">定义了将使用的动态文件夹捆绑**CoffeeMinify**将仅应用到的文件的自定义缩小处理器&quot; **.coffee** &quot;扩展 (CoffeeScript 文件）。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-506">You are defining a dynamic folder bundle that will use the **CoffeeMinify** custom minification processor that will only apply to the files with the &quot;**.coffee**&quot; extension (CoffeeScript files).</span></span> <span data-ttu-id="a3bc2-507">请注意，您可以使用搜索模式来选择要在文件夹中，如捆绑的文件\*.coffee。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-507">Notice that you can use a search pattern to select the files to bundle within a folder, like '\*.coffee'.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample16.cs)]
3. <span data-ttu-id="a3bc2-508">打开 NuGet 包管理器控制台。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-508">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="a3bc2-509">若要执行此操作，使用菜单**视图** | **其他 Windows** | **程序包管理器控制台**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-509">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>
4. <span data-ttu-id="a3bc2-510">在**程序包管理器控制台**类型**Install-package CoffeeSharp**然后按**ENTER**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-510">In the **Package Manager Console,** type **Install-Package CoffeeSharp** and press **ENTER**.</span></span>
5. <span data-ttu-id="a3bc2-511">单击**显示所有文件**按钮**解决方案资源管理器**窗口</span><span class="sxs-lookup"><span data-stu-id="a3bc2-511">Click the **Show All Files** button in the **Solution Explorer** window</span></span>

    <span data-ttu-id="a3bc2-512">![显示所有文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "都显示所有文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-512">![Showing all files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "Showing all files")</span></span>

    *<span data-ttu-id="a3bc2-513">显示所有文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-513">Showing all files</span></span>*
6. <span data-ttu-id="a3bc2-514">右键单击**CoffeeMinify.cs**中的文件**解决方案资源管理器**，然后选择**包括在项目**</span><span class="sxs-lookup"><span data-stu-id="a3bc2-514">Right click the **CoffeeMinify.cs** file in the **Solution Explorer** and select **Include in Project**</span></span>

    <span data-ttu-id="a3bc2-515">![在项目中包含 CoffeeMinify.cs 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "在项目中包含 CoffeeMinify.cs 文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-515">![Include the CoffeeMinify.cs file in the project](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "Include the CoffeeMinify.cs file in the project")</span></span>

    *<span data-ttu-id="a3bc2-516">在项目中包含 CoffeeMinify.cs 文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-516">Include the CoffeeMinify.cs file in the project</span></span>*
7. <span data-ttu-id="a3bc2-517">打开**CoffeeMinify.cs**文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-517">Open the **CoffeeMinify.cs** file.</span></span>

    <span data-ttu-id="a3bc2-518">此类继承自 JsMinify 来缩小由 CoffeeScript 代码编译产生的 JavaScript 输出。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-518">This class inherits from JsMinify to minify the JavaScript output resulting from the CoffeeScript code compilation.</span></span> <span data-ttu-id="a3bc2-519">它将调用 CoffeeScript 编译器首先，生成的 JavaScript 代码，然后将其发送给 JsMinify.Process 方法，以缩小生成的代码。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-519">It calls the CoffeeScript compiler to generate the JavaScript code first, and then it sends it to the JsMinify.Process method to minify the resulting code.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample17.cs)]
8. <span data-ttu-id="a3bc2-520">打开**Script1.coffee**并**Script2.coffee**从文件**脚本/捆绑**文件夹。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-520">Open the **Script1.coffee** and **Script2.coffee** files from the **Scripts/bundle** folder.</span></span>

    <span data-ttu-id="a3bc2-521">这些文件将包括 CoffeScript 代码执行与 CoffeeMinify 类绑定时编译。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-521">These files will include the CoffeScript code to be compiled while performing the bundling with the CoffeeMinify class.</span></span>

    <span data-ttu-id="a3bc2-522">为简单起见，提供的 CoffeeScript 文件仅包含 CoffeeScript 示例代码。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-522">For simplicity purposes, the CoffeeScript files provided are only including CoffeeScript sample code.</span></span> <span data-ttu-id="a3bc2-523">注释不由 JsMinify 进程。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-523">The comments are excluded by the JsMinify process.</span></span>

    <span data-ttu-id="a3bc2-524">![CoffeeScript 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript 文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-524">![CoffeeScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript files")</span></span>

    *<span data-ttu-id="a3bc2-525">CoffeeScript 文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-525">CoffeeScript files</span></span>*

    > [!NOTE]
    > <span data-ttu-id="a3bc2-526">[CofeeScript](https://github.com/jashkenas/coffeescript/)提供更简单的语法来编写 JavaScript 代码、 增强了 JavaScript 的简洁和可读性，以及添加其他功能，如数组理解和模式匹配。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability, as well as adding other features like array comprehension and pattern matching.</span></span>
9. <span data-ttu-id="a3bc2-527">打开**Optimization.aspx**文件，找到的捆绑包链接。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-527">Open the **Optimization.aspx** file and locate the bundle links.</span></span>

    <span data-ttu-id="a3bc2-528">请注意，到链接**动态 JS 捆绑**引用的**脚本/捆绑包**使用文件夹 **/咖啡**动态文件夹绑定配置的后缀。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-528">Notice that the link to **Dynamic JS Bundle** is referencing the **Scripts/bundle** folder by using the **/Coffee** suffix you configured for the dynamic folder bundle.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample18.aspx)]
10. <span data-ttu-id="a3bc2-529">按**F5**若要运行该应用程序，然后导航到**优化**页。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-529">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
11. <span data-ttu-id="a3bc2-530">单击**动态 JS 捆绑**链接以打开生成的文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-530">Click on the **Dynamic JS Bundle** link to open the generated file.</span></span>

    <span data-ttu-id="a3bc2-531">请注意，此捆绑包中包含的内容仅包含 **.coffee**文件。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-531">Notice that the content that was included in this bundle only contains **.coffee** files.</span></span> <span data-ttu-id="a3bc2-532">此外可以看到 CoffeeScript 代码编译为 JavaScript 且已删除注释掉的行。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-532">You can also see that the CoffeeScript code was compiled to JavaScript and the commented-out lines has been removed.</span></span>

    <span data-ttu-id="a3bc2-533">![动态 JS 文件捆绑](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "动态 JS 文件捆绑包")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-533">![Dynamic JS files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "Dynamic JS files bundle")</span></span>

    *<span data-ttu-id="a3bc2-534">动态 JS 文件捆绑在一起</span><span class="sxs-lookup"><span data-stu-id="a3bc2-534">Dynamic JS files bundle</span></span>*

> [!NOTE]
> <span data-ttu-id="a3bc2-535">此外，可以部署此应用程序到 Windows Azure Web Sites 以下[附录 b:ASP.NET MVC 4 应用程序使用 Web 部署发布](#AppendixB)。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-535">Additionally, you can deploy this application to Windows Azure Web Sites following [Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixB).</span></span>


<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="a3bc2-536">总结</span><span class="sxs-lookup"><span data-stu-id="a3bc2-536">Summary</span></span>

<span data-ttu-id="a3bc2-537">此实验室可帮助你了解什么是 ASP.NET 中的新增功能和 Visual Studio 2012 中的 Web 开发以及如何利用 Visual Studio 2012 中的许多增强功能。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-537">This lab helps you to understand what New in ASP.NET and Web Development in Visual Studio 2012 is and how to take advantage of the variety of enhancements in Visual Studio 2012.</span></span>

<span data-ttu-id="a3bc2-538">通过完成本动手实验，你已了解到如何在 Visual Studio 2012 编辑器中使用的新功能和改进，CSS、 JavaScript 和 HTML。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-538">By completing this Hands-On Lab, you have learnt how to use the new features and improvements in Visual Studio 2012 Editors for CSS, JavaScript and HTML.</span></span> <span data-ttu-id="a3bc2-539">此外，你已了解到 Visual Studio 2012 如何实现内置绑定和缩减。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-539">In addition, you have learnt how Visual Studio 2012 implements built-in bundling and minification.</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="a3bc2-540">附录 a:安装 Visual Studio Express 2012 for Web</span><span class="sxs-lookup"><span data-stu-id="a3bc2-540">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="a3bc2-541">你可以安装**Microsoft Visual Studio Express 2012 for Web**或另一个&quot;Express&quot;使用版本 **[Microsoft Web 平台安装程序](https://www.microsoft.com/web/downloads/platform.aspx)** .</span><span class="sxs-lookup"><span data-stu-id="a3bc2-541">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="a3bc2-542">以下说明将指导您完成安装所需的步骤*Visual studio Express 2012 for Web*使用*Microsoft Web 平台安装程序*。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-542">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="a3bc2-543">转到[ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169)。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-543">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="a3bc2-544">或者，如果你已安装 Web 平台安装程序，则可以打开它，并搜索产品&quot; <em>Visual Studio Express 2012 for Web 与 Windows Azure SDK</em>&quot;。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-544">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="a3bc2-545">单击**立即安装**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-545">Click on **Install Now**.</span></span> <span data-ttu-id="a3bc2-546">如果还没有**Web 平台安装程序**将重定向以下载并安装。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-546">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="a3bc2-547">一次**Web 平台安装程序**处于打开状态，单击**安装**以启动安装程序。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-547">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="a3bc2-548">![安装 Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "安装 Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-548">![Install Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "Install Visual Studio Express")</span></span>

    *<span data-ttu-id="a3bc2-549">安装 Visual Studio Express</span><span class="sxs-lookup"><span data-stu-id="a3bc2-549">Install Visual Studio Express</span></span>*
4. <span data-ttu-id="a3bc2-550">阅读所有产品的许可证和条款，然后单击**我接受**以继续。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-550">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![接受许可条款](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image60.png)

    *<span data-ttu-id="a3bc2-552">接受许可条款</span><span class="sxs-lookup"><span data-stu-id="a3bc2-552">Accepting the license terms</span></span>*
5. <span data-ttu-id="a3bc2-553">等待，直到下载和安装过程完成。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-553">Wait until the downloading and installation process completes.</span></span>

    ![安装进度](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image61.png)

    *<span data-ttu-id="a3bc2-555">安装进度</span><span class="sxs-lookup"><span data-stu-id="a3bc2-555">Installation progress</span></span>*
6. <span data-ttu-id="a3bc2-556">安装完成后，单击**完成**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-556">When the installation completes, click **Finish**.</span></span>

    ![安装已完成](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image62.png)

    *<span data-ttu-id="a3bc2-558">安装已完成</span><span class="sxs-lookup"><span data-stu-id="a3bc2-558">Installation completed</span></span>*
7. <span data-ttu-id="a3bc2-559">单击**退出**以关闭 Web 平台安装程序。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-559">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="a3bc2-560">若要打开 Visual Studio Express for Web，请转到**启动**屏幕上即可开始编写&quot; **VS Express**&quot;，然后单击**VS Express for Web**磁贴。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-560">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web 磁贴](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image63.png)

    *<span data-ttu-id="a3bc2-562">VS Express for Web 磁贴</span><span class="sxs-lookup"><span data-stu-id="a3bc2-562">VS Express for Web tile</span></span>*
...
## <a name="appendix-b-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="a3bc2-563">附录 b:ASP.NET MVC 4 应用程序使用 Web 部署发布</span><span class="sxs-lookup"><span data-stu-id="a3bc2-563">Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="a3bc2-564">本附录将演示如何从 Windows Azure 管理门户创建新的网站和发布应用程序获取按照本实验中，利用 Windows Azure 提供的 Web 部署发布功能。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-564">This appendix will show you how to create a new web site from the Windows Azure Management Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Windows Azure.</span></span>

<a id="Ex1Task1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-windows-azure-portal"></a><span data-ttu-id="a3bc2-565">任务 1-创建新的 Web 站点从 Windows Azure 门户</span><span class="sxs-lookup"><span data-stu-id="a3bc2-565">Task 1 - Creating a New Web Site from the Windows Azure Portal</span></span>

1. <span data-ttu-id="a3bc2-566">转到[Windows Azure 管理门户](https://manage.windowsazure.com/)并使用与你的订阅关联的 Microsoft 凭据登录。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-566">Go to the [Windows Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a3bc2-567">使用 Windows Azure 可以免费托管 10 个 ASP.NET 网站，然后随着流量增长情况。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-567">With Windows Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="a3bc2-568">你可以注册[此处](https://aka.ms/aspnet-hol-azure)。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-568">You can sign up [here](https://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="a3bc2-569">![登录到 Windows Azure 门户](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "登录到 Windows Azure 门户")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-569">![Log on to Windows Azure portal](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Log on to Windows Azure portal")</span></span>

    *<span data-ttu-id="a3bc2-570">登录到 Windows Azure 管理门户</span><span class="sxs-lookup"><span data-stu-id="a3bc2-570">Log on to Windows Azure Management Portal</span></span>*
2. <span data-ttu-id="a3bc2-571">单击**新建**命令栏上。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-571">Click **New** on the command bar.</span></span>

    <span data-ttu-id="a3bc2-572">![创建新的 Web 站点](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "创建新的 Web 站点")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-572">![Creating a new Web Site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "Creating a new Web Site")</span></span>

    *<span data-ttu-id="a3bc2-573">创建新的 Web 站点</span><span class="sxs-lookup"><span data-stu-id="a3bc2-573">Creating a new Web Site</span></span>*
3. <span data-ttu-id="a3bc2-574">单击**计算** | **网站**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-574">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="a3bc2-575">然后选择**快速创建**选项。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-575">Then select **Quick Create** option.</span></span> <span data-ttu-id="a3bc2-576">为新网站提供可用的 URL，然后单击**创建网站**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-576">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a3bc2-577">Windows Azure 网站是可以控制和管理在云中运行的 web 应用程序主机。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-577">A Windows Azure Web Site is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="a3bc2-578">快速创建选项，可将已完成的 web 应用程序到 Windows Azure 网站从门户外部的部署。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-578">The Quick Create option allows you to deploy a completed web application to the Windows Azure Web Site from outside the portal.</span></span> <span data-ttu-id="a3bc2-579">它不包括用于设置数据库的步骤。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-579">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="a3bc2-580">![创建新的网站使用快速创建](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "创建新的网站使用快速创建")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-580">![Creating a new Web Site using Quick Create](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "Creating a new Web Site using Quick Create")</span></span>

    *<span data-ttu-id="a3bc2-581">创建新的网站使用快速创建</span><span class="sxs-lookup"><span data-stu-id="a3bc2-581">Creating a new Web Site using Quick Create</span></span>*
4. <span data-ttu-id="a3bc2-582">等到新**网站**创建。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-582">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="a3bc2-583">创建网站后，单击下面的链接**URL**列。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-583">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="a3bc2-584">检查新的 Web 站点正常工作。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-584">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="a3bc2-585">![浏览到新的 web 站点](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "浏览到新的 web 站点")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-585">![Browsing to the new web site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "Browsing to the new web site")</span></span>

    *<span data-ttu-id="a3bc2-586">浏览到新的 web 站点</span><span class="sxs-lookup"><span data-stu-id="a3bc2-586">Browsing to the new web site</span></span>*

    <span data-ttu-id="a3bc2-587">![正在运行的网站](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "正在运行的网站")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-587">![Web site running](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "Web site running")</span></span>

    *<span data-ttu-id="a3bc2-588">正在运行的网站</span><span class="sxs-lookup"><span data-stu-id="a3bc2-588">Web site running</span></span>*
6. <span data-ttu-id="a3bc2-589">返回到门户并单击下的 web 站点的名称**名称**列中显示的管理页。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-589">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="a3bc2-590">![打开网站管理页](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "打开网站管理页")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-590">![Opening the web site management pages](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "Opening the web site management pages")</span></span>

    *<span data-ttu-id="a3bc2-591">打开网站管理页</span><span class="sxs-lookup"><span data-stu-id="a3bc2-591">Opening the Web Site management pages</span></span>*
7. <span data-ttu-id="a3bc2-592">在中**仪表板**页面上，在**速览**部分中，单击**下载发布配置文件**链接。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-592">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a3bc2-593">*发布配置文件*包含所有发布到每个启用的发布方法的 Windows Azure 网站的 web 应用程序所需的信息。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-593">The *publish profile* contains all of the information required to publish a web application to a Windows Azure website for each enabled publication method.</span></span> <span data-ttu-id="a3bc2-594">发布配置文件包含 Url、 用户凭据和连接到并对每个发布方法启用的终结点进行身份验证所需的数据库字符串。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-594">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="a3bc2-595">**Microsoft WebMatrix 2**， **Microsoft Visual Studio Express for Web**并**Microsoft Visual Studio 2012**支持读取发布配置文件，以自动执行这些计划的配置web 应用程序发布到 Windows Azure 网站。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Windows Azure websites.</span></span>

    <span data-ttu-id="a3bc2-596">![正在下载网站发布配置文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "下载网站发布配置文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-596">![Downloading the web site publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "Downloading the web site publish profile")</span></span>

    *<span data-ttu-id="a3bc2-597">正在下载网站发布配置文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-597">Downloading the Web Site publish profile</span></span>*
8. <span data-ttu-id="a3bc2-598">下载发布配置文件到已知位置。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-598">Download the publish profile file to a known location.</span></span> <span data-ttu-id="a3bc2-599">进一步在此练习中将了解如何使用此文件从 Visual Studio 的 web 应用程序到 Windows Azure 网站发布。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-599">Further in this exercise you will see how to use this file to publish a web application to a Windows Azure Web Sites from Visual Studio.</span></span>

    <span data-ttu-id="a3bc2-600">![保存发布配置文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "保存发布配置文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-600">![Saving the publish profile file](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "Saving the publish profile")</span></span>

    *<span data-ttu-id="a3bc2-601">保存发布配置文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-601">Saving the publish profile file</span></span>*

<a id="Ex1Task2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="a3bc2-602">任务 2-配置数据库服务器</span><span class="sxs-lookup"><span data-stu-id="a3bc2-602">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="a3bc2-603">如果你的应用程序将使用的 SQL Server 数据库将需要创建 SQL 数据库服务器。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-603">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="a3bc2-604">如果你想要部署的简单应用程序不使用 SQL Server 可能会跳过此任务。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-604">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="a3bc2-605">用于存储应用程序数据库，将需要 SQL 数据库服务器。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-605">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="a3bc2-606">可以从在 Windows Azure 管理门户在订阅中查看 SQL 数据库服务器**Sql 数据库** | **服务器** | **服务器的仪表板**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-606">You can view the SQL Database servers from your subscription in the Windows Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="a3bc2-607">如果没有创建的服务器，则可以创建一个使用**添加**命令栏上的按钮。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-607">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="a3bc2-608">请注意**服务器名称和 URL、 管理员登录名和密码**，因为你将在下一任务中使用它们。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-608">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="a3bc2-609">不创建数据库，因为它将在后面的阶段中创建。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-609">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="a3bc2-610">![SQL 数据库服务器仪表板](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL Database 服务器仪表板")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-610">![SQL Database Server Dashboard](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL Database Server Dashboard")</span></span>

    *<span data-ttu-id="a3bc2-611">SQL 数据库服务器仪表板</span><span class="sxs-lookup"><span data-stu-id="a3bc2-611">SQL Database Server Dashboard</span></span>*
2. <span data-ttu-id="a3bc2-612">在下一个任务将测试从 Visual Studio 中，数据库连接，因此您需要在服务器的列表中包括你的本地 IP 地址**允许的 IP 地址**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-612">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="a3bc2-613">若要执行此操作，请单击**配置**，选择中的 IP 地址**当前客户端 IP 地址**并将其粘贴在上**起始 IP 地址**和**结束 IP 地址**文本框。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-613">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes.</span></span> <span data-ttu-id="a3bc2-614">输入规则的名称，然后单击![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png)按钮。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-614">Enter a name for the rule and click the ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) button.</span></span>

    ![添加客户端 IP 地址](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image74.png)

    *<span data-ttu-id="a3bc2-616">添加客户端 IP 地址</span><span class="sxs-lookup"><span data-stu-id="a3bc2-616">Adding Client IP Address</span></span>*
3. <span data-ttu-id="a3bc2-617">一次**客户端 IP 地址**添加到允许的 IP 地址列表中，单击**保存**以确认所做的更改。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-617">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![确认更改](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image75.png)

    *<span data-ttu-id="a3bc2-619">确认更改</span><span class="sxs-lookup"><span data-stu-id="a3bc2-619">Confirm Changes</span></span>*

<a id="Ex1Task3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="a3bc2-620">任务 3-ASP.NET MVC 4 应用程序使用 Web 部署发布</span><span class="sxs-lookup"><span data-stu-id="a3bc2-620">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="a3bc2-621">返回到 ASP.NET MVC 4 解决方案。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-621">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="a3bc2-622">在中**解决方案资源管理器**，右键单击网站项目并选择**发布**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-622">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="a3bc2-623">![发布应用程序](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "发布应用程序")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-623">![Publishing the Application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "Publishing the Application")</span></span>

    *<span data-ttu-id="a3bc2-624">发布此网站</span><span class="sxs-lookup"><span data-stu-id="a3bc2-624">Publishing the web site</span></span>*
2. <span data-ttu-id="a3bc2-625">导入发布配置文件保存在第一个任务。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-625">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="a3bc2-626">![导入发布配置文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "导入发布配置文件")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-626">![Importing the publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "Importing the publish profile")</span></span>

    *<span data-ttu-id="a3bc2-627">导入发布配置文件</span><span class="sxs-lookup"><span data-stu-id="a3bc2-627">Importing publish profile</span></span>*
3. <span data-ttu-id="a3bc2-628">单击**验证连接**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-628">Click **Validate Connection**.</span></span> <span data-ttu-id="a3bc2-629">验证完成后单击**下一步**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-629">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a3bc2-630">请参阅验证连接按钮旁边会出现一个绿色复选标记后，验证已完成。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-630">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="a3bc2-631">![验证连接](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "验证连接")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-631">![Validating connection](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "Validating connection")</span></span>

    *<span data-ttu-id="a3bc2-632">验证连接</span><span class="sxs-lookup"><span data-stu-id="a3bc2-632">Validating connection</span></span>*
4. <span data-ttu-id="a3bc2-633">在中**设置**页面上，在**数据库**部分中，单击您的数据库连接的文本框旁边的按钮 (即**DefaultConnection**)。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-633">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="a3bc2-634">![Web 部署配置](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web 部署配置")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-634">![Web deploy configuration](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web deploy configuration")</span></span>

    *<span data-ttu-id="a3bc2-635">Web 部署配置</span><span class="sxs-lookup"><span data-stu-id="a3bc2-635">Web deploy configuration</span></span>*
5. <span data-ttu-id="a3bc2-636">配置数据库连接，如下所示：</span><span class="sxs-lookup"><span data-stu-id="a3bc2-636">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="a3bc2-637">在中**服务器名称**键入 SQL 数据库服务器 URL 使用*tcp:* 前缀。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-637">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="a3bc2-638">在中**用户名**键入服务器管理员登录名。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-638">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="a3bc2-639">在中**密码**键入服务器管理员登录密码。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-639">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="a3bc2-640">键入新的数据库名称，例如：*MVC4SampleDB*。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-640">Type a new database name, for example: *MVC4SampleDB*.</span></span>

     <span data-ttu-id="a3bc2-641">![配置目标连接字符串](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "配置目标连接字符串")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-641">![Configuring destination connection string](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "Configuring destination connection string")</span></span>

     *<span data-ttu-id="a3bc2-642">配置目标连接字符串</span><span class="sxs-lookup"><span data-stu-id="a3bc2-642">Configuring destination connection string</span></span>*
6. <span data-ttu-id="a3bc2-643">然后单击“确定” 。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-643">Then click **OK**.</span></span> <span data-ttu-id="a3bc2-644">当系统提示你创建数据库时，单击**是**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-644">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="a3bc2-645">![创建数据库](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "创建数据库字符串")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-645">![Creating the database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "Creating the database string")</span></span>

    *<span data-ttu-id="a3bc2-646">创建数据库</span><span class="sxs-lookup"><span data-stu-id="a3bc2-646">Creating the database</span></span>*
7. <span data-ttu-id="a3bc2-647">将用于连接到 Windows Azure 中的 SQL 数据库的连接字符串是显示在默认连接文本框内。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-647">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="a3bc2-648">然后，单击 **“下一步”**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-648">Then click **Next**.</span></span>

    <span data-ttu-id="a3bc2-649">![连接字符串指向 SQL 数据库](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "指向 SQL 数据库连接字符串")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-649">![Connection string pointing to SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "Connection string pointing to SQL Database")</span></span>

    *<span data-ttu-id="a3bc2-650">连接字符串指向 SQL 数据库</span><span class="sxs-lookup"><span data-stu-id="a3bc2-650">Connection string pointing to SQL Database</span></span>*
8. <span data-ttu-id="a3bc2-651">在中**预览版**页上，单击**发布**。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-651">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="a3bc2-652">![Web 应用程序发布](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "发布 web 应用程序")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-652">![Publishing the web application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "Publishing the web application")</span></span>

    *<span data-ttu-id="a3bc2-653">Web 应用程序发布</span><span class="sxs-lookup"><span data-stu-id="a3bc2-653">Publishing the web application</span></span>*
9. <span data-ttu-id="a3bc2-654">在发布过程完成后，在默认浏览器将打开已发布的网站。</span><span class="sxs-lookup"><span data-stu-id="a3bc2-654">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="a3bc2-655">![应用程序发布到 Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "应用程序发布到 Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="a3bc2-655">![Application published to Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "Application published to Windows Azure")</span></span>

    *<span data-ttu-id="a3bc2-656">应用程序发布到 Windows Azure</span><span class="sxs-lookup"><span data-stu-id="a3bc2-656">Application published to Windows Azure</span></span>*
