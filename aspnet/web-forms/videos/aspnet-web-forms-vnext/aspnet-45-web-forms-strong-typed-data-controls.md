...
title: ASP.NET 4.5 Web 窗体强类型化数据控件 |Microsoft Docs
author: shanselman
description: Scott Hanselman 演示了新的 ASP.NET 4.5 Web 窗体强类型化数据控件。
ms.author: riande
ms.date: 08/15/2012
...
[&#9654;观看视频（4分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-45-web-forms-strong-typed-data-controls)
