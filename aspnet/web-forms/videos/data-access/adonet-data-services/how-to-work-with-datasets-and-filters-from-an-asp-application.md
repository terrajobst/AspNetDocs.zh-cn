...
ms.locfileid: "57054334"
---
<a name="how-to-work-with-datasets-and-filters-from-an-asp-application"></a>如何使用数据集和筛选器从 ASP 应用程序
====================
通过[Joe Stagner](https://github.com/JoeStagner)

在本视频中，为 3，第 3 部分 Joe Stagner 演示了如何从应用程序的整体数据集中返回经过筛选的数据集。 与本视频有关的其他信息，请阅读[创建数据访问层](../../../overview/data-access/introduction/creating-a-data-access-layer-vb.md)数据访问教程。
