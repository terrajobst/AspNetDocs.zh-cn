...
---
<a name="how-do-i-create-xml-documents-from-sql-data"></a>[如何实现:]通过 SQL 数据创建 XML 文档？
====================
通过[Beth Massi](https://github.com/bethmassi)

Visual Basic 开发人员将了解如何轻松地创建 XML 和 HTML 文档直接在 Visual Basic 编辑器以查询其 SQL Server 数据库。
