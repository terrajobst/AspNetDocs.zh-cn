...
description: .NET Framework 4 中可用的新 ASP.NET 特性和功能。
ms.author: riande
ms.date: 10/05/2011
...
- [Ajax](ajax/index.md)
    ...
    - [Microsoft 客户端控件的命令性 JavaScript 语法](ajax/aspnet-4-quick-hit-imperative-javascript-syntax-for-microsoft-client-side-controls.md)
...
- [图表](chart/index.md)
    ...
    - [Chart 控件](chart/aspnet-4-quick-hit-chart-control.md)
...
- [“标记”控件](markup-control/index.md)
    ...
    - [禁用的控件样式](markup-control/aspnet-4-quick-hit-disabled-control-styling.md)
...
- [路由](routing/index.md)
    ...
    - [强制性 WebForms 路由](routing/aspnet-4-quick-hit-imperative-webforms-routing.md)
    - [声明性 WebForms 路由](routing/aspnet-4-quick-hit-declarative-webforms-routing.md)
    - [出站 WebForms 路由](routing/aspnet-4-quick-hit-outbound-webforms-routing.md)
    - [向 ASP.NET Web 窗体使用路由](routing/how-do-i-use-routing-with-aspnet-web-forms.md)
    - [使用 ASP.NET 路由中的 URL](routing/how-do-i-work-with-urls-in-aspnet-routing.md)
- [SEO](seo/index.md)

    - [动态元数据](seo/aspnet-4-quick-hit-dynamic-metadata.md)
