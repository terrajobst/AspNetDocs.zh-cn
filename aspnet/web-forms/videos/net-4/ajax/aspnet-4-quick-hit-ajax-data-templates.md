...
---
# <a name="aspnet-4-quick-hit---ajax-data-templates"></a>ASP.NET 4"快速命中"的 AJAX 数据模板

通过[Joe Stagner](https://github.com/JoeStagner)

在本视频中，您将学习如何使用客户端模板以显示通过 DataView 控件的数据库记录。 

[&#9654;观看视频 （12 分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-ajax-data-templates)

> [!div class="step-by-step"]
> [上一个](aspnet-4-quick-hit-jquery-syntax-for-microsoft-ajax.md)
