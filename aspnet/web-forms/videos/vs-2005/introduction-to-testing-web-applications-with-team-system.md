...
---
# <a name="introduction-to-testing-web-applications-with-team-system"></a>通过 Team System 测试 Web 应用程序简介

作者： Eric

在此视频中，我们将了解如何使用 Visual Studio Team System 的 web 测试功能自动测试您的 web 应用程序。

[&#9654;观看视频（9分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/introduction-to-testing-web-applications-with-team-system)
