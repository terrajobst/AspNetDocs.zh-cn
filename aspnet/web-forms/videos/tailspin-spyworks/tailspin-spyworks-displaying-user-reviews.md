...
---
# <a name="tailspin-spyworks---displaying-user-reviews"></a>Tailspin Spyworks - 显示用户评论

通过[Joe Stagner](https://github.com/JoeStagner)

Joe Stagner Tailspin Spyworks 示例 Web 窗体应用程序中显示客户的评论。

[&#9654;观看视频 （13 分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/tailspin-spyworks-displaying-user-reviews)

> [!div class="step-by-step"]
> [上一个](tailspin-spyworks-adding-user-product-reviews.md)
