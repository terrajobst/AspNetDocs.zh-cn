...
ms.locfileid: "57053704"
---
<a name="understanding-aspnet-memberships"></a>了解 ASP.NET 成员身份
====================
通过[Joe Stagner](https://github.com/JoeStagner)

在本视频中 Joe Stagner 介绍使用内置的提供程序，可供 ASP.NET 开发人员的成员身份。 与本视频有关的其他信息，请阅读[SQL Server 中创建成员身份架构](../../overview/older-versions-security/membership/creating-the-membership-schema-in-sql-server-vb.md)安全教程。
