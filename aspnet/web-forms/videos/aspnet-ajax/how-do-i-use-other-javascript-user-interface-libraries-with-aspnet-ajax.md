...
Microsoft 是组成部分[OpenAjax 联盟](http://www.openajax.org/)和 Microsoft AJAX Library 设计为可无缝使用第三方 JavaScript 用户界面库。 此视频提供了 ASP.NET AJAX、 原型和 script.aculo.us 之间的互操作性的演示。
