...
了解如何轻松地将 Microsoft ASP.NET AJAX 功能添加到现有的 ASP.NET 应用程序。 此视频介绍无需更改您的服务器控件或数据访问代码-只需添加并配置几个 ASP.NET AJAX 控件。 简单 ！

[&#9654;观看视频 （7 分钟为单位）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-add-aspnet-ajax-features-to-an-existing-web-application)
