...
---
# <a name="visual-studio-2010-quick-hit---new-multi-targeting"></a>Visual Studio 2010 "快速点击"-新的多目标

作者： [Joe Stagner](https://github.com/JoeStagner)

在此视频中，您将了解如何使用 Visual Studio 的增强的多目标支持，这允许您使用和面向 .NET 的多个版本。

[&#9654;观看视频（6分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/visual-studio-2010-quick-hit-new-multi-targeting)
