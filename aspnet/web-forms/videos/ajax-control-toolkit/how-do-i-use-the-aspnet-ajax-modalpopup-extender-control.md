...
---
# <a name="how-do-i-use-the-aspnet-ajax-modalpopup-extender-control"></a>[如何实现:]使用 ASP.NET AJAX ModalPopup 扩展程序控件？

通过[Joe Stagner](https://github.com/JoeStagner)

了解如何使用 ASP.NET AJAX 控件工具包附带的 ASP.NET AJAX ModalPopup 扩展程序控件。 在本视频中 ModalPopup 扩展程序用于弹开标准 ASP.NET 面板控件为模式对话框。
