...
ms.locfileid: "57030564"
---
<a name="how-do-i-use-the-new-entity-data-source"></a>[如何实现:]使用新的实体数据源
====================
通过[Diego Vega](https://github.com/divega)

在此介绍性视频 Diego Vega 将演示如何使用 ASP.NET 应用程序中的实体数据源。
