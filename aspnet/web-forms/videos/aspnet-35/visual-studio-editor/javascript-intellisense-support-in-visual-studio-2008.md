...
---
<a name="javascript-intellisense-support-in-visual-studio-2008"></a>Visual Studio 2008 中的 JavaScript IntelliSense
====================
通过[Joe Stagner](https://github.com/JoeStagner)

在本视频中我将重点介绍一些 JavaScript Intellisense 内置于 Visual Studio 2008。 我将介绍通过编写 JavaScript 代码的方式来改进 Intellisense JavaScript 功能的方式。
