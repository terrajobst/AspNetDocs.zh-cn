...
title: jQuery 数据表 1.10.5 |Microsoft Docs
...
ms.locfileid: "78454130"
---
# <a name="jquery-datatables-1105"></a><span data-ttu-id="13391-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="13391-102">jQuery DataTables 1.10.5</span></span>

<span data-ttu-id="13391-103">JQuery 数据表插件的以下文件托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="13391-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
