...
ms.locfileid: "59383728"
---
# <a name="jquery-datatables-193"></a><span data-ttu-id="b13d9-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="b13d9-102">jQuery DataTables 1.9.3</span></span>

<span data-ttu-id="b13d9-103">在 CDN 上托管的 jQuery DataTables 插件的以下文件：</span><span class="sxs-lookup"><span data-stu-id="b13d9-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
