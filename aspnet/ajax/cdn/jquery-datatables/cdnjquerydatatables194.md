...
title: jQuery 数据表 1.9.4 |Microsoft Docs
...
ms.locfileid: "78454046"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="7265e-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="7265e-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="7265e-103">JQuery 数据表插件的以下文件托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="7265e-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
