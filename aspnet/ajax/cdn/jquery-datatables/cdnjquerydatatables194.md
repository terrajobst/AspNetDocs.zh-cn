...
---
<a name="jquery-datatables-194"></a><span data-ttu-id="700ae-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="700ae-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="700ae-103">在 CDN 上托管的 jQuery DataTables 插件的以下文件：</span><span class="sxs-lookup"><span data-stu-id="700ae-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
