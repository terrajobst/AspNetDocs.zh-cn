...
title: ASP.NET Web 窗体和 Ajax 4.5.2 |Microsoft Docs
...
ms.locfileid: "78454160"
---
# <a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="09efa-102">ASP.NET Web 窗体和 Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="09efa-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>

<span data-ttu-id="09efa-103">以下文件托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="09efa-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="09efa-104">注意：可以在以下文件夹中找到全球化脚本（如 fr-FR）：</span><span class="sxs-lookup"><span data-stu-id="09efa-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
