...
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="a3375-102">jquery.validate 版本 1.8.1</span><span class="sxs-lookup"><span data-stu-id="a3375-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="a3375-103">在 CDN 上托管的以下文件：</span><span class="sxs-lookup"><span data-stu-id="a3375-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="a3375-104">本地化文件 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js其中 # # 是本地化代码。</span><span class="sxs-lookup"><span data-stu-id="a3375-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
