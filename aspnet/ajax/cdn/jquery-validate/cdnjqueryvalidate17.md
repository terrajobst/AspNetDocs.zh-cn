...
ms.locfileid: "57053444"
---
<a name="jqueryvalidate-version-17"></a><span data-ttu-id="35677-102">jquery.validate 版本 1.7</span><span class="sxs-lookup"><span data-stu-id="35677-102">jquery.validate version 1.7</span></span>
====================
<span data-ttu-id="35677-103">在 CDN 上托管的以下文件：</span><span class="sxs-lookup"><span data-stu-id="35677-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="35677-104">本地化文件</span><span class="sxs-lookup"><span data-stu-id="35677-104">Localization Files</span></span>
