...
ms.locfileid: "78472802"
---
# <a name="jquery-validation-1150"></a><span data-ttu-id="cdc34-102">jQuery 验证 1.15.0</span><span class="sxs-lookup"><span data-stu-id="cdc34-102">jQuery Validation 1.15.0</span></span>

<span data-ttu-id="cdc34-103">以下文件托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="cdc34-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="cdc34-104">https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js 中的本地化文件 # # 是 loc 代码。</span><span class="sxs-lookup"><span data-stu-id="cdc34-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
