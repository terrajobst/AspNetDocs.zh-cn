...
ms.locfileid: "67538788"
---
# <a name="jquery-validation-1190"></a><span data-ttu-id="2c2fc-102">jQuery 验证 1.19.0</span><span class="sxs-lookup"><span data-stu-id="2c2fc-102">jQuery Validation 1.19.0</span></span>

<span data-ttu-id="2c2fc-103">在 CDN 上托管的以下文件：</span><span class="sxs-lookup"><span data-stu-id="2c2fc-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="2c2fc-104">本地化文件 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js 其中 # # 是本地化代码。</span><span class="sxs-lookup"><span data-stu-id="2c2fc-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
