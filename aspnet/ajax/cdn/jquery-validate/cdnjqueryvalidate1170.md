...
title: jQuery 验证 1.17.0 |Microsoft Docs
author: guardrex
description: ''
ms.author: riande
ms.date: 10/14/2017
...
ms.locfileid: "57056244"
---
<a name="jquery-validation-1170"></a><span data-ttu-id="aed21-102">jQuery 验证 1.17.0</span><span class="sxs-lookup"><span data-stu-id="aed21-102">jQuery Validation 1.17.0</span></span>
====================
<span data-ttu-id="aed21-103">在 CDN 上托管的以下文件：</span><span class="sxs-lookup"><span data-stu-id="aed21-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="aed21-104">本地化文件 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js 其中 # # 是本地化代码。</span><span class="sxs-lookup"><span data-stu-id="aed21-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
