...
title: jquery.validate 版本 1.9 |Microsoft Docs
...
- 本地化文件 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js其中 # # 是本地化代码。
