...
ms.locfileid: "59388083"
---
# <a name="jquery-validate-16"></a><span data-ttu-id="6e6ed-102">jQuery 验证 1.6</span><span class="sxs-lookup"><span data-stu-id="6e6ed-102">jQuery Validate 1.6</span></span>

<span data-ttu-id="6e6ed-103">在 CDN 上托管的以下文件：</span><span class="sxs-lookup"><span data-stu-id="6e6ed-103">The following files are hosted on the CDN:</span></span>
