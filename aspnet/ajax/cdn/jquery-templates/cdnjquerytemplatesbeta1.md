...
---
# <a name="jquery-templates-beta-1"></a><span data-ttu-id="a2f7f-102">jQuery 模板 Beta 1</span><span class="sxs-lookup"><span data-stu-id="a2f7f-102">jQuery Templates Beta 1</span></span>

<span data-ttu-id="a2f7f-103">JQuery Templates 插件包括下列文件：</span><span class="sxs-lookup"><span data-stu-id="a2f7f-103">The jQuery Templates plugin includes the following files:</span></span>
