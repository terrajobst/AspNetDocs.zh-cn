...
此存储库包含[docs.microsoft.com/aspnet](https://docs.microsoft.com/aspnet)上托管的 ASP.NET 4.x 文档。 如果想要寻求帮助，请参阅[参与指南](CONTRIBUTING.md)和[问题列表](https://github.com/dotnet/AspNetDocs/issues)。
