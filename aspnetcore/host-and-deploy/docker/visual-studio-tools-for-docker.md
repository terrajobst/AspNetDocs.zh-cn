...
安装 Docker，请首先在查看此信息[Docker 的 Windows:安装须知](https://docs.docker.com/docker-for-windows/install/#what-to-know-before-you-install)了解相关信息。 然后安装[用于 Windows 的 Docker](https://docs.docker.com/docker-for-windows/install/)。
...
Visual Studio 2017 版本 15.8 或更高版本仅在获得指示时添加业务流程解决方案。 右键单击“解决方案资源管理器”中的项目，然后选择“添加” > “容器业务流程协调程序支持”。 提供两个不同的选择：[Docker Compose](#docker-compose)并[Service Fabric](#service-fabric)。
