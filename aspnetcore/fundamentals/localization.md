...
1. 在“解决方案资源管理器”中，右键单击将包含资源文件的文件夹 >“添加” > “新项”。
    ...
    ![嵌套的上下文菜单：在解决方案资源管理器上下文菜单已打开的资源。 “添加”可打开第二个上下文菜单，突出显示“新项”命令。](localization/_static/newi.png)
...
* 全球化 (G11N):使应用支持不同的语言和区域的过程。
* 本地化 (L10N):自定义适用于给定的语言和区域的应用的过程。
* 国际化 (I18N):介绍了全球化和本地化。
* 区域性：它是一种语言和区域 （可选）。
* 非特定区域性：具有指定的语言，但不是具有区域的区域性。 （例如，“en”，“es”）
* 特定区域性：具有指定的语言和区域的区域性。 （例如，“en-US”，“en-GB”，“es-CL”）
* 父区域性：包含特定区域性非特定区域性。 （例如，“en”是“en-US”和“en-GB”的父区域性）
* 区域设置：区域设置是与区域性相同。
